...
define("vs/basic-languages/mdx/mdx", ["require", "require"], (require) => {
  ...
  var moduleExports = (() => {
    ...
    var b = Object.getPrototypeOf, g = Object.prototype.hasOwnProperty;
    var h = (e => typeof require < "u" ? require : typeof Proxy < "u" ? new Proxy(e, {get: (t, n) => (typeof require < "u" ? require : t)[n]}) : e)(function (e) {
      if (typeof require < "u") return require.apply(this, arguments);
      throw Error('Dynamic require of "' + e + '" is not supported')
    });
    var f = (e, t) => () => (t || e((t = {exports: {}}).exports, t), t.exports), u = (e, t) => {
        for (var n in t) r(e, n, {get: t[n], enumerable: !0})
      }, s = (e, t, n, d) => {
        if (t && typeof t == "object" || typeof t == "function") for (let i of l(t)) !g.call(e, i) && i !== n && r(e, i, {
          get: () => t[i],
          enumerable: !(d = m(t, i)) || d.enumerable
        });
        return e
      }, c = (e, t, n) => (s(e, t, "default"), n && s(n, t, "default")),
      p = (e, t, n) => (n = e != null ? x(b(e)) : {}, s(t || !e || !e.__esModule ? r(n, "default", {
        value: e,
        enumerable: !0
      }) : n, e)), w = e => s(r({}, "__esModule", {value: !0}), e);
    var k = f((T, a) => {
    ...
    var _ = {
      ...
      autoClosingPairs: [{open: '"', close: '"'}, {open: "'", close: "'"}, {
        ...
        open: "(",
        close: ")"
      }, {open: "_", close: "_"}, {open: "**", close: "**"}, {open: "<", close: ">"}],
      onEnterRules: [{
        beforeText: /^\s*- .+/,
        ...
        beforeText: /^> /,
        action: {indentAction: o.languages.IndentAction.None, appendText: "> "}
      }, {beforeText: /<\w+/, action: {indentAction: o.languages.IndentAction.Indent}}, {
        beforeText: /\s+>\s*$/,
        ...
        action: {indentAction: o.languages.IndentAction.None, appendText: `${t + 1}. `}
      }))]
    }, y = {
      defaultToken: "", tokenPostfix: ".mdx", control: /[!#()*+.[\\\]_`{}\-]/, escapes: /\\@control/, tokenizer: {
        root: [[/^---$/, {
          token: "meta.content",
          next: "@frontmatter",
          nextEmbedded: "yaml"
        }], [/^\s*import/, {token: "keyword", next: "@import", nextEmbedded: "js"}], [/^\s*export/, {
          token: "keyword",
          next: "@export",
          nextEmbedded: "js"
        }], [/<\w+/, {
          ...
          next: "@jsx"
        }], [/<\/?\w+>/, "type.identifier"], [/^(\s*)(>*\s*)(#{1,6}\s)/, [{token: "white"}, {token: "comment"}, {
          token: "keyword",
          next: "@header"
        ...
        }], [/~{3,}(\s.*)?$/, {token: "string", next: "@codeblock_tilde"}], [/`{3,}(\S+).*$/, {
          token: "string",
          ...
          nextEmbedded: "$1"
        }], [/^(\s*)(-{4,})$/, ["white", "comment"]], [/^(\s*)(>+)/, ["white", "comment"]], {include: "content"}],
        ...
        expression: [[/{/, {token: "delimiter.bracket", next: "@expression"}], [/}/, {
        ...
        emphasis_underscore: [[/_/, {
          token: "emphasis",
          next: "@pop"
        }], {include: "content"}, [/./, {token: "emphasis"}]],
        emphasis_asterisk: [[/\*(?!\*)/, {
          token: "emphasis",
          next: "@pop"
        }], {include: "content"}, [/./, {token: "emphasis"}]],
        ...
        codeblock_backtick: [[/\s*`{3,}\s*$/, {token: "string", next: "@pop"}], [/.*$/, "variable.source"]],
        codeblock_tilde: [[/\s*~{3,}\s*$/, {token: "string", next: "@pop"}], [/.*$/, "variable.source"]]
      }
    };
    return w(A);
  })();
