...
define("vs/basic-languages/apex/apex", ["require", "require"], (require) => {
  ...
  var moduleExports = (() => {
    ...
    var d = (e, t) => {
      ...
      if (t && typeof t == "object" || typeof t == "function") for (let o of c(t)) !l.call(e, o) && o !== s && i(e, o, {
        get: () => t[o],
        enumerable: !(a = r(t, o)) || a.enumerable
      });
      return e
    };
    var p = e => g(i({}, "__esModule", {value: !0}), e);
    var h = {};
    d(h, {conf: () => m, language: () => b});
    var m = {
    ...
    var b = {
      ...
      tokenizer: {
        ...
        }], {include: "@whitespace"}, [/[{}()\[\]]/, "@brackets"], [/[<>](?!@symbols)/, "@brackets"], [/@symbols/, {
          cases: {
            "@operators": "delimiter",
            "@default": ""
          }
