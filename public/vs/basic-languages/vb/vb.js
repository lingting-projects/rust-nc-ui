...
define("vs/basic-languages/vb/vb", ["require", "require"], (require) => {
  ...
  var moduleExports = (() => {
    ...
    var i = (n, e) => {
      ...
      if (e && typeof e == "object" || typeof e == "function") for (let o of d(e)) !l.call(n, o) && o !== t && r(n, o, {
        get: () => e[o],
        enumerable: !(s = a(e, o)) || s.enumerable
      });
      return n
    };
    var u = n => c(r({}, "__esModule", {value: !0}), n);
    var k = {};
    i(k, {conf: () => g, language: () => p});
    var g = {
      ...
      folding: {markers: {start: new RegExp("^\\s*#Region\\b"), end: new RegExp("^\\s*#End Region\\b")}}
    }, p = {
      defaultToken: "",
      tokenPostfix: ".vb",
      ignoreCase: !0,
      ...
      floatsuffix: /[R#F!]?/,
      tokenizer: {
        root: [{include: "@whitespace"}, [/next(?!\w)/, {token: "keyword.tag-for"}], [/loop(?!\w)/, {token: "keyword.tag-do"}], [/end\s+(?!for|do)(addhandler|class|enum|event|function|get|if|interface|module|namespace|operator|property|raiseevent|removehandler|select|set|structure|sub|synclock|try|while|with|using)/, {token: "keyword.tag-$1"}], [/[a-zA-Z_]\w*/, {
          cases: {
