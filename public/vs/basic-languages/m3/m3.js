...
define("vs/basic-languages/m3/m3", ["require", "require"], (require) => {
  ...
  var moduleExports = (() => {
    ...
    var R = (o, e) => {
      ...
      if (e && typeof e == "object" || typeof e == "function") for (let t of a(e)) !i.call(o, t) && t !== s && r(o, t, {
        get: () => e[t],
    ...
    var A = {
      ...
      tokenizer: {
        ...
        }], {include: "@whitespace"}, [/[{}()\[\]]/, "@brackets"], [/[0-9]+\.[0-9]+(?:[DdEeXx][\+\-]?[0-9]+)?/, "number.float"], [/[0-9]+(?:\_[0-9a-fA-F]+)?L?/, "number"], [/@symbols/, {
          cases: {
            "@operators": "operators",
            "@relations": "operators",
