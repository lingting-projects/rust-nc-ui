...
define("vs/basic-languages/redshift/redshift", ["require", "require"], (require) => {
  ...
  var moduleExports = (() => {
    ...
    var p = (_, e) => {
      for (var r in e) i(_, r, {get: e[r], enumerable: !0})
    }, l = (_, e, r, a) => {
      if (e && typeof e == "object" || typeof e == "function") for (let t of o(e)) !n.call(_, t) && t !== r && i(_, t, {
        get: () => e[t],
        enumerable: !(a = s(e, t)) || a.enumerable
      });
      return _
    };
    var g = _ => l(i({}, "__esModule", {value: !0}), _);
    var m = {};
    p(m, {conf: () => c, language: () => d});
    var c = {
