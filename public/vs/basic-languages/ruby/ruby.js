...
define("vs/basic-languages/ruby/ruby", ["require", "require"], (require) => {
  ...
  var moduleExports = (() => {
    ...
    var p = (t, e) => {
      ...
      if (e && typeof e == "object" || typeof e == "function") for (let n of c(e)) !d.call(t, n) && n !== r && o(t, n, {
        get: () => e[n],
    ...
    var g = {
      ...
      tokenizer: {
        root: [[/^(\s*)([a-z_]\w*[!?=]?)/, ["white", {
          ...
          next: '@dstring.d."'
        }], [/'/, {token: "string.sq.delim", next: "@sstring.sq"}], [/%([rsqxwW]|Q?)/, {
          token: "@rematch",
          next: "pstring"
        }], [/`/, {
        ...
        }], [/%r\(/, {token: "regexp.delim", switchTo: "@pregexp.(.)"}], [/%r\[/, {
          token: "regexp.delim",
          switchTo: "@pregexp.[.]"
        }], [/%r\{/, {token: "regexp.delim", switchTo: "@pregexp.{.}"}], [/%r</, {
          token: "regexp.delim",
        ...
        }], [/%([rqwsxW]|Q?)./, {token: "invalid", next: "@pop"}], [/./, {token: "invalid", next: "@pop"}]],
        qstring: [[/\\$/, "string.$S2.escape"], [/\\./, "string.$S2.escape"], [/./, {
          cases: {
            "$#==$S4": {
              token: "string.$S2.delim",
              next: "@pop"
            }, "$#==$S3": {token: "string.$S2.delim", next: "@push"}, "@default": "string.$S2"
          }
        }]],
