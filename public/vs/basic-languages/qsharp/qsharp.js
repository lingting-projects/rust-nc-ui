...
define("vs/basic-languages/qsharp/qsharp", ["require", "require"], (require) => {
  ...
  var moduleExports = (() => {
    ...
    var c = (t, e) => {
      ...
      if (e && typeof e == "object" || typeof e == "function") for (let o of r(e)) !l.call(t, o) && o !== n && a(t, o, {
        get: () => e[o],
        enumerable: !(s = i(e, o)) || s.enumerable
      });
      return t
    };
    var u = t => p(a({}, "__esModule", {value: !0}), t);
    var w = {};
    c(w, {conf: () => d, language: () => m});
    var d = {
      ...
      tokenizer: {
        root: [[/[a-zA-Z_$][\w$]*/, {
          cases: {
            ...
            "@importsFollows": {token: "keyword.$0", next: "@imports"},
            "@typeKeywords": "type",
            "@keywords": "keyword",
            "@constants": "constant",
            "@builtin": "keyword",
        ...
        }], {include: "@whitespace"}, [/[{}()\[\]]/, "@brackets"], [/@symbols/, {
          cases: {
            "@operators": "operator",
            "@default": ""
          }
        ...
        namespace: [{include: "@whitespace"}, [/[A-Za-z]\w*/, "namespace"], [/[\.]/, "delimiter"], ["", "", "@pop"]],
        imports: [{include: "@whitespace"}, [/[A-Za-z]\w*(?=\.)/, "namespace"], [/[A-Za-z]\w*/, "identifier"], [/\*/, "wildcard"], [/[\.,]/, "delimiter"], ["", "", "@pop"]],
        whitespace: [[/[ \t\r\n]+/, "white"], [/(\/\/).*/, "comment"]]
      }
    };
    return u(w);
