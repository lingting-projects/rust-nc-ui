...
define("vs/basic-languages/shell/shell", ["require", "require"], (require) => {
  ...
  var moduleExports = (() => {
    ...
    var c = (r, e) => {
      ...
      if (e && typeof e == "object" || typeof e == "function") for (let t of n(e)) !l.call(r, t) && t !== i && a(r, t, {
        get: () => e[t],
    ...
    var m = {
      ...
      tokenizer: {
        ...
        }], {include: "@whitespace"}, {include: "@strings"}, {include: "@parameters"}, {include: "@heredoc"}, [/[{}\[\]()]/, "@brackets"], [/@symbols/, "delimiter"], {include: "@numbers"}, [/[,;]/, "delimiter"]],
