...
define("vs/basic-languages/cypher/cypher", ["require", "require"], (require) => {
  ...
  var moduleExports = (() => {
    ...
    var c = (i, e) => {
      ...
      if (e && typeof e == "object" || typeof e == "function") for (let t of a(e)) !l.call(i, t) && t !== n && s(i, t, {
        get: () => e[t],
    ...
    var d = {
      ...
      tokenizer: {
        ...
        common: [{include: "@whitespace"}, {include: "@numbers"}, {include: "@strings"}, [/:[a-zA-Z_][\w]*/, "type.identifier"], [/[a-zA-Z_][\w]*(?=\()/, {cases: {"@builtinFunctions": "predefined.function"}}], [/[a-zA-Z_$][\w$]*/, {
          cases: {
            "@keywords": "keyword",
