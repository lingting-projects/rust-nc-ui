...
define("vs/basic-languages/sql/sql", ["require", "require"], (require) => {
  ...
  var moduleExports = (() => {
    ...
    var L = (T, E) => {
      ...
      if (E && typeof E == "object" || typeof E == "function") for (let R of O(E)) !C.call(T, R) && R !== A && I(T, R, {
        get: () => E[R],
        enumerable: !(N = S(E, R)) || N.enumerable
      });
      return T
    };
    var P = T => e(I({}, "__esModule", {value: !0}), T);
    var M = {};
    L(M, {conf: () => D, language: () => U});
    var D = {
      ...
      tokenizer: {
        ...
        pseudoColumns: [[/[$][A-Za-z_][\w@#$]*/, {cases: {"@pseudoColumns": "predefined", "@default": "identifier"}}]],
