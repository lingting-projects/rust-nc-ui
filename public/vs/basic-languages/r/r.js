...
define("vs/basic-languages/r/r", ["require", "require"], (require) => {
  ...
  var moduleExports = (() => {
    ...
    var l = (o, e) => {
      ...
      if (e && typeof e == "object" || typeof e == "function") for (let r of i(e)) !c.call(o, r) && r !== t && a(o, r, {
        get: () => e[r],
    ...
    var d = {
      ...
      tokenizer: {
        root: [{include: "@numbers"}, {include: "@strings"}, [/[{}\[\]()]/, "@brackets"], {include: "@operators"}, [/#'$/, "comment.doc"], [/#'/, "comment.doc", "@roxygen"], [/(^#.*$)/, "comment"], [/\s+/, "white"], [/[,:;]/, "delimiter"], [/@[a-zA-Z]\w*/, "tag"], [/[a-zA-Z]\w*/, {
          cases: {
            "@keywords": "keyword",
            "@constants": "constant",
            "@default": "identifier"
