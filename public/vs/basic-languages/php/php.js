...
define("vs/basic-languages/php/php", ["require", "require"], (require) => {
  ...
  var moduleExports = (() => {
    ...
    var s = (t, e) => {
      ...
      if (e && typeof e == "object" || typeof e == "function") for (let p of m(e)) !a.call(t, p) && p !== n && i(t, p, {
        get: () => e[p],
        enumerable: !(r = o(e, p)) || r.enumerable
      });
      return t
    };
    var l = t => h(i({}, "__esModule", {value: !0}), t);
    var u = {};
    s(u, {conf: () => d, language: () => c});
    var d = {
