...
define("vs/basic-languages/swift/swift", ["require", "require"], (require) => {
  ...
  var moduleExports = (() => {
    ...
    var c = (o, e) => {
      for (var n in e) i(o, n, {get: e[n], enumerable: !0})
    }, u = (o, e, n, r) => {
      if (e && typeof e == "object" || typeof e == "function") for (let t of s(e)) !l.call(o, t) && t !== n && i(o, t, {
        get: () => e[t],
        enumerable: !(r = a(e, t)) || r.enumerable
      });
      return o
    };
    var d = o => u(i({}, "__esModule", {value: !0}), o);
    var f = {};
    ...
    var p = {
      ...
      tokenizer: {
        root: [{include: "@whitespace"}, {include: "@comment"}, {include: "@attribute"}, {include: "@literal"}, {include: "@keyword"}, {include: "@invokedmethod"}, {include: "@symbol"}],
        ...
        attribute: [[/@@@identifier/, {cases: {"@attributes": "keyword.control", "@default": ""}}]],
        literal: [[/"/, {
          token: "string.quote",
          next: "@stringlit"
        ...
        interpolatedexpression: [[/\(/, {
          ...
          token: "operator",
          next: "@pop"
        }], {include: "@literal"}, {include: "@keyword"}, {include: "@symbol"}],
