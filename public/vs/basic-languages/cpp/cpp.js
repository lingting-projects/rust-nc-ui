...
define("vs/basic-languages/cpp/cpp", ["require", "require"], (require) => {
  ...
  var moduleExports = (() => {
    ...
    var c = (n, e) => {
      ...
      if (e && typeof e == "object" || typeof e == "function") for (let t of a(e)) !s.call(n, t) && t !== i && o(n, t, {
        get: () => e[t],
        enumerable: !(_ = r(e, t)) || _.enumerable
      });
      return n
    };
    var d = n => l(o({}, "__esModule", {value: !0}), n);
    var u = {};
    c(u, {conf: () => p, language: () => m});
    var p = {
      ...
      tokenizer: {
        root: [[/@encoding?R\"(?:([^ ()\\\t]*))\(/, {
          ...
          next: "@include"
        }], [/^\s*#\s*\w+/, "keyword.directive"], {include: "@whitespace"}, [/\[\s*\[/, {
          token: "annotation",
          next: "@annotation"
        }], [/[{}()<>\[\]]/, "@brackets"], [/@symbols/, {
          cases: {
        ...
        raw: [[/[^)]+/, "string.raw"], [/\)$S2\"/, {token: "string.raw.end", next: "@pop"}], [/\)/, "string.raw"]],
        annotation: [{include: "@whitespace"}, [/using|alignas/, "keyword"], [/[a-zA-Z0-9_]+/, "annotation"], [/[,:]/, "delimiter"], [/[()]/, "@brackets"], [/\]\s*\]/, {
          token: "annotation",
          next: "@pop"
        }]],
