...
define("vs/basic-languages/dart/dart", ["require", "require"], (require) => {
  ...
  var moduleExports = (() => {
    ...
    var p = (n, e) => {
      ...
      if (e && typeof e == "object" || typeof e == "function") for (let o of c(e)) !a.call(n, o) && o !== t && r(n, o, {
        get: () => e[o],
        enumerable: !(s = i(e, o)) || s.enumerable
      });
      return n
    };
    var l = n => g(r({}, "__esModule", {value: !0}), n);
    var x = {};
    p(x, {conf: () => d, language: () => m});
    var d = {
      ...
      tokenizer: {
        ...
        }], [/[A-Z_$][\w\$]*/, "type.identifier"], {include: "@whitespace"}, [/\/(?=([^\\\/]|\\.)+\/([gimsuy]*)(\s*)(\.|;|,|\)|\]|\}|$))/, {
          token: "regexp",
          bracket: "@open",
          next: "@regexp"
