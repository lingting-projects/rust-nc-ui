...
define("vs/basic-languages/html/html", ["require", "require"], (require) => {
  ...
  var moduleExports = (() => {
    ...
    var k = (e => typeof require < "u" ? require : typeof Proxy < "u" ? new Proxy(e, {get: (t, n) => (typeof require < "u" ? require : t)[n]}) : e)(function (e) {
      if (typeof require < "u") return require.apply(this, arguments);
      throw Error('Dynamic require of "' + e + '" is not supported')
    });
    var E = (e, t) => () => (t || e((t = {exports: {}}).exports, t), t.exports), T = (e, t) => {
        for (var n in t) a(e, n, {get: t[n], enumerable: !0})
      }, o = (e, t, n, s) => {
        if (t && typeof t == "object" || typeof t == "function") for (let r of x(t)) !g.call(e, r) && r !== n && a(e, r, {
          get: () => t[r],
          enumerable: !(s = b(t, r)) || s.enumerable
        });
        return e
      }, d = (e, t, n) => (o(e, t, "default"), n && o(n, t, "default")),
      m = (e, t, n) => (n = e != null ? u(y(e)) : {}, o(t || !e || !e.__esModule ? a(n, "default", {
        value: e,
        enumerable: !0
      }) : n, e)), w = e => o(a({}, "__esModule", {value: !0}), e);
    var l = E((A, p) => {
    ...
    var c = ["area", "base", "br", "col", "embed", "hr", "img", "input", "keygen", "link", "menuitem", "meta", "param", "source", "track", "wbr"],
      v = {
        ...
        onEnterRules: [{
          beforeText: new RegExp(`<(?!(?:${c.join("|")}))([_:\\w][_:\\w-.\\d]*)([^/>]*(?!/)>)[^<]*$`, "i"),
          afterText: /^<\/([_:\w][_:\w-.\d]*)\s*>$/i,
          action: {indentAction: i.languages.IndentAction.IndentOutdent}
        }, {
          beforeText: new RegExp(`<(?!(?:${c.join("|")}))(\\w[\\w\\d]*)([^/>]*(?!/)>)[^<]*$`, "i"),
        ...
        defaultToken: "", tokenPostfix: ".html", ignoreCase: !0, tokenizer: {
