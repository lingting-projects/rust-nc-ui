...
define("vs/basic-languages/lua/lua", ["require", "require"], (require) => {
  ...
  var moduleExports = (() => {
    ...
    var c = (o, e) => {
      ...
      if (e && typeof e == "object" || typeof e == "function") for (let n of i(e)) !l.call(o, n) && n !== t && s(o, n, {
        get: () => e[n],
    ...
    var d = {
      ...
      tokenizer: {
        ...
        }], {include: "@whitespace"}, [/(,)(\s*)([a-zA-Z_]\w*)(\s*)(:)(?!:)/, ["delimiter", "", "key", "", "delimiter"]], [/({)(\s*)([a-zA-Z_]\w*)(\s*)(:)(?!:)/, ["@brackets", "", "key", "", "delimiter"]], [/[{}()\[\]]/, "@brackets"], [/@symbols/, {
          cases: {
            "@operators": "delimiter",
            "@default": ""
          }
