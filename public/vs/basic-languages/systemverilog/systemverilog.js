...
define("vs/basic-languages/systemverilog/systemverilog", ["require", "require"], (require) => {
  ...
  var moduleExports = (() => {
    ...
    var d = (n, e) => {
      ...
      if (e && typeof e == "object" || typeof e == "function") for (let i of a(e)) !c.call(n, i) && i !== t && r(n, i, {
        get: () => e[i],
        enumerable: !(o = s(e, i)) || o.enumerable
      });
      return n
    };
    var p = n => l(r({}, "__esModule", {value: !0}), n);
    var f = {};
    d(f, {conf: () => u, language: () => m});
    var u = {
      ...
      brackets: [{token: "delimiter.curly", open: "{", close: "}"}, {
        ...
        open: "(",
        close: ")"
      }, {token: "delimiter.square", open: "[", close: "]"}, {token: "delimiter.angle", open: "<", close: ">"}],
      ...
      tokenizer: {
        root: [[/^(\s*)(@identifier)/, ["", {
          cases: {
            ...
            table: {token: "keyword.$2", next: "@table"},
          ...
          next: "@include"
        }], [/^\s*`\s*\w+/, "keyword"], {include: "@identifier_or_keyword"}, {include: "@whitespace"}, [/\(\*.*\*\)/, "annotation"], [/@systemcall/, "variable.predefined"], [/[{}()\[\]]/, "@brackets"], [/[<>](?!@symbols)/, "@brackets"], [/@symbols/, {
          cases: {
            "@operators": "delimiter",
            "@default": ""
          }
        }], {include: "@numbers"}, [/[;,.]/, "delimiter"], {include: "@strings"}],
        ...
        module_instance: [{include: "@whitespace"}, [/(#?)(\()/, ["", {
          token: "@brackets",
        ...
        port_connection: [{include: "@identifier_or_keyword"}, {include: "@whitespace"}, [/@systemcall/, "variable.predefined"], {include: "@numbers"}, {include: "@strings"}, [/[,]/, "delimiter"], [/\(/, "@brackets", "@port_connection"], [/\)/, "@brackets", "@pop"]],
        ...
        table: [{include: "@whitespace"}, [/[()]/, "@brackets"], [/[:;]/, "delimiter"], [/[01\-*?xXbBrRfFpPnN]/, "variable.predefined"], ["endtable", "keyword.endtable", "@pop"]]
      }
    };
    return p(f);
  })();
