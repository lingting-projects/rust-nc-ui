...
define("vs/basic-languages/perl/perl", ["require", "require"], (require) => {
  ...
  var moduleExports = (() => {
    ...
    var a = (t, e) => {
      ...
      if (e && typeof e == "object" || typeof e == "function") for (let s of l(e)) !d.call(t, s) && s !== n && r(t, s, {
        get: () => e[s],
        enumerable: !(i = o(e, s)) || i.enumerable
      });
      return t
    };
    var c = t => $(r({}, "__esModule", {value: !0}), t);
    var m = {};
    a(m, {conf: () => g, language: () => p});
    var g = {
      ...
      tokenizer: {
        ...
        }], {include: "@strings"}, {include: "@dblStrings"}, {include: "@perldoc"}, {include: "@heredoc"}, [/[{}\[\]()]/, "@brackets"], [/[\/](?:(?:\[(?:\\]|[^\]])+\])|(?:\\\/|[^\]\/]))*[\/]\w*\s*(?=[).,;]|$)/, "regexp"], [/@symbols/, "operators"], {include: "@numbers"}, [/[,;]/, "delimiter"]],
        ...
        quotedConstructs: [[/(q|qw|tr|y)\s*\(/, {
          ...
          token: "regexp.delim",
          switchTo: "@qregexp.{.}"
        }], [/(qr|m|s)\s*</, {token: "regexp.delim", switchTo: "@qregexp.<.>"}], [/(qr|m|s)#/, {
          token: "regexp.delim",
          switchTo: "@qregexp.#.#"
          ...
          token: "string.delim",
          switchTo: "@qqstring.{.}"
        }], [/(qq|qx)\s*</, {token: "string.delim", switchTo: "@qqstring.<.>"}], [/(qq|qx)#/, {
          token: "string.delim",
          switchTo: "@qqstring.#.#"
        }], [/(qq|qx)\s*([^A-Za-z0-9#\s])/, {
          token: "string.delim",
        ...
        qregexp: [{include: "@variables"}, [/\\./, "regexp.escape"], [/./, {
          cases: {
            "$#==$S3": {
              token: "regexp.delim",
              next: "@regexpModifiers"
            }, "$#==$S2": {token: "regexp.delim", next: "@push"}, "@default": "regexp"
          }
        }]],
