...
define("vs/basic-languages/sophia/sophia", ["require", "require"], (require) => {
  ...
  var moduleExports = (() => {
    ...
    var l = (t, e) => {
      ...
      if (e && typeof e == "object" || typeof e == "function") for (let n of a(e)) !c.call(t, n) && n !== o && s(t, n, {
        get: () => e[n],
    ...
    var f = {
      ...
      tokenizer: {
        ...
        }], {include: "@whitespace"}, [/\[\[.*\]\]/, "annotation"], [/^\s*#\w+/, "keyword"], [/int\d*/, "keyword"], [/[{}()\[\]]/, "@brackets"], [/[<>](?!@symbols)/, "@brackets"], [/@symbols/, {
          cases: {
            "@operators": "delimiter",
            "@default": ""
          }
