...
define("vs/basic-languages/mysql/mysql", ["require", "require"], (require) => {
  ...
  var moduleExports = (() => {
    ...
    var o = (T, E) => {
      ...
      if (E && typeof E == "object" || typeof E == "function") for (let S of I(E)) !N.call(T, S) && S !== R && A(T, S, {
        get: () => E[S],
        enumerable: !(_ = e(E, S)) || _.enumerable
      });
      return T
    };
    var t = T => O(A({}, "__esModule", {value: !0}), T);
    var L = {};
    o(L, {conf: () => n, language: () => C});
    var n = {
      ...
      tokenizer: {
        ...
        string: [[/\\'/, "string"], [/[^']+/, "string"], [/''/, "string"], [/'/, {token: "string", next: "@pop"}]],
