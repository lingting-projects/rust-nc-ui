...
define("vs/basic-languages/go/go", ["require", "require"], (require) => {
  ...
  var moduleExports = (() => {
    ...
    var m = (n, e) => {
      ...
      if (e && typeof e == "object" || typeof e == "function") for (let o of a(e)) !c.call(n, o) && o !== t && s(n, o, {
        get: () => e[o],
    ...
    var p = {
      ...
      tokenizer: {
        ...
        }], {include: "@whitespace"}, [/\[\[.*\]\]/, "annotation"], [/^\s*#\w+/, "keyword"], [/[{}()\[\]]/, "@brackets"], [/[<>](?!@symbols)/, "@brackets"], [/@symbols/, {
          cases: {
            "@operators": "delimiter",
            "@default": ""
          }
