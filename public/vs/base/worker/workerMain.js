...
(function () {
  ...
  (function (W) {
    ...
    class n {
      ...
      _detect() {
        this._detected || (this._detected = !0, this._isWindows = n._isWindows(), this._isNode = typeof module < "u" && !!module.exports, this._isElectronRenderer = typeof process < "u" && typeof process.versions < "u" && typeof process.versions.electron < "u" && process.type === "renderer", this._isWebWorker = typeof W.global.importScripts == "function", this._isElectronNodeIntegrationWebWorker = this._isWebWorker && typeof process < "u" && typeof process.versions < "u" && typeof process.versions.electron < "u" && process.type === "worker")
      }
  ...
  (function (W) {
    ...
    class i {
      ...
      record(d, f) {
        this._events.push(new n(d, f, W.Utilities.getHighPerformanceTimestamp()))
      }
  ...
  (function (W) {
    class n {
      ...
      static isEmpty(x) {
        let A = !0;
        return n.forEachProperty(x, () => {
          A = !1
        }), A
      }

      static recursiveClone(x) {
        if (!x || typeof x != "object" || x instanceof RegExp || !Array.isArray(x) && Object.getPrototypeOf(x) !== Object.prototype) return x;
        let A = Array.isArray(x) ? [] : {};
        return n.forEachProperty(x, (d, f) => {
          f && typeof f == "object" ? A[d] = n.recursiveClone(f) : A[d] = f
        }), A
      }
      ...
      static getHighPerformanceTimestamp() {
        return this.PERFORMANCE_NOW_PROBED || (this.PERFORMANCE_NOW_PROBED = !0, this.HAS_PERFORMANCE_NOW = W.global.performance && typeof W.global.performance.now == "function"), this.HAS_PERFORMANCE_NOW ? W.global.performance.now() : Date.now()
      }
    }

    n.NEXT_ANONYMOUS_ID = 1, n.PERFORMANCE_NOW_PROBED = !1, n.HAS_PERFORMANCE_NOW = !1, W.Utilities = n
  })(ie || (ie = {}));
  var ie;
  (function (W) {
    function n(A) {
    ...
    class i {
      static validateConfigurationOptions(d) {
        ...
        if (d = d || {}, typeof d.baseUrl != "string" && (d.baseUrl = ""), typeof d.isBuild != "boolean" && (d.isBuild = !1), typeof d.paths != "object" && (d.paths = {}), typeof d.config != "object" && (d.config = {}), typeof d.catchError > "u" && (d.catchError = !1), typeof d.recordStats > "u" && (d.recordStats = !1), typeof d.urlArgs != "string" && (d.urlArgs = ""), typeof d.onError != "function" && (d.onError = f), Array.isArray(d.ignoreDuplicateModules) || (d.ignoreDuplicateModules = []), d.baseUrl.length > 0 && (W.Utilities.endsWith(d.baseUrl, "/") || (d.baseUrl += "/")), typeof d.cspNonce != "string" && (d.cspNonce = ""), typeof d.preferScriptTags > "u" && (d.preferScriptTags = !1), d.nodeCachedData && typeof d.nodeCachedData == "object" && (typeof d.nodeCachedData.seed != "string" && (d.nodeCachedData.seed = "seed"), (typeof d.nodeCachedData.writeDelay != "number" || d.nodeCachedData.writeDelay < 0) && (d.nodeCachedData.writeDelay = 1e3 * 7), !d.nodeCachedData.path || typeof d.nodeCachedData.path != "string")) {
          const p = n(new Error("INVALID cached data configuration, 'path' MUST be set"));
      ...
      static mergeConfigurationOptions(d = null, f = null) {
        ...
        return W.Utilities.forEachProperty(d, (c, a) => {
          c === "ignoreDuplicateModules" && typeof p.ignoreDuplicateModules < "u" ? p.ignoreDuplicateModules = p.ignoreDuplicateModules.concat(a) : c === "paths" && typeof p.paths < "u" ? W.Utilities.forEachProperty(a, (m, e) => p.paths[m] = e) : c === "config" && typeof p.config < "u" ? W.Utilities.forEachProperty(a, (m, e) => p.config[m] = e) : p[c] = W.Utilities.recursiveClone(a)
    ...
    class x {
      constructor(d, f) {
        if (this._env = d, this.options = i.mergeConfigurationOptions(f), this._createIgnoreDuplicateModulesMap(), this._createSortedPathsRules(), this.options.baseUrl === "" && this.options.nodeRequire && this.options.nodeRequire.main && this.options.nodeRequire.main.filename && this._env.isNode) {
          let p = this.options.nodeRequire.main.filename, c = Math.max(p.lastIndexOf("/"), p.lastIndexOf("\\"));
      ...
      _createSortedPathsRules() {
        this.sortedPathsRules = [], W.Utilities.forEachProperty(this.options.paths, (d, f) => {
          Array.isArray(f) ? this.sortedPathsRules.push({from: d, to: f}) : this.sortedPathsRules.push({
            from: d,
            to: [f]
          })
      ...
      _applyPaths(d) {
        let f;
        for (let p = 0, c = this.sortedPathsRules.length; p < c; p++) if (f = this.sortedPathsRules[p], W.Utilities.startsWith(d, f.from)) {
          let a = [];
          for (let m = 0, e = f.to.length; m < e; m++) a.push(f.to[m] + d.substr(f.from.length));
          return a
        }
        return [d]
      }
      ...
      _addUrlArgsToUrl(d) {
        return W.Utilities.containsQueryString(d) ? d + "&" + this.options.urlArgs : d + "?" + this.options.urlArgs
      }
      ...
      _addUrlArgsIfNecessaryToUrls(d) {
        if (this.options.urlArgs) for (let f = 0, p = d.length; f < p; f++) d[f] = this._addUrlArgsToUrl(d[f]);
        return d
      }
      ...
      moduleIdToPaths(d) {
        ...
        if (!W.Utilities.endsWith(f, ".js") && !W.Utilities.isAbsolutePath(f)) {
          ...
          for (let c = 0, a = p.length; c < a; c++) this.isBuild() && p[c] === "empty:" || (W.Utilities.isAbsolutePath(p[c]) || (p[c] = this.options.baseUrl + p[c]), !W.Utilities.endsWith(p[c], ".js") && !W.Utilities.containsQueryString(p[c]) && (p[c] = p[c] + ".js"))
        } else !W.Utilities.endsWith(f, ".js") && !W.Utilities.containsQueryString(f) && (f = f + ".js"), p = [f];
        return this._addUrlArgsIfNecessaryToUrls(p)
      }

      requireToUrl(d) {
        let f = d;
        return W.Utilities.isAbsolutePath(f) || (f = this._applyPaths(f)[0], W.Utilities.isAbsolutePath(f) || (f = this.options.baseUrl + f)), this._addUrlArgsIfNecessaryToUrl(f)
      }
      ...
      shouldInvokeFactory(d) {
        return !!(!this.options.isBuild || W.Utilities.isAnonymousModule(d) || this.options.buildForceInvokeFactory && this.options.buildForceInvokeFactory[d])
      }
  ...
  (function (W) {
    class n {
      ...
      load(a, m, e, h) {
        if (!this._scriptLoader) if (this._env.isWebWorker) this._scriptLoader = new A; else if (this._env.isElectronRenderer) {
          ...
          s ? this._scriptLoader = new i : this._scriptLoader = new d(this._env)
        } else this._env.isNode ? this._scriptLoader = new d(this._env) : this._scriptLoader = new i;
        let r = {callback: e, errorback: h};
        if (this._callbackMap.hasOwnProperty(m)) {
          this._callbackMap[m].push(r);
          return
        }
        this._callbackMap[m] = [r], this._scriptLoader.load(a, m, () => this.triggerCallback(m), s => this.triggerErrorback(m, s))
      }
    ...
    class i {
      attachListeners(a, m, e) {
        let h = () => {
          a.removeEventListener("load", r), a.removeEventListener("error", s)
        }, r = o => {
          h(), m()
        }, s = o => {
          h(), e(o)
      ...
      load(a, m, e, h) {
        if (/^node\|/.test(m)) {
          let r = a.getConfig().getOptionsLiteral(), s = f(a.getRecorder(), r.nodeRequire || W.global.nodeRequire),
            o = m.split("|"), u = null;
          try {
            u = s(o[1])
          } catch (S) {
          ...
          r.setAttribute("async", "async"), r.setAttribute("type", "text/javascript"), this.attachListeners(r, e, h);
          ...
          o && r.setAttribute("nonce", o), document.getElementsByTagName("head")[0].appendChild(r)
        }
      }
    }
    ...
    class A {
      ...
      _canUseEval(a) {
        return this._cachedCanUseEval === null && (this._cachedCanUseEval = x(a)), this._cachedCanUseEval
      }

      load(a, m, e, h) {
        if (/^node\|/.test(m)) {
          const r = a.getConfig().getOptionsLiteral(), s = f(a.getRecorder(), r.nodeRequire || W.global.nodeRequire),
            o = m.split("|");
          let u = null;
          try {
            u = s(o[1])
          ...
          if (!(/^((http:)|(https:)|(file:))/.test(m) && m.substring(0, self.origin.length) !== self.origin) && this._canUseEval(a)) {
            fetch(m).then(o => {
              if (o.status !== 200) throw new Error(o.statusText);
              return o.text()
            }).then(o => {
              o = `${o}
//# sourceURL=${m}`, (r ? self.eval(r.createScript("", o)) : new Function(o)).call(self), e()
            }).then(void 0, h);
            return
          }
          try {
    ...
    class d {
      ...
      _init(a) {
        this._didInitialize || (this._didInitialize = !0, this._fs = a("fs"), this._vm = a("vm"), this._path = a("path"), this._crypto = a("crypto"))
      }
      ...
      _initNodeRequire(a, m) {
        ...
        function s(o) {
          ...
          return S.resolve = function (N, P) {
            return u._resolveFilename(N, o, !1, P)
          }, S.resolve.paths = function (N) {
            return u._resolveLookupPaths(N, o)
          }, S.main = process.mainModule, S.extensions = u._extensions, S.cache = u._cache, S
        }

        r.prototype._compile = function (o, u) {
          const S = r.wrap(o.replace(/^#!.*/, "")), L = m.getRecorder(), N = h._getCachedDataPath(e, u),
            P = {filename: u};
          let E;
          try {
            const y = h._fs.readFileSync(N);
            E = y.slice(0, 16), P.cachedData = y.slice(16), L.record(60, N)
          } catch {
            L.record(61, N)
          }
          const v = new h._vm.Script(S, P), l = v.runInThisContext(P), b = h._path.dirname(u), g = s(this),
            w = [this.exports, g, this, u, b, process, Me, Buffer], M = l.apply(this.exports, w);
          return h._handleCachedData(v, S, N, !P.cachedData, m), h._verifyCachedData(v, S, N, E, m), M
        }
      }

      load(a, m, e, h) {
        const r = a.getConfig().getOptionsLiteral(), s = f(a.getRecorder(), r.nodeRequire || W.global.nodeRequire),
          o = r.nodeInstrumenter || function (S) {
            return S
          };
        this._init(s), this._initNodeRequire(s, a);
        let u = a.getRecorder();
        if (/^node\|/.test(m)) {
          let S = m.split("|"), L = null;
          try {
            L = s(S[1])
          } catch (N) {
            h(N);
          ...
          const S = this._path.normalize(m), L = this._getElectronRendererScriptPathOrUri(S), N = !!r.nodeCachedData,
          ...
          this._readSourceAndCachedData(S, P, u, (E, v, l, b) => {
            ...
            let g;
            v.charCodeAt(0) === d._BOM ? g = d._PREFIX + v.substring(1) + d._SUFFIX : g = d._PREFIX + v + d._SUFFIX, g = o(g, S);
            const w = {filename: L, cachedData: l}, M = this._createAndEvalScript(a, g, w, e, h);
            this._handleCachedData(M, g, P, N && !l, a), this._verifyCachedData(M, g, P, b, a)
          })
        }
      }
      ...
      _createAndEvalScript(a, m, e, h, r) {
        ...
        const o = new this._vm.Script(m, e), u = o.runInThisContext(e), S = a.getGlobalAMDDefineFunc();
        let L = !1;
        const N = function () {
          return L = !0, S.apply(null, arguments)
        };
        return N.amd = S.amd, u.call(W.global, a.getGlobalAMDRequireFunc(), N, e.filename, this._path.dirname(e.filename)), s.record(32, e.filename), L ? h() : r(new Error(`Didn't receive define call in ${e.filename}!`)), o
      }

      _getElectronRendererScriptPathOrUri(a) {
        if (!this._env.isElectronRenderer) return a;
        let m = a.match(/^([a-z])\:(.*)/i);
        return m ? `file:///${(m[1].toUpperCase() + ":" + m[2]).replace(/\\/g, "/")}` : `file://${a}`
      }

      _getCachedDataPath(a, m) {
        const e = this._crypto.createHash("md5").update(m, "utf8").update(a.seed, "utf8").update(process.arch, "").digest("hex"),
          h = this._path.basename(m).replace(/\.js$/, "");
        return this._path.join(a.path, `${h}-${e}.code`)
      }

      _handleCachedData(a, m, e, h, r) {
        a.cachedDataRejected ? this._fs.unlink(e, s => {
          r.getRecorder().record(62, e), this._createAndWriteCachedData(a, m, e, r), s && r.getConfig().onError(s)
        }) : h && this._createAndWriteCachedData(a, m, e, r)
      }

      _createAndWriteCachedData(a, m, e, h) {
        let r = Math.ceil(h.getConfig().getOptionsLiteral().nodeCachedData.writeDelay * (1 + Math.random())), s = -1,
          o = 0, u;
        const S = () => {
          setTimeout(() => {
            u || (u = this._crypto.createHash("md5").update(m, "utf8").digest());
            ...
            if (!(L.length === 0 || L.length === s || o >= 5)) {
              ...
              s = L.length, this._fs.writeFile(e, Buffer.concat([u, L]), N => {
                N && h.getConfig().onError(N), h.getRecorder().record(63, e), S()
              })
            }
          }, r * Math.pow(4, o++))
        };
      ...
      _readSourceAndCachedData(a, m, e, h) {
        if (!m) this._fs.readFile(a, {encoding: "utf8"}, h); else {
          let r, s, o, u = 2;
          const S = L => {
          ...
          this._fs.readFile(a, {encoding: "utf8"}, (L, N) => {
            ...
            !L && N && N.length > 0 ? (o = N.slice(0, 16), s = N.slice(16), e.record(60, m)) : e.record(61, m), S()
          })
        }
      }

      _verifyCachedData(a, m, e, h, r) {
        h && (a.cachedDataRejected || setTimeout(() => {
          const s = this._crypto.createHash("md5").update(m, "utf8").digest();
          h.equals(s) || (r.getConfig().onError(new Error(`FAILED TO VERIFY CACHED DATA, deleting stale '${e}' now, but a RESTART IS REQUIRED`)), this._fs.unlink(e, o => {
  ...
  (function (W) {
    class n {
      constructor(c) {
        let a = c.lastIndexOf("/");
        a !== -1 ? this.fromModulePath = c.substr(0, a + 1) : this.fromModulePath = ""
      }

      static _normalizeModuleId(c) {
        let a = c, m;
        for (m = /\/\.\//; m.test(a);) a = a.replace(m, "/");
        for (a = a.replace(/^\.\//g, ""), m = /\/(([^\/])|([^\/][^\/\.])|([^\/\.][^\/])|([^\/][^\/][^\/]+))\/\.\.\//; m.test(a);) a = a.replace(m, "/");
        return a = a.replace(/^(([^\/])|([^\/][^\/\.])|([^\/\.][^\/])|([^\/][^\/][^\/]+))\/\.\.\//, ""), a
      }

      resolveModule(c) {
        let a = c;
        return W.Utilities.isAbsolutePath(a) || (W.Utilities.startsWith(a, "./") || W.Utilities.startsWith(a, "../")) && (a = n._normalizeModuleId(this.fromModulePath + a)), a
      }
    }
    ...
    class i {
      constructor(c, a, m, e, h, r) {
        this.id = c, this.strId = a, this.dependencies = m, this._callback = e, this._errorback = h, this.moduleIdResolver = r, this.exports = {}, this.error = null, this.exportsPassedIn = !1, this.unresolvedDependenciesCount = this.dependencies.length, this._isComplete = !1
      }
      ...
      static _invokeFactory(c, a, m, e) {
        return c.shouldInvokeFactory(a) ? c.shouldCatchError() ? this._safeInvokeFunction(m, e) : {
          returnedValue: m.apply(W.global, e),
          producedError: null
      ...
      complete(c, a, m, e) {
        ...
        if (this._callback) if (typeof this._callback == "function") {
          ...
          h = r.producedError, c.record(22, this.strId), !h && typeof r.returnedValue < "u" && (!this.exportsPassedIn || W.Utilities.isEmpty(this.exports)) && (this.exports = r.returnedValue)
        } else this.exports = this._callback;
        if (h) {
          let r = W.ensureError(h);
          r.phase = "factory", r.moduleId = this.strId, r.neededBy = e(this.id), this.error = r, a.onError(r)
        }
    ...
    class x {
      ...
      getModuleId(c) {
        ...
        return typeof a > "u" && (a = this._nextId++, this._strModuleIdToIntModuleId.set(c, a), this._intModuleIdToStrModuleId[a] = c), a
      }
    ...
    A.EXPORTS = new A(0), A.MODULE = new A(1), A.REQUIRE = new A(2), W.RegularDependency = A;
    ...
    class f {
      ...
      reset() {
        return new f(this._env, this._scriptLoader, this._defineFunc, this._requireFunc, this._loaderAvailableTimestamp)
      }
      ...
      static _findRelevantLocationInStack(c, a) {
        let m = r => r.replace(/\\/g, "/"), e = m(c), h = a.split(/\n/);
        for (let r = 0; r < h.length; r++) {
          let s = h[r].match(/(.*):(\d+):(\d+)\)?$/);
          if (s) {
            let o = s[1], u = s[2], S = s[3], L = Math.max(o.lastIndexOf(" ") + 1, o.lastIndexOf("(") + 1);
      ...
      getBuildInfo() {
        ...
        for (let m = 0, e = this._modules2.length; m < e; m++) {
          ...
          if (!h) continue;
          let r = this._buildInfoPath[h.id] || null, s = this._buildInfoDefineStack[h.id] || null,
            o = this._buildInfoDependencies[h.id];
          c[a++] = {
            id: h.strId,
            path: r,
            defineLocation: r && s ? f._findRelevantLocationInStack(r, s) : null,
            dependencies: o,
            shim: null,
            exports: h.exports
          }
      ...
      getRecorder() {
        return this._recorder || (this._config.shouldRecordStats() ? this._recorder = new W.LoaderEventRecorder(this._loaderAvailableTimestamp) : this._recorder = W.NullLoaderEventRecorder.INSTANCE), this._recorder
      }
      ...
      enqueueDefineAnonymousModule(c, a) {
        ...
        let m = null;
        this._config.isBuild() && (m = new Error("StackLocation").stack || null), this._currentAnonymousDefineCall = {
          stack: m,
          dependencies: c,
          callback: a
        }
      ...
      defineModule(c, a, m, e, h, r = new n(c)) {
        ...
        this._modules2[s] = o, this._config.isBuild() && (this._buildInfoDefineStack[s] = h, this._buildInfoDependencies[s] = (o.dependencies || []).map(u => this._moduleIdProvider.getStrModuleId(u.id))), this._resolve(o)
      }
      ...
      _normalizeDependency(c, a) {
        ...
        let m = c.indexOf("!");
        if (m >= 0) {
          let e = a.resolveModule(c.substr(0, m)), h = a.resolveModule(c.substr(m + 1)),
            r = this._moduleIdProvider.getModuleId(e + "!" + h), s = this._moduleIdProvider.getModuleId(e);
          return new d(r, s, h)
        }
      ...
      _normalizeDependencies(c, a) {
        let m = [], e = 0;
        for (let h = 0, r = c.length; h < r; h++) m[e++] = this._normalizeDependency(c[h], a);
        return m
      }

      _relativeRequire(c, a, m, e) {
        if (typeof a == "string") return this.synchronousRequire(a, c);
        this.defineModule(W.Utilities.generateAnonymousModule(), a, m, e, null, c)
      }

      synchronousRequire(c, a = new n(c)) {
        let m = this._normalizeDependency(c, a), e = this._modules2[m.id];
      ...
      configure(c, a) {
        ...
        a ? this._config = new W.Configuration(this._env, c) : this._config = this._config.cloneAndMerge(c), this._config.shouldRecordStats() && !m && (this._recorder = null)
      }
      ...
      _onLoad(c) {
        if (this._currentAnonymousDefineCall !== null) {
          ...
          this._currentAnonymousDefineCall = null, this.defineModule(this._moduleIdProvider.getStrModuleId(c), a.dependencies, a.callback, null, a.stack)
        }
      }

      _createLoadError(c, a) {
        let m = this._moduleIdProvider.getStrModuleId(c),
          e = (this._inverseDependencies2[c] || []).map(r => this._moduleIdProvider.getStrModuleId(r));
      ...
      _onLoadError(c, a) {
        ...
        this._modules2[c] || (this._modules2[c] = new i(c, this._moduleIdProvider.getStrModuleId(c), [], () => {
        }, null, null));
        let e = [];
        for (let s = 0, o = this._moduleIdProvider.getMaxModuleId(); s < o; s++) e[s] = !1;
        let h = !1, r = [];
        for (r.push(c), e[c] = !0; r.length > 0;) {
          let s = r.shift(), o = this._modules2[s];
          o && (h = o.onDependencyError(m) || h);
          let u = this._inverseDependencies2[s];
          if (u) for (let S = 0, L = u.length; S < L; S++) {
            let N = u[S];
            e[N] || (r.push(N), e[N] = !0)
          }
        }
      ...
      _hasDependencyPath(c, a) {
        ...
        if (!m) return !1;
        let e = [];
        for (let r = 0, s = this._moduleIdProvider.getMaxModuleId(); r < s; r++) e[r] = !1;
        let h = [];
        for (h.push(m), e[c] = !0; h.length > 0;) {
          let s = h.shift().dependencies;
          if (s) for (let o = 0, u = s.length; o < u; o++) {
            let S = s[o];
            if (S.id === a) return !0;
      ...
      _findCyclePath(c, a, m) {
        ...
        if (h) for (let r = 0, s = h.length; r < s; r++) {
      ...
      _createRequire(c) {
        ...
        return a.toUrl = m => this._config.requireToUrl(c.resolveModule(m)), a.getStats = () => this.getLoaderEvents(), a.hasDependencyCycle = () => this._hasDependencyCycle, a.config = (m, e = !1) => {
          this.configure(m, e)
        }, a.__$__nodeRequire = W.global.nodeRequire, a
      }

      _loadModule(c) {
        if (this._modules2[c] || this._knownModules2[c]) return;
        this._knownModules2[c] = !0;
        let a = this._moduleIdProvider.getStrModuleId(c), m = this._config.moduleIdToPaths(a), e = /^@[^\/]+\/[^\/]+$/;
        this._env.isNode && (a.indexOf("/") === -1 || e.test(a)) && m.push("node|" + a);
        let h = -1, r = s => {
          if (h++, h >= m.length) this._onLoadError(c, s); else {
            let o = m[h], u = this.getRecorder();
            if (this._config.isBuild() && o === "empty:") {
              this._buildInfoPath[c] = o, this.defineModule(this._moduleIdProvider.getStrModuleId(c), [], null, null, null), this._onLoad(c);
              return
            }
            u.record(10, o), this._scriptLoader.load(this, o, () => {
              this._config.isBuild() && (this._buildInfoPath[c] = o), u.record(11, o), this._onLoad(c)
            }, S => {
              u.record(12, o), r(S)
            })
          }
      ...
      _loadPluginDependency(c, a) {
        ...
        }, c.load(a.pluginParam, this._createRequire(n.ROOT), m, this._config.getOptionsLiteral())
      }

      _resolve(c) {
        let a = c.dependencies;
        if (a) for (let m = 0, e = a.length; m < e; m++) {
          let h = a[m];
          if (h === A.EXPORTS) {
          ...
          if (this._hasDependencyPath(h.id, c.id)) {
            this._hasDependencyCycle = !0, console.warn("There is a dependency cycle between '" + this._moduleIdProvider.getStrModuleId(h.id) + "' and '" + this._moduleIdProvider.getStrModuleId(c.id) + "'. The cyclic path follows:");
            let s = this._findCyclePath(h.id, c.id, 0) || [];
            s.reverse(), s.push(h.id), console.warn(s.map(o => this._moduleIdProvider.getStrModuleId(o)).join(` =>
`)), c.unresolvedDependenciesCount--;
            continue
          }
          if (this._inverseDependencies2[h.id] = this._inverseDependencies2[h.id] || [], this._inverseDependencies2[h.id].push(c.id), h instanceof d) {
            ...
            o || (o = [], this._inversePluginDependencies2.set(h.pluginId, o)), o.push(h), this._loadModule(h.pluginId);
            continue
          }
      ...
      _onModuleComplete(c) {
        ...
        let m = c.dependencies, e = [];
        if (m) for (let o = 0, u = m.length; o < u; o++) {
          let S = m[o];
          if (S === A.EXPORTS) {
            e[o] = c.exports;
            continue
          ...
          if (S === A.MODULE) {
            e[o] = {id: c.strId, config: () => this._config.getConfigForModule(c.strId)};
            continue
          }
          if (S === A.REQUIRE) {
        ...
        const h = o => (this._inverseDependencies2[o] || []).map(u => this._moduleIdProvider.getStrModuleId(u));
        c.complete(a, this._config, e, h);
        let r = this._inverseDependencies2[c.id];
        if (this._inverseDependencies2[c.id] = null, r) for (let o = 0, u = r.length; o < u; o++) {
          let S = r[o], L = this._modules2[S];
          L.unresolvedDependenciesCount--, L.unresolvedDependenciesCount === 0 && this._onModuleComplete(L)
        }
        let s = this._inversePluginDependencies2.get(c.id);
        if (s) {
          this._inversePluginDependencies2.delete(c.id);
          for (let o = 0, u = s.length; o < u; o++) this._loadPluginDependency(c.exports, s[o])
        }
      }
    }
  ...
  (function (W) {
    ...
    const x = function (p, c, a) {
      typeof p != "string" && (a = c, c = p, p = null), (typeof c != "object" || !Array.isArray(c)) && (a = c, c = null), c || (c = ["require", "exports", "module"]), p ? i.defineModule(p, c, a, null, null) : i.enqueueDefineAnonymousModule(c, a)
    };
    x.amd = {jQuery: !0};
    const A = function (p, c = !1) {
      ...
      if (arguments.length === 1) {
        ...
        if (typeof arguments[0] == "string") return i.synchronousRequire(arguments[0])
      }
      if ((arguments.length === 2 || arguments.length === 3) && Array.isArray(arguments[0])) {
        i.defineModule(W.Utilities.generateAnonymousModule(), arguments[0], arguments[1], arguments[2], null);
        return
      }
      throw new Error("Unrecognized require call")
    };
    d.config = A, d.getConfig = function () {
    ...
    function f() {
      if (typeof W.global.require < "u" || typeof require < "u") {
        ...
        if (typeof p == "function" && typeof p.resolve == "function") {
          ...
          W.global.nodeRequire = c, d.nodeRequire = c, d.__$__nodeRequire = c
        }
      }
      n.isNode && !n.isElectronRenderer && !n.isElectronNodeIntegrationWebWorker ? module.exports = d : (n.isElectronRenderer || (W.global.define = x), W.global.require = d)
    }

    W.init = f, (typeof W.global.define != "function" || !W.global.define.amd) && (i = new W.ModuleManager(n, W.createScriptLoader(n), x, d, W.Utilities.getHighPerformanceTimestamp()), typeof W.global.require < "u" && typeof W.global.require != "function" && d.config(W.global.require), X = function () {
      return x.apply(null, arguments)
    }, X.amd = x.amd, typeof doNotInitLoader > "u" && f())
  })(ie || (ie = {})), function () {
    const W = globalThis.MonacoEnvironment, n = W && W.baseUrl ? W.baseUrl : "../../../";

    function i(e, h) {
      if (W?.createTrustedTypesPolicy) try {
    ...
    const x = i("amdLoader", {
      createScriptURL: e => e, createScript: (e, ...h) => {
        const r = h.slice(0, -1).join(","), s = h.pop().toString();
    ...
    function A() {
      try {
        return (x ? globalThis.eval(x.createScript("", "true")) : new Function("true")).call(globalThis), !0
      } catch {
        return !1
      }
    }
    ...
    function d() {
      return new Promise((e, h) => {
        ...
        if (!(/^((http:)|(https:)|(file:))/.test(r) && r.substring(0, globalThis.origin.length) !== globalThis.origin) && A()) {
          fetch(r).then(o => {
            if (o.status !== 200) throw new Error(o.statusText);
            return o.text()
          }).then(o => {
            o = `${o}
//# sourceURL=${r}`, (x ? globalThis.eval(x.createScript("", o)) : new Function(o)).call(globalThis), e()
          }).then(void 0, h);
          return
        }
    ...
    function f() {
      require.config({baseUrl: n, catchError: !0, trustedTypesPolicy: x, amdModulesPattern: /^vs\//})
    }

    function p(e) {
      return d().then(() => (f(), new Promise((h, r) => {
        require([e], h, r)
      })))
    }
    ...
    function c(e) {
      setTimeout(function () {
        ...
        for (self.onmessage = r => h.onmessage(r.data, r.ports); m.length > 0;) self.onmessage(m.shift())
      }, 0)
    }
    ...
    "use strict";
    Object.defineProperty(n, "__esModule", {value: !0}), n.Permutation = n.CallbackIterable = n.ArrayQueue = n.booleanComparator = n.numberComparator = n.CompareResult = void 0, n.tail = i, n.tail2 = x, n.equals = A, n.removeFastWithoutKeepingOrder = d, n.binarySearch = f, n.binarySearch2 = p, n.quickSelect = c, n.groupBy = a, n.groupAdjacentBy = m, n.forEachAdjacent = e, n.forEachWithNeighbors = h, n.coalesce = r, n.coalesceInPlace = s, n.isFalsyOrEmpty = o, n.isNonEmptyArray = u, n.distinct = S, n.firstOrDefault = L, n.range = N, n.arrayInsert = P, n.pushToStart = E, n.pushToEnd = v, n.pushMany = l, n.asArray = b, n.insertInto = g, n.splice = w, n.compareBy = _, n.tieBreakComparators = C, n.reverseOrder = T;
    ...
    function p(F, q) {
      ...
      for (; B <= G;) {
        const $ = (B + G) / 2 | 0, U = q($);
        if (U < 0) B = $ + 1; else if (U > 0) G = $ - 1; else return $
      }
      return -(B + 1)
    }
    ...
    function c(F, q, B) {
      ...
      const G = q[Math.floor(q.length * Math.random())], $ = [], U = [], ee = [];
      for (const re of q) {
        const ue = B(re, G);
        ue < 0 ? $.push(re) : ue > 0 ? U.push(re) : ee.push(re)
      }
      return F < $.length ? c(F, $, B) : F < $.length + ee.length ? ee[0] : c(F - ($.length + ee.length), U, B)
    }

    function a(F, q) {
      const B = [];
      let G;
      for (const $ of F.slice(0).sort(q)) !G || q(G[0], $) !== 0 ? (G = [$], B.push(G)) : G.push($);
      return B
    }

    function* m(F, q) {
      let B, G;
      for (const $ of F) G !== void 0 && q(G, $) ? B.push($) : (B && (yield B), B = [$]), G = $;
      B && (yield B)
    }

    function e(F, q) {
      for (let B = 0; B <= F.length; B++) q(B === 0 ? void 0 : F[B - 1], B === F.length ? void 0 : F[B])
    }

    function h(F, q) {
      for (let B = 0; B < F.length; B++) q(B === 0 ? void 0 : F[B - 1], F[B], B + 1 === F.length ? void 0 : F[B + 1])
    }
    ...
    function N(F, q) {
      ...
      const G = [];
      if (B <= q) for (let $ = B; $ < q; $++) G.push($); else for (let $ = B; $ > q; $--) G.push($);
      return G
    }

    function P(F, q, B) {
      const G = F.slice(0, q), $ = F.slice(q);
      return G.concat(B, $)
    }
    ...
    function g(F, q, B) {
      const G = M(F, q), $ = F.length, U = B.length;
      F.length = $ + U;
    ...
    (function (F) {
      ...
      F.isNeitherLessOrGreaterThan = $, F.greaterThan = 1, F.lessThan = -1, F.neitherLessOrGreaterThan = 0
    })(y || (n.CompareResult = y = {}));
    ...
    class O {
      constructor(q) {
        this.items = q, this.firstIdx = 0, this.lastIdx = this.items.length - 1
      }
      ...
      takeWhile(q) {
        ...
        const G = B === this.firstIdx ? null : this.items.slice(this.firstIdx, B);
      ...
      takeFromEndWhile(q) {
        ...
        const G = B === this.lastIdx ? null : this.items.slice(B + 1, this.lastIdx + 1);
    ...
    class z {
      ...
      findLastMaxBy(q) {
        let B, G = !0;
        return this.iterate($ => ((G || y.isGreaterThan(q($, B))) && (G = !1, B = $), !0)), B
      }
    }
    ...
    class j {
      ...
      inverse() {
        ...
        for (let B = 0; B < this._indexMap.length; B++) q[this._indexMap[B]] = B;
        return new j(q)
      }
    }
    ...
    "use strict";
    Object.defineProperty(n, "__esModule", {value: !0}), n.MonotonousArray = void 0, n.findLast = i, n.findLastIdx = x, n.findLastMonotonous = A, n.findLastIdxMonotonous = d, n.findFirstMonotonous = f, n.findFirstIdxMonotonousOrArrLen = p, n.findFirstMax = a, n.findLastMax = m, n.findFirstMin = e, n.findMaxIdx = h, n.mapFindFirst = r;
      ...
      findLastMonotonous(o) {
        if (c.assertInvariants) {
          if (this._prevFindLastPredicate) {
            for (const S of this._array) if (this._prevFindLastPredicate(S) && !o(S)) throw new Error("MonotonousArray: current predicate must be weaker than (or equal to) the previous predicate.")
          }
          this._prevFindLastPredicate = o
        }
        const u = d(this._array, o, this._findLastMonotonousLastIdx);
        return this._findLastMonotonousLastIdx = u + 1, u === -1 ? void 0 : this._array[u]
      }
    }
    ...
    "use strict";
    Object.defineProperty(n, "__esModule", {value: !0}), n.CachedFunction = n.LRUCachedFunction = void 0, n.identity = i;
    ...
    class x {
      constructor(f, p) {
        this.lastCache = void 0, this.lastArgKey = void 0, typeof f == "function" ? (this._fn = f, this._computeKey = i) : (this._fn = p, this._computeKey = f.getCacheKey)
      }

      get(f) {
        const p = this._computeKey(f);
        return this.lastArgKey !== p && (this.lastArgKey = p, this.lastCache = this._fn(f)), this.lastCache
      }
    }
    ...
    class A {
      ...
      constructor(f, p) {
        this._map = new Map, this._map2 = new Map, typeof f == "function" ? (this._fn = f, this._computeKey = i) : (this._fn = p, this._computeKey = f.getCacheKey)
      }
    ...
    "use strict";
    Object.defineProperty(n, "__esModule", {value: !0}), n.Color = n.HSVA = n.HSLA = n.RGBA = void 0;
    ...
    class x {
      constructor(c, a, m, e = 1) {
        this._rgbaBrand = void 0, this.r = Math.min(255, Math.max(0, c)) | 0, this.g = Math.min(255, Math.max(0, a)) | 0, this.b = Math.min(255, Math.max(0, m)) | 0, this.a = i(Math.max(Math.min(1, e), 0), 3)
      }
    ...
    class A {
      constructor(c, a, m, e) {
        this._hslaBrand = void 0, this.h = Math.max(Math.min(360, c), 0) | 0, this.s = i(Math.max(Math.min(1, a), 0), 3), this.l = i(Math.max(Math.min(1, m), 0), 3), this.a = i(Math.max(Math.min(1, e), 0), 3)
      }
      ...
      static fromRGBA(c) {
        const a = c.r / 255, m = c.g / 255, e = c.b / 255, h = c.a, r = Math.max(a, m, e), s = Math.min(a, m, e);
        let o = 0, u = 0;
        const S = (s + r) / 2, L = r - s;
        if (L > 0) {
          switch (u = Math.min(S <= .5 ? L / (2 * S) : L / (2 - 2 * S), 1), r) {
            case a:
              o = (m - e) / L + (m < e ? 6 : 0);
              break;
            case m:
      ...
      static _hue2rgb(c, a, m) {
        return m < 0 && (m += 1), m > 1 && (m -= 1), m < 1 / 6 ? c + (a - c) * 6 * m : m < 1 / 2 ? a : m < 2 / 3 ? c + (a - c) * (2 / 3 - m) * 6 : c
      }

      static toRGBA(c) {
        const a = c.h / 360, {s: m, l: e, a: h} = c;
        let r, s, o;
        if (m === 0) r = s = o = e; else {
          const u = e < .5 ? e * (1 + m) : e + m - e * m, S = 2 * e - u;
          r = A._hue2rgb(S, u, a + 1 / 3), s = A._hue2rgb(S, u, a), o = A._hue2rgb(S, u, a - 1 / 3)
        }
        return new x(Math.round(r * 255), Math.round(s * 255), Math.round(o * 255), h)
      }
    }
    ...
    class d {
      constructor(c, a, m, e) {
        this._hsvaBrand = void 0, this.h = Math.max(Math.min(360, c), 0) | 0, this.s = i(Math.max(Math.min(1, a), 0), 3), this.v = i(Math.max(Math.min(1, m), 0), 3), this.a = i(Math.max(Math.min(1, e), 0), 3)
      }
      ...
      static fromRGBA(c) {
        const a = c.r / 255, m = c.g / 255, e = c.b / 255, h = Math.max(a, m, e), r = Math.min(a, m, e), s = h - r,
          o = h === 0 ? 0 : s / h;
        let u;
        return s === 0 ? u = 0 : h === a ? u = ((m - e) / s % 6 + 6) % 6 : h === m ? u = (e - a) / s + 2 : u = (a - m) / s + 4, new d(Math.round(u * 60), o, h, c.a)
      }

      static toRGBA(c) {
        const {h: a, s: m, v: e, a: h} = c, r = e * m, s = r * (1 - Math.abs(a / 60 % 2 - 1)), o = e - r;
        let [u, S, L] = [0, 0, 0];
        return a < 60 ? (u = r, S = s) : a < 120 ? (u = s, S = r) : a < 180 ? (S = r, L = s) : a < 240 ? (S = s, L = r) : a < 300 ? (u = s, L = r) : a <= 360 && (u = r, L = s), u = Math.round((u + o) * 255), S = Math.round((S + o) * 255), L = Math.round((L + o) * 255), new x(u, S, L, h)
      }
    }
    ...
    class f {
      ...
      constructor(c) {
        if (c) if (c instanceof x) this.rgba = c; else if (c instanceof A) this._hsla = c, this.rgba = A.toRGBA(c); else if (c instanceof d) this._hsva = c, this.rgba = d.toRGBA(c); else throw new Error("Invalid color ctor argument"); else throw new Error("Color needs a value")
      }

      equals(c) {
        return !!c && x.equals(this.rgba, c.rgba) && A.equals(this.hsla, c.hsla) && d.equals(this.hsva, c.hsva)
      }

      getRelativeLuminance() {
        const c = f._relativeLuminanceForComponent(this.rgba.r), a = f._relativeLuminanceForComponent(this.rgba.g),
          m = f._relativeLuminanceForComponent(this.rgba.b), e = .2126 * c + .7152 * a + .0722 * m;
        return i(e, 4)
      }
      ...
      isLighterThan(c) {
        const a = this.getRelativeLuminance(), m = c.getRelativeLuminance();
        return a > m
      }
      ...
      lighten(c) {
        return new f(new A(this.hsla.h, this.hsla.s, this.hsla.l + this.hsla.l * c, this.hsla.a))
      }
      ...
      opposite() {
        return new f(new x(255 - this.rgba.r, 255 - this.rgba.g, 255 - this.rgba.b, this.rgba.a))
      }

      makeOpaque(c) {
        if (this.isOpaque() || c.rgba.a !== 1) return this;
        const {r: a, g: m, b: e, a: h} = this.rgba;
        return new f(new x(c.rgba.r - h * (c.rgba.r - a), c.rgba.g - h * (c.rgba.g - m), c.rgba.b - h * (c.rgba.b - e), 1))
      }
      ...
      static getLighterColor(c, a, m) {
        ...
        m = m || .5;
        const e = c.getRelativeLuminance(), h = a.getRelativeLuminance();
    ...
    n.Color = f, function (p) {
      let c;
      (function (a) {
        let m;
        (function (e) {
          function h(v) {
            return v.rgba.a === 1 ? `rgb(${v.rgba.r}, ${v.rgba.g}, ${v.rgba.b})` : p.Format.CSS.formatRGBA(v)
          }
          ...
          function s(v) {
            return v.hsla.a === 1 ? `hsl(${v.hsla.h}, ${(v.hsla.s * 100).toFixed(2)}%, ${(v.hsla.l * 100).toFixed(2)}%)` : p.Format.CSS.formatHSLA(v)
          }
          ...
          function L(v, l = !1) {
            return l && v.rgba.a === 1 ? p.Format.CSS.formatHex(v) : `#${u(v.rgba.r)}${u(v.rgba.g)}${u(v.rgba.b)}${u(Math.round(v.rgba.a * 255))}`
          }

          e.formatHexA = L;

          function N(v) {
            return v.isOpaque() ? p.Format.CSS.formatHex(v) : p.Format.CSS.formatRGBA(v)
          }
          ...
          function P(v) {
            ...
            if (l === 7) {
              const b = 16 * E(v.charCodeAt(1)) + E(v.charCodeAt(2)), g = 16 * E(v.charCodeAt(3)) + E(v.charCodeAt(4)),
                w = 16 * E(v.charCodeAt(5)) + E(v.charCodeAt(6));
              return new p(new x(b, g, w, 1))
            }
            if (l === 9) {
              const b = 16 * E(v.charCodeAt(1)) + E(v.charCodeAt(2)), g = 16 * E(v.charCodeAt(3)) + E(v.charCodeAt(4)),
                w = 16 * E(v.charCodeAt(5)) + E(v.charCodeAt(6)), M = 16 * E(v.charCodeAt(7)) + E(v.charCodeAt(8));
              return new p(new x(b, g, w, M / 255))
            }
            if (l === 4) {
              const b = E(v.charCodeAt(1)), g = E(v.charCodeAt(2)), w = E(v.charCodeAt(3));
              return new p(new x(16 * b + b, 16 * g + g, 16 * w + w))
            }
            if (l === 5) {
              const b = E(v.charCodeAt(1)), g = E(v.charCodeAt(2)), w = E(v.charCodeAt(3)), M = E(v.charCodeAt(4));
              return new p(new x(16 * b + b, 16 * g + g, 16 * w + w, (16 * M + M) / 255))
            }
            return null
          }
    ...
    class i {
      constructor(A, d, f, p) {
        this.originalStart = A, this.originalLength = d, this.modifiedStart = f, this.modifiedLength = p
      }
    ...
    "use strict";
    Object.defineProperty(n, "__esModule", {value: !0}), n.BugIndicatingError = n.ErrorNoTelemetry = n.NotSupportedError = n.CancellationError = n.errorHandler = n.ErrorHandler = void 0, n.onUnexpectedError = x, n.onUnexpectedExternalError = A, n.transformErrorForSerialization = d, n.isCancellationError = p, n.canceled = a, n.illegalArgument = m, n.illegalState = e;

    class i {
      constructor() {
        this.listeners = [], this.unexpectedErrorHandler = function (u) {
          setTimeout(() => {
            throw u.stack ? r.isErrorNoTelemetry(u) ? new r(u.message + `
...
` + u.stack) : u
    ...
    function d(o) {
      if (o instanceof Error) {
        const {name: u, message: S} = o, L = o.stacktrace || o.stack;
        return {$isError: !0, name: u, message: S, stack: L, noTelemetry: r.isErrorNoTelemetry(o)}
      }
      return o
    }
    ...
    function p(o) {
      return o instanceof c ? !0 : o instanceof Error && o.name === f && o.message === f
    }
    ...
    class s extends Error {
      constructor(u) {
        super(u || "An unexpected bug occurred."), Object.setPrototypeOf(this, s.prototype)
      }
    }
    ...
    "use strict";
    Object.defineProperty(n, "__esModule", {value: !0}), n.ok = x, n.assertNever = A, n.softAssert = d, n.assertFn = f, n.checkAdjacentItems = p;

    function x(c, a) {
      if (!c) throw new Error(a ? `Assertion failed (${a})` : "Assertion Failed")
    }
    ...
    function d(c) {
      c || (0, i.onUnexpectedError)(new i.BugIndicatingError("Soft Assertion Failed"))
    }

    function f(c) {
      if (!c()) {
        debugger;
        c(), (0, i.onUnexpectedError)(new i.BugIndicatingError("Assertion Failed"))
      }
    }
    ...
    "use strict";
    Object.defineProperty(n, "__esModule", {value: !0}), n.createSingleCallFunction = i;
    ...
    (function (x) {
      ...
      function* P(l, b, g = l.length) {
        for (b < 0 && (b += l.length), g < 0 ? g += l.length : g > l.length && (g = l.length); b < g; b++) yield l[b]
      }
    ...
    "use strict";
    Object.defineProperty(n, "__esModule", {value: !0}), n.KeyCodeUtils = n.IMMUTABLE_KEY_CODE_TO_CODE = n.IMMUTABLE_CODE_TO_KEY_CODE = n.NATIVE_WINDOWS_KEY_CODE_TO_KEY_CODE = n.EVENT_KEY_CODE_MAP = void 0, n.KeyChord = m;
    ...
    class i {
      ...
      define(h, r) {
        this._keyCodeToStr[h] = r, this._strToKeyCode[r.toLowerCase()] = h
      }
    ...
    const x = new i, A = new i, d = new i;
    n.EVENT_KEY_CODE_MAP = new Array(230), n.NATIVE_WINDOWS_KEY_CODE_TO_KEY_CODE = {};
    const f = [], p = Object.create(null), c = Object.create(null);
    ...
    "use strict";
    Object.defineProperty(n, "__esModule", {value: !0}), n.DisposableMap = n.ImmortalReference = n.RefCountedDisposable = n.MutableDisposable = n.Disposable = n.DisposableStore = void 0, n.setDisposableTracker = f, n.trackDisposable = p, n.markAsDisposed = c, n.markAsSingleton = e, n.isDisposable = h, n.dispose = r, n.combinedDisposable = s, n.toDisposable = o;
    const A = !1;
    let d = null;
    ...
    function h(v) {
      return typeof v == "object" && v !== null && typeof v.dispose == "function" && v.dispose.length === 0
    }

    function r(v) {
      if (x.Iterable.is(v)) {
        const l = [];
        for (const b of v) if (b) try {
          b.dispose()
        } catch (g) {
          l.push(g)
        }
        if (l.length === 1) throw l[0];
        if (l.length > 1) throw new AggregateError(l, "Encountered errors while disposing of store");
    ...
    class u {
      ...
      add(l) {
        ...
        return a(l, this), this._isDisposed ? u.DISABLE_DISPOSED_WARNING || console.warn(new Error("Trying to add a disposable to a DisposableStore that has already been disposed of. The added object will be leaked!").stack) : this._toDispose.add(l), l
      }
    ...
    class L {
      ...
      set value(l) {
        this._isDisposed || l === this._value || (this._value?.dispose(), l && a(l, this), this._value = l)
      }
      ...
      dispose() {
        this._isDisposed = !0, c(this), this._value?.dispose(), this._value = void 0
      }
    }
    ...
    class E {
      ...
      set(l, b, g = !1) {
        this._isDisposed && console.warn(new Error("Trying to add a disposable to a DisposableMap that has already been disposed of. The added object will be leaked!").stack), g || this._store.get(l)?.dispose(), this._store.set(l, b)
      }
    ...
    class i {
      ...
      constructor(d) {
        this.element = d, this.next = i.Undefined, this.prev = i.Undefined
      }
    }
    ...
    class x {
      ...
      _insert(d, f) {
        const p = new i(d);
        if (this._first === i.Undefined) this._first = p, this._last = p; else if (f) {
          const a = this._last;
      ...
      _remove(d) {
        ...
        } else d.prev === i.Undefined && d.next === i.Undefined ? (this._first = i.Undefined, this._last = i.Undefined) : d.next === i.Undefined ? (this._last = this._last.prev, this._last.next = i.Undefined) : d.prev === i.Undefined && (this._first = this._first.next, this._first.prev = i.Undefined);
        this._size -= 1
      }
    ...
    "use strict";
    var i, x;
    Object.defineProperty(n, "__esModule", {value: !0}), n.SetMap = n.BidirectionalMap = n.LRUCache = n.LinkedMap = n.ResourceMap = void 0;
    ...
    class f {
      ...
      constructor(r, s) {
        if (this[i] = "ResourceMap", r instanceof f) this.map = new Map(r.map), this.toKey = s ?? f.defaultToKey; else if (d(r)) {
    ...
    class p {
      constructor() {
        this[x] = "LinkedMap", this._map = new Map, this._head = void 0, this._tail = void 0, this._size = 0, this._state = 0
      }
      ...
      set(r, s, o = 0) {
        ...
        if (u) u.value = s, o !== 0 && this.touch(u, o); else {
          switch (u = {key: r, value: s, next: void 0, previous: void 0}, o) {
            case 0:
              this.addItemLast(u);
              break;
            case 1:
      ...
      remove(r) {
        ...
        if (s) return this._map.delete(r), this.removeItem(s), this._size--, s.value
      }
      ...
      shift() {
        ...
        const r = this._head;
        return this._map.delete(r.key), this.removeItem(r), this._size--, r.value
      }
      ...
      forEach(r, s) {
        ...
        let u = this._head;
        for (; u;) {
          if (s ? r.bind(s)(u.value, u.key, this) : r(u.value, u.key, this), this._state !== o) throw new Error("LinkedMap got modified during iteration.");
          u = u.next
        }
      }

      keys() {
        const r = this, s = this._state;
        let o = this._head;
        const u = {
          [Symbol.iterator]() {
            return u
      ...
      trimNew(r) {
        ...
        let s = this._tail, o = this.size;
        for (; s && o > r;) this._map.delete(s.key), s = s.previous, o--;
        this._tail = s, this._size = o, s && (s.next = void 0), this._state++
      }

      addItemFirst(r) {
        if (!this._head && !this._tail) this._tail = r; else if (this._head) r.next = this._head, this._head.previous = r; else throw new Error("Invalid list");
        this._head = r, this._state++
      }

      addItemLast(r) {
        if (!this._head && !this._tail) this._head = r; else if (this._tail) r.previous = this._tail, this._tail.next = r; else throw new Error("Invalid list");
        this._tail = r, this._state++
      }

      removeItem(r) {
        if (r === this._head && r === this._tail) this._head = void 0, this._tail = void 0; else if (r === this._head) {
      ...
      touch(r, s) {
        ...
        if (!(s !== 1 && s !== 2)) {
          if (s === 1) {
            ...
            const o = r.next, u = r.previous;
            r === this._tail ? (u.next = void 0, this._tail = u) : (o.previous = u, u.next = o), r.previous = void 0, r.next = this._head, this._head.previous = r, this._head = r, this._state++
          } else if (s === 2) {
            if (r === this._tail) return;
            const o = r.next, u = r.previous;
            r === this._head ? (o.previous = void 0, this._head = o) : (o.previous = u, u.next = o), r.next = void 0, r.previous = this._tail, this._tail.next = r, this._tail = r, this._state++
          }
        }
      }
    ...
    class c extends p {
      constructor(r, s = 1) {
        super(), this._limit = r, this._ratio = Math.min(Math.max(0, s), 1)
      }
    ...
    class m {
      constructor(r) {
        if (this._m1 = new Map, this._m2 = new Map, r) for (const [s, o] of r) this.set(s, o)
      }
      ...
      delete(r) {
        ...
        return s === void 0 ? !1 : (this._m1.delete(r), this._m2.delete(s), !0)
      }
    ...
    const i = globalThis.performance && typeof globalThis.performance.now == "function";
    ...
    class x {
      ...
      constructor(d) {
        this._now = i && d === !1 ? Date.now : globalThis.performance.now.bind(globalThis.performance), this._startTime = this._now(), this._stopTime = -1
      }
    ...
    "use strict";
    Object.defineProperty(n, "__esModule", {value: !0}), n.Relay = n.EventBufferer = n.EventMultiplexer = n.MicrotaskEmitter = n.DebounceEmitter = n.PauseableEmitter = n.createEventDeliveryQueue = n.Emitter = n.ListenerRefusalError = n.ListenerLeakError = n.EventProfiling = n.Event = void 0;
    const p = !1, c = !1, a = !1;
    var m;
    (function (C) {
      ...
      function R(K) {
        if (a) {
          const {onDidAddListener: Q} = K, k = s.create();
          let I = 0;
          K.onDidAddListener = () => {
            ++I === 2 && (console.warn("snapshotted emitter LIKELY used public and SHOULD HAVE BEEN created with DisposableStore. snapshotted here"), k.print()), Q?.()
          }
        }
      }
      ...
      function F(K, Q, k) {
        return $((I, V = null, H) => K(Y => Q(Y) && I.call(V, Y), null, H), k)
      }
      ...
      function B(...K) {
        return (Q, k = null, I) => {
          const V = (0, A.combinedDisposable)(...K.map(H => H(Y => Q.call(k, Y))));
          return U(V, I)
        }
      }
      ...
      function ee(K, Q, k = 100, I = !1, V = !1, H, Y) {
        let te, ne, ae, le = 0, oe;
        const se = {
          leakWarningThreshold: H, onWillAddFirstListener() {
            te = K(he => {
              le++, ne = Q(ne, he), I && !ae && (ce.fire(ne), ne = void 0), oe = () => {
                const be = ne;
                ne = void 0, ae = void 0, (!I || le > 1) && ce.fire(be), le = 0
              }, typeof k == "number" ? (clearTimeout(ae), ae = setTimeout(oe, k)) : ae === void 0 && (ae = 0, queueMicrotask(oe))
            })
      ...
      function re(K, Q = 0, k) {
        return C.debounce(K, (I, V) => I ? (I.push(V), I) : [V], Q, void 0, !0, void 0, k)
      }
      ...
      function Le(K, Q, k = I => I) {
        const I = (...te) => Y.fire(k(...te)), V = () => K.on(Q, I), H = () => K.removeListener(Q, I),
          Y = new E({onWillAddFirstListener: V, onDidRemoveLastListener: H});
        return Y.event
      }
      ...
      function we(K, Q, k = I => I) {
        const I = (...te) => Y.fire(k(...te)), V = () => K.addEventListener(Q, I),
          H = () => K.removeEventListener(Q, I), Y = new E({onWillAddFirstListener: V, onDidRemoveLastListener: H});
        return Y.event
      }
        ...
        return (Q, k, I) => {
          ...
          const Y = {
            beginUpdate() {
              ...
              V--, V === 0 && (K.reportChanges(), H && (H = !1, Q.call(k)))
          ...
          return I instanceof A.DisposableStore ? I.add(te) : Array.isArray(I) && I.push(te), te
        }
      }
    ...
    class e {
      ...
      constructor(R) {
        this.listenerCount = 0, this.invocationCount = 0, this.elapsedOverall = 0, this.durations = [], this.name = `${R}_${e._idPool++}`, e.all.add(this)
      }
      ...
      stop() {
        if (this._stopWatch) {
          ...
          this.durations.push(R), this.elapsedOverall += R, this.invocationCount += 1, this._stopWatch = void 0
        }
      }
    }
    ...
    class r {
      ...
      constructor(R, D, T = (r._idPool++).toString(16).padStart(3, "0")) {
        this._errorHandler = R, this.threshold = D, this.name = T, this._warnCountdown = 0
      }
      ...
      check(R, D) {
        ...
        if (this._stacks.set(R.value, O + 1), this._warnCountdown -= 1, this._warnCountdown <= 0) {
          this._warnCountdown = T * .5;
      ...
      getMostFrequentStack() {
        ...
        let R, D = 0;
        for (const [T, O] of this._stacks) (!R || D < O) && (R = [T, O], D = O);
        return R
      }
    }
...
`))
    ...
    const L = 2, N = (C, R) => {
      if (C instanceof S) R(C); else for (let D = 0; D < C.length; D++) {
        const T = C[D];
        T && R(T)
      }
    };
    ...
    if (p) {
      const C = [];
      setInterval(() => {
        C.length !== 0 && (console.warn("[LEAKING LISTENERS] GC'ed these listeners that were NOT yet disposed:"), console.warn(C.join(`
`)), C.length = 0)
      }, 3e3), P = new FinalizationRegistry(R => {
    ...
    class E {
      constructor(R) {
        this._size = 0, this._options = R, this._leakageMon = h > 0 || this._options?.leakWarningThreshold ? new r(R?.onListenerError ?? i.onUnexpectedError, this._options?.leakWarningThreshold ?? h) : void 0, this._perfMon = this._options?._profName ? new e(this._options._profName) : void 0, this._deliveryQueue = this._options?.deliveryQueue
      }
      ...
      get event() {
        return this._event ??= (R, D, T) => {
          if (this._leakageMon && this._size > this._leakageMon.threshold ** 2) {
            ...
            console.warn(q);
            const B = this._leakageMon.getMostFrequentStack() ?? ["UNKNOWN stack", -1],
              G = new u(`${q}. HINT: Stack shows most frequent listener (${B[1]}-times)`, B[0]);
            return (this._options?.onListenerError || i.onUnexpectedError)(G), A.Disposable.None
          }
          ...
          if (T instanceof A.DisposableStore ? T.add(F) : Array.isArray(T) && T.push(F), P) {
            const q = new Error().stack.split(`
`).slice(2, 3).join(`
`).trim(), B = /(file:|vscode-file:\/\/vscode-app)?(\/[^:]*:\d+:\d+)/.exec(q);
      ...
      _removeListener(R) {
        ...
        const D = this._listeners, T = D.indexOf(R);
        ...
        if (this._size * L <= D.length) {
          let z = 0;
          for (let j = 0; j < D.length; j++) D[j] ? D[z++] = D[j] : O && (this._deliveryQueue.end--, z < this._deliveryQueue.i && this._deliveryQueue.i--);
          D.length = z
        }
      }
      ...
      fire(R) {
        if (this._deliveryQueue?.current && (this._deliverQueue(this._deliveryQueue), this._perfMon?.stop()), this._perfMon?.start(this._size), this._listeners) if (this._listeners instanceof S) this._deliver(this._listeners, R); else {
          const D = this._deliveryQueue;
          D.enqueue(this, R, this._listeners.length), this._deliverQueue(D)
        }
        this._perfMon?.stop()
      }
    ...
    class b extends E {
      constructor(R) {
        super(R), this._isPaused = 0, this._eventQueue = new d.LinkedList, this._mergeFn = R?.merge
      }
      ...
      fire(R) {
        this._size && (this._isPaused !== 0 ? this._eventQueue.push(R) : super.fire(R))
      }
    }
    ...
    class w extends E {
      ...
      fire(R) {
        this.hasListeners() && (this._queuedEvents.push(R), this._queuedEvents.length === 1 && queueMicrotask(() => {
          this._mergeFn ? super.fire(this._mergeFn(this._queuedEvents)) : this._queuedEvents.forEach(D => super.fire(D)), this._queuedEvents = []
        }))
      }
    }
    ...
    class M {
      constructor() {
        this.hasListeners = !1, this.events = [], this.emitter = new E({
      ...
      onLastListenerRemove() {
        this.hasListeners = !1, this.events.forEach(R => this.unhook(R))
      }
    ...
    class y {
      ...
      wrapEvent(R, D, T) {
        return (O, z, j) => R(F => {
          ...
          B.items ??= [], B.items.push(F), B.buffers.length === 0 && q.buffers.push(() => {
            B.reducedResult ??= T ? B.items.reduce(D, T) : B.items.reduce(D), O.call(z, B.reducedResult)
          })
        }, void 0, j)
      }
    ...
    class _ {
      constructor() {
        this.listening = !1, this.inputEvent = m.None, this.inputEventListener = A.Disposable.None, this.emitter = new E({
          onDidAddFirstListener: () => {
      ...
      set input(R) {
        this.inputEvent = R, this.listening && (this.inputEventListener.dispose(), this.inputEventListener = R(this.emitter.fire, this.emitter))
      }
    ...
    "use strict";
    Object.defineProperty(n, "__esModule", {value: !0}), n.CancellationTokenSource = n.CancellationToken = void 0, n.cancelOnDispose = p;
    ...
    (function (c) {
      function a(m) {
        return m === c.None || m === c.Cancelled || m instanceof d ? !0 : !m || typeof m != "object" ? !1 : typeof m.isCancellationRequested == "boolean" && typeof m.onCancellationRequested == "function"
      }

      c.isCancellationToken = a, c.None = Object.freeze({
        isCancellationRequested: !1,
        onCancellationRequested: i.Event.None
      }), c.Cancelled = Object.freeze({isCancellationRequested: !0, onCancellationRequested: x})
    ...
    class d {
      ...
      get onCancellationRequested() {
        return this._isCancelled ? x : (this._emitter || (this._emitter = new i.Emitter), this._emitter.event)
      }
    ...
    class f {
      constructor(a) {
        this._token = void 0, this._parentListener = void 0, this._parentListener = a && a.onCancellationRequested(this.cancel, this)
      }
      ...
      cancel() {
        this._token ? this._token instanceof d && this._token.cancel() : this._token = A.Cancelled
      }

      dispose(a = !1) {
        a && this.cancel(), this._parentListener?.dispose(), this._token ? this._token instanceof d && this._token.dispose() : this._token = A.None
      }
    }
    ...
    function f(k, ...I) {
      return I.length === 0 ? k : k.replace(d, function (V, H) {
    ...
    function o(k, I, V = {}) {
      ...
      I || (k = a(k)), V.wholeWord && (/\B/.test(k.charAt(0)) || (k = "\\b" + k), /\B/.test(k.charAt(k.length - 1)) || (k = k + "\\b"));
      let H = "";
      return V.global && (H += "g"), V.matchCase || (H += "i"), V.multiline && (H += "m"), V.unicode && (H += "u"), new RegExp(k, H)
    }
    ...
    function L(k) {
      const I = [], V = k.split(/(\r\n|\r|\n)/);
      for (let H = 0; H < Math.ceil(V.length / 2); H++) I.push(V[2 * H] + (V[2 * H + 1] ?? ""));
      return I
    }
    ...
    function l(k, I, V = 0, H = k.length, Y = 0, te = I.length) {
      for (; V < H && Y < te; V++, Y++) {
        const le = k.charCodeAt(V), oe = I.charCodeAt(Y);
        if (le < oe) return -1;
        if (le > oe) return 1
      }
      const ne = H - V, ae = te - Y;
    ...
    function g(k, I, V = 0, H = k.length, Y = 0, te = I.length) {
      for (; V < H && Y < te; V++, Y++) {
        let le = k.charCodeAt(V), oe = I.charCodeAt(Y);
        if (le === oe) continue;
        if (le >= 128 || oe >= 128) return l(k.toLowerCase(), I.toLowerCase(), V, H, Y, te);
    ...
    function R(k, I) {
      ...
      let H;
      for (H = 0; H < V; H++) if (k.charCodeAt(H) !== I.charCodeAt(H)) return H;
      return V
    }
    ...
    function D(k, I) {
      const V = Math.min(k.length, I.length);
      let H;
      const Y = k.length - 1, te = I.length - 1;
      for (H = 0; H < V; H++) if (k.charCodeAt(Y - H) !== I.charCodeAt(te - H)) return H;
      return V
    }
    ...
    class B {
      ...
      nextGraphemeLength() {
        const I = fe.getInstance(), V = this._iterator, H = V.offset;
        let Y = I.getGraphemeBreakType(V.nextCodePoint());
        for (; !V.eol();) {
          const te = V.offset, ne = I.getGraphemeBreakType(V.nextCodePoint());
          if (ve(Y, ne)) {
            V.setOffset(te);
            break
          }
      ...
      prevGraphemeLength() {
        ...
        for (; V.offset > 0;) {
          const te = V.offset, ne = I.getGraphemeBreakType(V.prevCodePoint());
          if (ve(ne, Y)) {
            V.setOffset(te);
            break
          }
    ...
    function we(k, I = !1) {
      return k ? (I && (k = k.replace(/\\./g, "")), k.toLowerCase() !== k) : !1
    }
    ...
    function ve(k, I) {
      return k === 0 ? I !== 5 && I !== 7 : k === 2 && I === 3 ? !1 : k === 4 || k === 2 || k === 3 || I === 4 || I === 2 || I === 3 ? !0 : !(k === 8 && (I === 8 || I === 9 || I === 11 || I === 12) || (k === 11 || k === 9) && (I === 9 || I === 10) || (k === 12 || k === 10) && I === 10 || I === 5 || I === 13 || I === 7 || k === 1 || k === 13 && I === 14 || k === 6 && I === 6)
    }
    ...
    class fe {
      ...
      getGraphemeBreakType(I) {
        ...
        if (I < 127) return 0;
        const V = this._data, H = V.length / 3;
        let Y = 1;
        for (; Y <= H;) if (I < V[3 * Y]) Y = 2 * Y; else if (I > V[3 * Y + 1]) Y = 2 * Y + 1; else return V[3 * Y + 2];
        return 0
      }
    }
    ...
    class K {
      ...
      static {
        this.cache = new i.LRUCachedFunction({getCacheKey: JSON.stringify}, I => {
          ...
          const le = V(te._common), oe = H(le, ae);
          return new K(oe)
        })
      }
      ...
      static {
        this._locales = new x.Lazy(() => Object.keys(K.ambiguousCharacterData.value).filter(I => !I.startsWith("_")))
      }
    ...
    class Q {
      ...
      static getData() {
        return this._data || (this._data = new Set(Q.getRawData())), this._data
      }
    ...
    "use strict";
    Object.defineProperty(n, "__esModule", {value: !0}), n.StringSHA1 = void 0, n.hash = x, n.doHash = A, n.numberHash = d, n.stringHash = p, n.toHexString = r;
    ...
    function A(o, u) {
      switch (typeof o) {
        case"object":
          return o === null ? d(349, u) : Array.isArray(o) ? c(o, u) : a(o, u);
        case"string":
          return p(o, u);
        case"boolean":
          return f(o, u);
    ...
    function a(o, u) {
      return u = d(181387, u), Object.keys(o).sort().reduce((S, L) => (S = p(L, S), A(o[L], S)), u)
    }
    ...
    function r(o, u = 32) {
      return o instanceof ArrayBuffer ? Array.from(new Uint8Array(o)).map(S => S.toString(16).padStart(2, "0")).join("") : h((o >>> 0).toString(16), u / 4)
    }
    ...
    class s {
      ...
      update(u) {
        ...
        if (S === 0) return;
        const L = this._buff;
        let N = this._buffLen, P = this._leftoverHighSurrogate, E, v;
        for (P !== 0 ? (E = P, v = -1, P = 0) : (E = u.charCodeAt(0), v = 0); ;) {
          let l = E;
          if (i.isHighSurrogate(E)) if (v + 1 < S) {
            const b = u.charCodeAt(v + 1);
            i.isLowSurrogate(b) ? (v++, l = i.computeCodePoint(E, b)) : l = 65533
          } else {
            P = E;
            break
          } else i.isLowSurrogate(E) && (l = 65533);
          if (N = this._push(L, N, l), v++, v < S) E = u.charCodeAt(v); else break
        }
        this._buffLen = N, this._leftoverHighSurrogate = P
      }

      _push(u, S, L) {
        return L < 128 ? u[S++] = L : L < 2048 ? (u[S++] = 192 | (L & 1984) >>> 6, u[S++] = 128 | (L & 63) >>> 0) : L < 65536 ? (u[S++] = 224 | (L & 61440) >>> 12, u[S++] = 128 | (L & 4032) >>> 6, u[S++] = 128 | (L & 63) >>> 0) : (u[S++] = 240 | (L & 1835008) >>> 18, u[S++] = 128 | (L & 258048) >>> 12, u[S++] = 128 | (L & 4032) >>> 6, u[S++] = 128 | (L & 63) >>> 0), S >= 64 && (this._step(), S -= 64, this._totalLen += 64, u[0] = u[64], u[1] = u[65], u[2] = u[66]), S
      }

      digest() {
        return this._finished || (this._finished = !0, this._leftoverHighSurrogate && (this._leftoverHighSurrogate = 0, this._buffLen = this._push(this._buff, this._buffLen, 65533)), this._totalLen += this._buffLen, this._wrapUp()), r(this._h0) + r(this._h1) + r(this._h2) + r(this._h3) + r(this._h4)
      }

      _wrapUp() {
        this._buff[this._buffLen++] = 128, e(this._buff, this._buffLen), this._buffLen > 56 && (this._step(), e(this._buff));
        const u = 8 * this._totalLen;
        this._buffDV.setUint32(56, Math.floor(u / 4294967296), !1), this._buffDV.setUint32(60, u % 4294967296, !1), this._step()
      }

      _step() {
        const u = s._bigBlock32, S = this._buffDV;
        for (let w = 0; w < 64; w += 4) u.setUint32(w, S.getUint32(w, !1), !1);
        for (let w = 64; w < 320; w += 4) u.setUint32(w, m(u.getUint32(w - 12, !1) ^ u.getUint32(w - 32, !1) ^ u.getUint32(w - 56, !1) ^ u.getUint32(w - 64, !1), 1), !1);
        let L = this._h0, N = this._h1, P = this._h2, E = this._h3, v = this._h4, l, b, g;
        for (let w = 0; w < 80; w++) w < 20 ? (l = N & P | ~N & E, b = 1518500249) : w < 40 ? (l = N ^ P ^ E, b = 1859775393) : w < 60 ? (l = N & P | N & E | P & E, b = 2400959708) : (l = N ^ P ^ E, b = 3395469782), g = m(L, 5) + l + v + b + u.getUint32(w * 4, !1) & 4294967295, v = E, E = P, P = m(N, 30), N = L, L = g;
        this._h0 = this._h0 + L & 4294967295, this._h1 = this._h1 + N & 4294967295, this._h2 = this._h2 + P & 4294967295, this._h3 = this._h3 + E & 4294967295, this._h4 = this._h4 + v & 4294967295
      }
    }
    ...
    "use strict";
    Object.defineProperty(n, "__esModule", {value: !0}), n.LcsDiff = n.StringDiffSequence = void 0, n.stringDiff = d;
    ...
    class A {
      ...
      getElements() {
        const e = this.source, h = new Int32Array(e.length);
    ...
    class c {
      ...
      MarkNextChange() {
        (this.m_originalCount > 0 || this.m_modifiedCount > 0) && this.m_changes.push(new i.DiffChange(this.m_originalStart, this.m_originalCount, this.m_modifiedStart, this.m_modifiedCount)), this.m_originalCount = 0, this.m_modifiedCount = 0, this.m_originalStart = 1073741824, this.m_modifiedStart = 1073741824
      }

      AddOriginalElement(e, h) {
        this.m_originalStart = Math.min(this.m_originalStart, e), this.m_modifiedStart = Math.min(this.m_modifiedStart, h), this.m_originalCount++
      }

      AddModifiedElement(e, h) {
        this.m_originalStart = Math.min(this.m_originalStart, e), this.m_modifiedStart = Math.min(this.m_modifiedStart, h), this.m_modifiedCount++
      }
    ...
    class a {
      constructor(e, h, r = null) {
        this.ContinueProcessingPredicate = r, this._originalSequence = e, this._modifiedSequence = h;
        const [s, o, u] = a._getElements(e), [S, L, N] = a._getElements(h);
        this._hasStrings = u && N, this._originalStringElements = s, this._originalElementsOrHash = o, this._modifiedStringElements = S, this._modifiedElementsOrHash = L, this.m_forwardHistory = [], this.m_reverseHistory = []
      }
      ...
      static _getElements(e) {
        ...
        if (a._isStringArray(h)) {
          ...
          for (let s = 0, o = h.length; s < o; s++) r[s] = (0, x.stringHash)(h[s], 0);
          return [h, r, !0]
        }
        return h instanceof Int32Array ? [[], h, !1] : [[], new Int32Array(h), !1]
      }

      ElementsAreEqual(e, h) {
        return this._originalElementsOrHash[e] !== this._modifiedElementsOrHash[h] ? !1 : this._hasStrings ? this._originalStringElements[e] === this._modifiedStringElements[h] : !0
      }

      ElementsAreStrictEqual(e, h) {
        if (!this.ElementsAreEqual(e, h)) return !1;
        const r = a._getStrictElement(this._originalSequence, e), s = a._getStrictElement(this._modifiedSequence, h);
        return r === s
      }

      static _getStrictElement(e, h) {
        return typeof e.getStrictElement == "function" ? e.getStrictElement(h) : null
      }

      OriginalElementsAreEqual(e, h) {
        return this._originalElementsOrHash[e] !== this._originalElementsOrHash[h] ? !1 : this._hasStrings ? this._originalStringElements[e] === this._originalStringElements[h] : !0
      }

      ModifiedElementsAreEqual(e, h) {
        return this._modifiedElementsOrHash[e] !== this._modifiedElementsOrHash[h] ? !1 : this._hasStrings ? this._modifiedStringElements[e] === this._modifiedStringElements[h] : !0
      }
      ...
      _ComputeDiff(e, h, r, s, o) {
        ...
        return o && (S = this.PrettifyChanges(S)), {quitEarly: u[0], changes: S}
      }

      ComputeDiffRecursive(e, h, r, s, o) {
        for (o[0] = !1; e <= h && r <= s && this.ElementsAreEqual(e, r);) e++, r++;
        for (; h >= e && s >= r && this.ElementsAreEqual(h, s);) h--, s--;
        if (e > h || r > s) {
          let E;
          return r <= s ? (f.Assert(e === h + 1, "originalStart should only be one more than originalEnd"), E = [new i.DiffChange(e, 0, r, s - r + 1)]) : e <= h ? (f.Assert(r === s + 1, "modifiedStart should only be one more than modifiedEnd"), E = [new i.DiffChange(e, h - e + 1, r, 0)]) : (f.Assert(e === h + 1, "originalStart should only be one more than originalEnd"), f.Assert(r === s + 1, "modifiedStart should only be one more than modifiedEnd"), E = []), E
        }
        const u = [0], S = [0], L = this.ComputeRecursionPoint(e, h, r, s, u, S, o), N = u[0], P = S[0];
        if (L !== null) return L;
        if (!o[0]) {
          const E = this.ComputeDiffRecursive(e, N, r, P, o);
          let v = [];
          return o[0] ? v = [new i.DiffChange(N + 1, h - (N + 1) + 1, P + 1, s - (P + 1) + 1)] : v = this.ComputeDiffRecursive(N + 1, h, P + 1, s, o), this.ConcatenateChanges(E, v)
        }
        return [new i.DiffChange(e, h - e + 1, r, s - r + 1)]
      }

      WALKTRACE(e, h, r, s, o, u, S, L, N, P, E, v, l, b, g, w, M, y) {
        let _ = null, C = null, R = new c, D = h, T = r, O = l[0] - w[0] - s, z = -1073741824,
          j = this.m_forwardHistory.length - 1;
        do {
          const F = O + e;
          F === D || F < T && N[F - 1] < N[F + 1] ? (E = N[F + 1], b = E - O - s, E < z && R.MarkNextChange(), z = E, R.AddModifiedElement(E + 1, b), O = F + 1 - e) : (E = N[F - 1] + 1, b = E - O - s, E < z && R.MarkNextChange(), z = E - 1, R.AddOriginalElement(E, b + 1), O = F - 1 - e), j >= 0 && (N = this.m_forwardHistory[j], e = N[0], D = 1, T = N.length - 1)
        } while (--j >= -1);
        if (_ = R.getReverseChanges(), y[0]) {
          let F = l[0] + 1, q = w[0] + 1;
          if (_ !== null && _.length > 0) {
            const B = _[_.length - 1];
            F = Math.max(F, B.getOriginalEnd()), q = Math.max(q, B.getModifiedEnd())
          }
          C = [new i.DiffChange(F, v - F + 1, q, g - q + 1)]
        } else {
          R = new c, D = u, T = S, O = l[0] - w[0] - L, z = 1073741824, j = M ? this.m_reverseHistory.length - 1 : this.m_reverseHistory.length - 2;
          do {
            const F = O + o;
            F === D || F < T && P[F - 1] >= P[F + 1] ? (E = P[F + 1] - 1, b = E - O - L, E > z && R.MarkNextChange(), z = E + 1, R.AddOriginalElement(E + 1, b + 1), O = F + 1 - o) : (E = P[F - 1], b = E - O - L, E > z && R.MarkNextChange(), z = E, R.AddModifiedElement(E + 1, b + 1), O = F - 1 - o), j >= 0 && (P = this.m_reverseHistory[j], o = P[0], D = 1, T = P.length - 1)
          } while (--j >= -1);
          C = R.getChanges()
        }
      ...
      ComputeRecursionPoint(e, h, r, s, o, u, S) {
        let L = 0, N = 0, P = 0, E = 0, v = 0, l = 0;
        e--, r--, o[0] = 0, u[0] = 0, this.m_forwardHistory = [], this.m_reverseHistory = [];
        const b = h - e + (s - r), g = b + 1, w = new Int32Array(g), M = new Int32Array(g), y = s - r, _ = h - e,
          C = e - r, R = h - s, T = (_ - y) % 2 === 0;
        w[y] = e, M[_] = h, S[0] = !1;
        for (let O = 1; O <= b / 2 + 1; O++) {
          let z = 0, j = 0;
          P = this.ClipDiagonalBound(y - O, O, y, g), E = this.ClipDiagonalBound(y + O, O, y, g);
          for (let q = P; q <= E; q += 2) {
            q === P || q < E && w[q - 1] < w[q + 1] ? L = w[q + 1] : L = w[q - 1] + 1, N = L - (q - y) - C;
            const B = L;
            for (; L < h && N < s && this.ElementsAreEqual(L + 1, N + 1);) L++, N++;
            if (w[q] = L, L + N > z + j && (z = L, j = N), !T && Math.abs(q - _) <= O - 1 && L >= M[q]) return o[0] = L, u[0] = N, B <= M[q] && O <= 1448 ? this.WALKTRACE(y, P, E, C, _, v, l, R, w, M, L, h, o, N, s, u, T, S) : null
          }
          const F = (z - e + (j - r) - O) / 2;
          if (this.ContinueProcessingPredicate !== null && !this.ContinueProcessingPredicate(z, F)) return S[0] = !0, o[0] = z, u[0] = j, F > 0 && O <= 1448 ? this.WALKTRACE(y, P, E, C, _, v, l, R, w, M, L, h, o, N, s, u, T, S) : (e++, r++, [new i.DiffChange(e, h - e + 1, r, s - r + 1)]);
          v = this.ClipDiagonalBound(_ - O, O, _, g), l = this.ClipDiagonalBound(_ + O, O, _, g);
          for (let q = v; q <= l; q += 2) {
            q === v || q < l && M[q - 1] >= M[q + 1] ? L = M[q + 1] - 1 : L = M[q - 1], N = L - (q - _) - R;
            const B = L;
            for (; L > e && N > r && this.ElementsAreEqual(L, N);) L--, N--;
            if (M[q] = L, T && Math.abs(q - y) <= O && L <= w[q]) return o[0] = L, u[0] = N, B >= w[q] && O <= 1448 ? this.WALKTRACE(y, P, E, C, _, v, l, R, w, M, L, h, o, N, s, u, T, S) : null
          }
          if (O <= 1447) {
            let q = new Int32Array(E - P + 2);
            q[0] = y - P + 1, p.Copy2(w, P, q, 1, E - P + 1), this.m_forwardHistory.push(q), q = new Int32Array(l - v + 2), q[0] = _ - v + 1, p.Copy2(M, v, q, 1, l - v + 1), this.m_reverseHistory.push(q)
          }
        }
        return this.WALKTRACE(y, P, E, C, _, v, l, R, w, M, L, h, o, N, s, u, T, S)
      }

      PrettifyChanges(e) {
        for (let h = 0; h < e.length; h++) {
          const r = e[h], s = h < e.length - 1 ? e[h + 1].originalStart : this._originalElementsOrHash.length,
            o = h < e.length - 1 ? e[h + 1].modifiedStart : this._modifiedElementsOrHash.length,
            u = r.originalLength > 0, S = r.modifiedLength > 0;
          for (; r.originalStart + r.originalLength < s && r.modifiedStart + r.modifiedLength < o && (!u || this.OriginalElementsAreEqual(r.originalStart, r.originalStart + r.originalLength)) && (!S || this.ModifiedElementsAreEqual(r.modifiedStart, r.modifiedStart + r.modifiedLength));) {
            const N = this.ElementsAreStrictEqual(r.originalStart, r.modifiedStart);
            if (this.ElementsAreStrictEqual(r.originalStart + r.originalLength, r.modifiedStart + r.modifiedLength) && !N) break;
        ...
        for (let h = e.length - 1; h >= 0; h--) {
          ...
          if (h > 0) {
            const E = e[h - 1];
            s = E.originalStart + E.originalLength, o = E.modifiedStart + E.modifiedLength
          }
          const u = r.originalLength > 0, S = r.modifiedLength > 0;
          let L = 0, N = this._boundaryScore(r.originalStart, r.originalLength, r.modifiedStart, r.modifiedLength);
          for (let E = 1; ; E++) {
            const v = r.originalStart - E, l = r.modifiedStart - E;
            if (v < s || l < o || u && !this.OriginalElementsAreEqual(v, v + r.originalLength) || S && !this.ModifiedElementsAreEqual(l, l + r.modifiedLength)) break;
            const g = (v === s && l === o ? 5 : 0) + this._boundaryScore(v, r.originalLength, l, r.modifiedLength);
            g > N && (N = g, L = E)
          }
        ...
        if (this._hasStrings) for (let h = 1, r = e.length; h < r; h++) {
          const s = e[h - 1], o = e[h], u = o.originalStart - s.originalStart - s.originalLength, S = s.originalStart,
            L = o.originalStart + o.originalLength, N = L - S, P = s.modifiedStart,
            E = o.modifiedStart + o.modifiedLength, v = E - P;
          if (u < 5 && N < 20 && v < 20) {
            const l = this._findBetterContiguousSequence(S, N, P, v, u);
            if (l) {
              const [b, g] = l;
              (b !== s.originalStart + s.originalLength || g !== s.modifiedStart + s.modifiedLength) && (s.originalLength = b - s.originalStart, s.modifiedLength = g - s.modifiedStart, o.originalStart = b + u, o.modifiedStart = g + u, o.originalLength = L - o.originalStart, o.modifiedLength = E - o.modifiedStart)
            }
          }
        }
        return e
      ...
      _findBetterContiguousSequence(e, h, r, s, o) {
        ...
        const u = e + h - o + 1, S = r + s - o + 1;
        let L = 0, N = 0, P = 0;
        for (let E = e; E < u; E++) for (let v = r; v < S; v++) {
      ...
      _boundaryScore(e, h, r, s) {
        const o = this._OriginalRegionIsBoundary(e, h) ? 1 : 0, u = this._ModifiedRegionIsBoundary(r, s) ? 1 : 0;
        return o + u
      }
      ...
      ConcatenateChanges(e, h) {
        ...
        if (this.ChangesOverlap(e[e.length - 1], h[0], r)) {
          ...
          return p.Copy(e, 0, s, 0, e.length - 1), s[e.length - 1] = r[0], p.Copy(h, 1, s, e.length, h.length - 1), s
        } else {
          const s = new Array(e.length + h.length);
          return p.Copy(e, 0, s, 0, e.length), p.Copy(h, 0, s, e.length, h.length), s
        }
      }

      ChangesOverlap(e, h, r) {
        if (f.Assert(e.originalStart <= h.originalStart, "Left change is not less than or equal to right change"), f.Assert(e.modifiedStart <= h.modifiedStart, "Left change is not less than or equal to right change"), e.originalStart + e.originalLength >= h.originalStart || e.modifiedStart + e.modifiedLength >= h.modifiedStart) {
          const s = e.originalStart;
          let o = e.originalLength;
          const u = e.modifiedStart;
          let S = e.modifiedLength;
          return e.originalStart + e.originalLength >= h.originalStart && (o = h.originalStart + h.originalLength - e.originalStart), e.modifiedStart + e.modifiedLength >= h.modifiedStart && (S = h.modifiedStart + h.modifiedLength - e.modifiedStart), r[0] = new i.DiffChange(s, o, u, S), !0
        } else return r[0] = null, !1
      }

      ClipDiagonalBound(e, h, r, s) {
        if (e >= 0 && e < s) return e;
        const o = r, u = s - r - 1, S = h % 2 === 0;
        if (e < 0) {
          const L = o % 2 === 0;
          return S === L ? 0 : 1
        } else {
    ...
    "use strict";
    Object.defineProperty(n, "__esModule", {value: !0}), n.MicrotaskDelay = void 0, n.MicrotaskDelay = Symbol("MicrotaskDelay")
  }), X(J[25], Z([0, 1]), function (W, n) {
    "use strict";
    Object.defineProperty(n, "__esModule", {value: !0}), n.isString = i, n.isObject = x, n.isTypedArray = A, n.isNumber = d, n.isIterable = f, n.isBoolean = p, n.isUndefined = c, n.isDefined = a, n.isUndefinedOrNull = m, n.assertType = e, n.assertIsDefined = h, n.isFunction = r, n.validateConstraints = s, n.validateConstraint = o;
    ...
    function x(u) {
      return typeof u == "object" && u !== null && !Array.isArray(u) && !(u instanceof RegExp) && !(u instanceof Date)
    }
    ...
    function e(u, S) {
      if (!u) throw new Error(S ? `Unexpected type, expected '${S}'` : "Unexpected type")
    }

    function h(u) {
      if (m(u)) throw new Error("Assertion Failed: argument is undefined or null");
      return u
    }
    ...
    function o(u, S) {
      if (i(S)) {
        if (typeof u !== S) throw new Error(`argument does not match constraint: typeof ${S}`)
      } else if (r(S)) {
        try {
          if (u instanceof S) return
        } catch {
        }
        if (!m(u) && u.constructor === S || S.length === 1 && S.call(void 0, u) === !0) return;
        throw new Error("argument does not match one of these constraints: arg instanceof constraint, arg.constructor === constraint, nor constraint(arg) === true")
      }
    }
  }), X(J[26], Z([0, 1, 25]), function (W, n, i) {
    "use strict";
    Object.defineProperty(n, "__esModule", {value: !0}), n.register = A, n.getCodiconFontCharacters = d;
    const x = Object.create(null);

    function A(f, p) {
      if ((0, i.isString)(p)) {
        const c = x[p];
        if (c === void 0) throw new Error(`${f} references an unknown codicon: ${p}`);
        p = c
      }
      return x[f] = p, {id: f}
    }
    ...
    "use strict";
    Object.defineProperty(n, "__esModule", {value: !0}), n.codiconsLibrary = void 0, n.codiconsLibrary = {
      ...
      gitPullRequestAbandoned: (0, i.register)("git-pull-request-abandoned", 60004),
      ...
      debugBreakpointDisabled: (0, i.register)("debug-breakpoint-disabled", 60017),
      debugHint: (0, i.register)("debug-hint", 60017),
      terminalDecorationSuccess: (0, i.register)("terminal-decoration-success", 60017),
      ...
      debugBreakpointConditionalUnverified: (0, i.register)("debug-breakpoint-conditional-unverified", 60070),
      debugBreakpointConditional: (0, i.register)("debug-breakpoint-conditional", 60071),
      debugBreakpointConditionalDisabled: (0, i.register)("debug-breakpoint-conditional-disabled", 60071),
      debugBreakpointDataUnverified: (0, i.register)("debug-breakpoint-data-unverified", 60072),
      debugBreakpointData: (0, i.register)("debug-breakpoint-data", 60073),
      debugBreakpointDataDisabled: (0, i.register)("debug-breakpoint-data-disabled", 60073),
      debugBreakpointLogUnverified: (0, i.register)("debug-breakpoint-log-unverified", 60074),
      debugBreakpointLog: (0, i.register)("debug-breakpoint-log", 60075),
      debugBreakpointLogDisabled: (0, i.register)("debug-breakpoint-log-disabled", 60075),
      ...
      debugBreakpointUnverified: (0, i.register)("debug-breakpoint-unverified", 60092),
      terminalDecorationIncomplete: (0, i.register)("terminal-decoration-incomplete", 60092),
      ...
      fileSymlinkDirectory: (0, i.register)("file-symlink-directory", 60141),
      ...
      debugBreakpointFunctionUnverified: (0, i.register)("debug-breakpoint-function-unverified", 60295),
      debugBreakpointFunction: (0, i.register)("debug-breakpoint-function", 60296),
      debugBreakpointFunctionDisabled: (0, i.register)("debug-breakpoint-function-disabled", 60296),
      debugStackframeActive: (0, i.register)("debug-stackframe-active", 60297),
      circleSmallFilled: (0, i.register)("circle-small-filled", 60298),
      debugStackframeDot: (0, i.register)("debug-stackframe-dot", 60298),
      terminalDecorationMark: (0, i.register)("terminal-decoration-mark", 60298),
      debugStackframe: (0, i.register)("debug-stackframe", 60299),
      debugStackframeFocused: (0, i.register)("debug-stackframe-focused", 60299),
      debugBreakpointUnsupported: (0, i.register)("debug-breakpoint-unsupported", 60300),
      symbolString: (0, i.register)("symbol-string", 60301),
      debugReverseContinue: (0, i.register)("debug-reverse-continue", 60302),
      ...
      gitPullRequestReviewer: (0, i.register)("git-pull-request-reviewer", 60310),
      ...
      gitPullRequestAssignee: (0, i.register)("git-pull-request-assignee", 60313),
      ...
      gitPullRequestCreate: (0, i.register)("git-pull-request-create", 60348),
      ...
      gitPullRequestClosed: (0, i.register)("git-pull-request-closed", 60378),
      ...
      layoutActivitybarLeft: (0, i.register)("layout-activitybar-left", 60396),
      layoutActivitybarRight: (0, i.register)("layout-activitybar-right", 60397),
      ...
      terminalDecorationError: (0, i.register)("terminal-decoration-error", 60411),
      ...
      layoutSidebarRightOff: (0, i.register)("layout-sidebar-right-off", 60416),
      layoutPanelOff: (0, i.register)("layout-panel-off", 60417),
      layoutSidebarLeftOff: (0, i.register)("layout-sidebar-left-off", 60418),
      ...
      foldHorizontalFilled: (0, i.register)("fold-horizontal-filled", 60422),
      ...
      gitPullRequestGoToChanges: (0, i.register)("git-pull-request-go-to-changes", 60427),
      gitPullRequestNewChanges: (0, i.register)("git-pull-request-new-changes", 60428),
    ...
    "use strict";
    Object.defineProperty(n, "__esModule", {value: !0}), n.Codicon = n.codiconsDerived = void 0, n.codiconsDerived = {
      ...
      treeItemExpanded: (0, i.register)("tree-item-expanded", "chevron-down"),
      treeFilterOnTypeOn: (0, i.register)("tree-filter-on-type-on", "list-filter"),
      treeFilterOnTypeOff: (0, i.register)("tree-filter-on-type-off", "list-selection"),
      ...
      scrollbarButtonLeft: (0, i.register)("scrollbar-button-left", "triangle-left"),
      scrollbarButtonRight: (0, i.register)("scrollbar-button-right", "triangle-right"),
      scrollbarButtonUp: (0, i.register)("scrollbar-button-up", "triangle-up"),
      scrollbarButtonDown: (0, i.register)("scrollbar-button-down", "triangle-down"),
      ...
      lightbulbSparkleAutofix: (0, i.register)("lightbulb-sparkle-autofix", 60447),
      debugBreakpointPending: (0, i.register)("debug-breakpoint-pending", 60377)
    }, n.Codicon = {...x.codiconsLibrary, ...n.codiconsDerived}
  }), X(J[27], Z([0, 1, 25]), function (W, n, i) {
    "use strict";
    Object.defineProperty(n, "__esModule", {value: !0}), n.deepClone = x, n.deepFreeze = A, n.cloneAndChange = f, n.mixin = c, n.equals = a, n.getAllPropertyNames = m, n.getAllMethodNames = e, n.createProxyObject = h;

    function x(r) {
      if (!r || typeof r != "object" || r instanceof RegExp) return r;
      const s = Array.isArray(r) ? [] : {};
      return Object.entries(r).forEach(([o, u]) => {
    ...
    function A(r) {
      ...
      for (; s.length > 0;) {
        const o = s.shift();
        Object.freeze(o);
        for (const u in o) if (d.call(o, u)) {
          const S = o[u];
          typeof S == "object" && !Object.isFrozen(S) && !(0, i.isTypedArray)(S) && s.push(S)
        }
      }
      return r
    }
    ...
    function p(r, s, o) {
      ...
      if ((0, i.isObject)(r)) {
        if (o.has(r)) throw new Error("Cannot clone recursive data-structure");
        o.add(r);
        const S = {};
    ...
    function c(r, s, o = !0) {
      return (0, i.isObject)(r) ? ((0, i.isObject)(s) && Object.keys(s).forEach(u => {
        u in r ? o && ((0, i.isObject)(r[u]) && (0, i.isObject)(s[u]) ? c(r[u], s[u], o) : r[u] = s[u]) : r[u] = s[u]
      }), r) : s
    }

    function a(r, s) {
      if (r === s) return !0;
      if (r == null || s === null || s === void 0 || typeof r != typeof s || typeof r != "object" || Array.isArray(r) !== Array.isArray(s)) return !1;
      let o, u;
      if (Array.isArray(r)) {
    ...
    function m(r) {
      let s = [];
      for (; Object.prototype !== r;) s = s.concat(Object.getOwnPropertyNames(r)), r = Object.getPrototypeOf(r);
      return s
    }
    ...
    "use strict";
    Object.defineProperty(n, "__esModule", {value: !0}), n.toUint8 = i, n.toUint32 = x;
    ...
    "use strict";
    Object.defineProperty(n, "__esModule", {value: !0}), n.CharacterSet = n.CharacterClassifier = void 0;

    class x {
      constructor(f) {
        const p = (0, i.toUint8)(f);
        this._defaultValue = p, this._asciiMap = x._createAsciiMap(p), this._map = new Map
      }
    ...
    "use strict";
    Object.defineProperty(n, "__esModule", {value: !0}), n.OffsetRangeSet = n.OffsetRange = void 0;
    ...
    class x {
      static addRange(f, p) {
        ...
        if (c === a) p.splice(c, 0, f); else {
          const m = Math.min(f.start, p[c].start), e = Math.max(f.endExclusive, p[a - 1].endExclusive);
      ...
      constructor(f, p) {
        if (this.start = f, this.endExclusive = p, f > p) throw new i.BugIndicatingError(`Invalid range: ${this.toString()}`)
      }
      ...
      join(f) {
        return new x(Math.min(this.start, f.start), Math.max(this.endExclusive, f.endExclusive))
      }

      intersect(f) {
        const p = Math.max(this.start, f.start), c = Math.min(this.endExclusive, f.endExclusive);
      ...
      clip(f) {
        if (this.isEmpty) throw new i.BugIndicatingError(`Invalid clipping range: ${this.toString()}`);
        return Math.max(this.start, Math.min(this.endExclusive - 1, f))
      }

      clipCyclic(f) {
        if (this.isEmpty) throw new i.BugIndicatingError(`Invalid clipping range: ${this.toString()}`);
        return f < this.start ? this.endExclusive - (this.start - f) % this.length : f >= this.endExclusive ? this.start + (f - this.start) % this.length : f
      }
    ...
    class A {
      ...
      addRange(f) {
        let p = 0;
        for (; p < this._sortedRanges.length && this._sortedRanges[p].endExclusive < f.start;) p++;
        let c = p;
        for (; c < this._sortedRanges.length && this._sortedRanges[c].start <= f.endExclusive;) c++;
        if (p === c) this._sortedRanges.splice(p, 0, f); else {
          const a = Math.min(f.start, this._sortedRanges[p].start),
            m = Math.max(f.endExclusive, this._sortedRanges[c - 1].endExclusive);
    ...
    class i {
      ...
      with(A = this.lineNumber, d = this.column) {
        return A === this.lineNumber && d === this.column ? this : new i(A, d)
      }
      ...
      static equals(A, d) {
        return !A && !d ? !0 : !!A && !!d && A.lineNumber === d.lineNumber && A.column === d.column
      }
      ...
      static isBefore(A, d) {
        return A.lineNumber < d.lineNumber ? !0 : d.lineNumber < A.lineNumber ? !1 : A.column < d.column
      }
      ...
      static compare(A, d) {
        const f = A.lineNumber | 0, p = d.lineNumber | 0;
        if (f === p) {
          const c = A.column | 0, a = d.column | 0;
          return c - a
        }
        return f - p
      }
    ...
    class x {
      constructor(d, f, p, c) {
        d > p || d === p && f > c ? (this.startLineNumber = p, this.startColumn = c, this.endLineNumber = d, this.endColumn = f) : (this.startLineNumber = d, this.startColumn = f, this.endLineNumber = p, this.endColumn = c)
      }
      ...
      static containsPosition(d, f) {
        return !(f.lineNumber < d.startLineNumber || f.lineNumber > d.endLineNumber || f.lineNumber === d.startLineNumber && f.column < d.startColumn || f.lineNumber === d.endLineNumber && f.column > d.endColumn)
      }
      ...
      static containsRange(d, f) {
        return !(f.startLineNumber < d.startLineNumber || f.endLineNumber < d.startLineNumber || f.startLineNumber > d.endLineNumber || f.endLineNumber > d.endLineNumber || f.startLineNumber === d.startLineNumber && f.startColumn < d.startColumn || f.endLineNumber === d.endLineNumber && f.endColumn > d.endColumn)
      }
      ...
      static plusRange(d, f) {
        let p, c, a, m;
        return f.startLineNumber < d.startLineNumber ? (p = f.startLineNumber, c = f.startColumn) : f.startLineNumber === d.startLineNumber ? (p = f.startLineNumber, c = Math.min(f.startColumn, d.startColumn)) : (p = d.startLineNumber, c = d.startColumn), f.endLineNumber > d.endLineNumber ? (a = f.endLineNumber, m = f.endColumn) : f.endLineNumber === d.endLineNumber ? (a = f.endLineNumber, m = Math.max(f.endColumn, d.endColumn)) : (a = d.endLineNumber, m = d.endColumn), new x(p, c, a, m)
      }
      ...
      static intersectRanges(d, f) {
        let p = d.startLineNumber, c = d.startColumn, a = d.endLineNumber, m = d.endColumn;
        const e = f.startLineNumber, h = f.startColumn, r = f.endLineNumber, s = f.endColumn;
        return p < e ? (p = e, c = h) : p === e && (c = Math.max(c, h)), a > r ? (a = r, m = s) : a === r && (m = Math.min(m, s)), p > a || p === a && c > m ? null : new x(p, c, a, m)
      }
      ...
      static equalsRange(d, f) {
        return !d && !f ? !0 : !!d && !!f && d.startLineNumber === f.startLineNumber && d.startColumn === f.startColumn && d.endLineNumber === f.endLineNumber && d.endColumn === f.endColumn
      }
      ...
      static collapseToStart(d) {
        return new x(d.startLineNumber, d.startColumn, d.startLineNumber, d.startColumn)
      }
      ...
      static collapseToEnd(d) {
        return new x(d.endLineNumber, d.endColumn, d.endLineNumber, d.endColumn)
      }

      delta(d) {
        return new x(this.startLineNumber + d, this.startColumn, this.endLineNumber + d, this.endColumn)
      }
      ...
      static lift(d) {
        return d ? new x(d.startLineNumber, d.startColumn, d.endLineNumber, d.endColumn) : null
      }
      ...
      static areIntersectingOrTouching(d, f) {
        return !(d.endLineNumber < f.startLineNumber || d.endLineNumber === f.startLineNumber && d.endColumn < f.startColumn || f.endLineNumber < d.startLineNumber || f.endLineNumber === d.startLineNumber && f.endColumn < d.startColumn)
      }
      ...
      static compareRangesUsingStarts(d, f) {
        if (d && f) {
          const a = d.startLineNumber | 0, m = f.startLineNumber | 0;
          if (a === m) {
            const e = d.startColumn | 0, h = f.startColumn | 0;
            if (e === h) {
              const r = d.endLineNumber | 0, s = f.endLineNumber | 0;
              if (r === s) {
                const o = d.endColumn | 0, u = f.endColumn | 0;
                return o - u
              }
              return r - s
            }
      ...
      static compareRangesUsingEnds(d, f) {
        return d.endLineNumber === f.endLineNumber ? d.endColumn === f.endColumn ? d.startLineNumber === f.startLineNumber ? d.startColumn - f.startColumn : d.startLineNumber - f.startLineNumber : d.endColumn - f.endColumn : d.endLineNumber - f.endLineNumber
      }
    ...
    "use strict";
    Object.defineProperty(n, "__esModule", {value: !0}), n.LineRangeSet = n.LineRange = void 0;
    ...
    class f {
      ...
      static join(a) {
        if (a.length === 0) throw new i.BugIndicatingError("lineRanges cannot be empty");
        let m = a[0].startLineNumber, e = a[0].endLineNumberExclusive;
        for (let h = 1; h < a.length; h++) m = Math.min(m, a[h].startLineNumber), e = Math.max(e, a[h].endLineNumberExclusive);
        return new f(m, e)
      }
      ...
      constructor(a, m) {
        if (a > m) throw new i.BugIndicatingError(`startLineNumber ${a} cannot be after endLineNumberExclusive ${m}`);
      ...
      join(a) {
        return new f(Math.min(this.startLineNumber, a.startLineNumber), Math.max(this.endLineNumberExclusive, a.endLineNumberExclusive))
      }
      ...
      intersectsStrict(a) {
        return this.startLineNumber < a.endLineNumberExclusive && a.startLineNumber < this.endLineNumberExclusive
      }
      ...
      equals(a) {
        return this.startLineNumber === a.startLineNumber && this.endLineNumberExclusive === a.endLineNumberExclusive
      }

      toInclusiveRange() {
        return this.isEmpty ? null : new A.Range(this.startLineNumber, 1, this.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER)
      }
      ...
      toOffsetRange() {
        return new x.OffsetRange(this.startLineNumber - 1, this.endLineNumberExclusive - 1)
      }
    }
    ...
    class p {
      ...
      addRange(a) {
        if (a.length === 0) return;
        const m = (0, d.findFirstIdxMonotonousOrArrLen)(this._normalizedRanges, h => h.endLineNumberExclusive >= a.startLineNumber),
          e = (0, d.findLastIdxMonotonous)(this._normalizedRanges, h => h.startLineNumber <= a.endLineNumberExclusive) + 1;
        if (m === e) this._normalizedRanges.splice(m, 0, a); else if (m === e - 1) {
          const h = this._normalizedRanges[m];
          this._normalizedRanges[m] = h.join(a)
        } else {
          const h = this._normalizedRanges[m].join(this._normalizedRanges[e - 1]).join(a);
          this._normalizedRanges.splice(m, e - m, h)
        }
      }

      contains(a) {
        const m = (0, d.findLastMonotonous)(this._normalizedRanges, e => e.startLineNumber <= a);
        return !!m && m.endLineNumberExclusive > a
      }

      intersects(a) {
        const m = (0, d.findLastMonotonous)(this._normalizedRanges, e => e.startLineNumber < a.endLineNumberExclusive);
      ...
      getUnion(a) {
        ...
        const m = [];
        let e = 0, h = 0, r = null;
        for (; e < this._normalizedRanges.length || h < a._normalizedRanges.length;) {
          let s = null;
          if (e < this._normalizedRanges.length && h < a._normalizedRanges.length) {
            const o = this._normalizedRanges[e], u = a._normalizedRanges[h];
            o.startLineNumber < u.startLineNumber ? (s = o, e++) : (s = u, h++)
          } else e < this._normalizedRanges.length ? (s = this._normalizedRanges[e], e++) : (s = a._normalizedRanges[h], h++);
          r === null ? r = s : r.endLineNumberExclusive >= s.startLineNumber ? r = new f(r.startLineNumber, Math.max(r.endLineNumberExclusive, s.endLineNumberExclusive)) : (m.push(r), r = s)
        }
        return r !== null && m.push(r), new p(m)
      }

      subtractFrom(a) {
        const m = (0, d.findFirstIdxMonotonousOrArrLen)(this._normalizedRanges, s => s.endLineNumberExclusive >= a.startLineNumber),
          e = (0, d.findLastIdxMonotonous)(this._normalizedRanges, s => s.startLineNumber <= a.endLineNumberExclusive) + 1;
        if (m === e) return new p([a]);
        const h = [];
        let r = a.startLineNumber;
        for (let s = m; s < e; s++) {
          const o = this._normalizedRanges[s];
          o.startLineNumber > r && h.push(new f(r, o.startLineNumber)), r = o.endLineNumberExclusive
        }
        return r < a.endLineNumberExclusive && h.push(new f(r, a.endLineNumberExclusive)), new p(h)
      }
      ...
      getIntersection(a) {
        ...
        let e = 0, h = 0;
        for (; e < this._normalizedRanges.length && h < a._normalizedRanges.length;) {
          const r = this._normalizedRanges[e], s = a._normalizedRanges[h], o = r.intersect(s);
          o && !o.isEmpty && m.push(o), r.endLineNumberExclusive < s.endLineNumberExclusive ? e++ : h++
        }
        return new p(m)
      }
    ...
    class A extends x.Range {
      constructor(f, p, c, a) {
        super(f, p, c, a), this.selectionStartLineNumber = f, this.selectionStartColumn = p, this.positionLineNumber = c, this.positionColumn = a
      }
      ...
      static selectionsEqual(f, p) {
        return f.selectionStartLineNumber === p.selectionStartLineNumber && f.selectionStartColumn === p.selectionStartColumn && f.positionLineNumber === p.positionLineNumber && f.positionColumn === p.positionColumn
      }
      ...
      setEndPosition(f, p) {
        return this.getDirection() === 0 ? new A(this.startLineNumber, this.startColumn, f, p) : new A(f, p, this.startLineNumber, this.startColumn)
      }
      ...
      getSelectionStart() {
        return new i.Position(this.selectionStartLineNumber, this.selectionStartColumn)
      }

      setStartPosition(f, p) {
        return this.getDirection() === 0 ? new A(f, p, this.endLineNumber, this.endColumn) : new A(this.endLineNumber, this.endColumn, f, p)
      }
      ...
      static fromRange(f, p) {
        return p === 0 ? new A(f.startLineNumber, f.startColumn, f.endLineNumber, f.endColumn) : new A(f.endLineNumber, f.endColumn, f.startLineNumber, f.startColumn)
      }

      static liftSelection(f) {
        return new A(f.selectionStartLineNumber, f.selectionStartColumn, f.positionLineNumber, f.positionColumn)
      }
      ...
      static selectionsArrEqual(f, p) {
        ...
        for (let c = 0, a = f.length; c < a; c++) if (!this.selectionsEqual(f[c], p[c])) return !1;
        return !0
      }

      static isISelection(f) {
        return f && typeof f.selectionStartLineNumber == "number" && typeof f.selectionStartColumn == "number" && typeof f.positionLineNumber == "number" && typeof f.positionColumn == "number"
      }
    ...
    "use strict";
    Object.defineProperty(n, "__esModule", {value: !0}), n.TextLength = void 0;
    ...
    class A {
      ...
      static betweenPositions(f, p) {
        return f.lineNumber === p.lineNumber ? new A(0, p.column - f.column) : new A(p.lineNumber - f.lineNumber, p.column - 1)
      }
...
` ? (p++, c = 0) : c++;
      ...
      isGreaterThanOrEqualTo(f) {
        return this.lineCount !== f.lineCount ? this.lineCount > f.lineCount : this.columnCount >= f.columnCount
      }

      createRange(f) {
        return this.lineCount === 0 ? new x.Range(f.lineNumber, f.column, f.lineNumber, f.column + this.columnCount) : new x.Range(f.lineNumber, f.column, f.lineNumber + this.lineCount, this.columnCount + 1)
      }

      addToPosition(f) {
        return this.lineCount === 0 ? new i.Position(f.lineNumber, f.column + this.columnCount) : new i.Position(f.lineNumber + this.lineCount, this.columnCount + 1)
      }
    ...
    "use strict";
    Object.defineProperty(n, "__esModule", {value: !0}), n.PositionOffsetTransformer = void 0;

    class A {
      constructor(f) {
        this.text = f, this.lineStartOffsetByLineIdx = [], this.lineStartOffsetByLineIdx.push(0);
        for (let p = 0; p < f.length; p++) f.charAt(p) === `
` && this.lineStartOffsetByLineIdx.push(p + 1)
      ...
      getOffsetRange(f) {
        return new i.OffsetRange(this.getOffset(f.getStartPosition()), this.getOffset(f.getEndPosition()))
      }

      get textLength() {
        const f = this.lineStartOffsetByLineIdx.length - 1;
        return new x.TextLength(f, this.text.length - this.lineStartOffsetByLineIdx[f])
      }
    }
    ...
    "use strict";
    Object.defineProperty(n, "__esModule", {value: !0}), n.StringText = n.AbstractText = n.SingleTextEdit = n.TextEdit = void 0;

    class c {
      constructor(s) {
        this.edits = s, (0, i.assertFn)(() => (0, i.checkAdjacentItems)(s, (o, u) => o.range.getEndPosition().isBeforeOrEqual(u.range.getStartPosition())))
      }

      apply(s) {
        let o = "", u = new A.Position(1, 1);
        for (const L of this.edits) {
          const N = L.range, P = N.getStartPosition(), E = N.getEndPosition(), v = m(u, P);
          v.isEmpty() || (o += s.getValueOfRange(v)), o += L.text, u = E
        }
      ...
      getNewRanges() {
        ...
        let o = 0, u = 0, S = 0;
        for (const L of this.edits) {
          const N = p.TextLength.ofText(L.text), P = A.Position.lift({
            lineNumber: L.range.startLineNumber + u,
            column: L.range.startColumn + (L.range.startLineNumber === o ? S : 0)
          }), E = N.createRange(P);
          s.push(E), u = E.endLineNumber - L.range.endLineNumber, S = E.endColumn - L.range.endColumn, o = L.range.endLineNumber
        }
        return s
      }
    }
    ...
    function m(r, s) {
      if (r.lineNumber === s.lineNumber && r.column === Number.MAX_SAFE_INTEGER) return f.Range.fromPositions(s, s);
      if (!r.isBeforeOrEqual(s)) throw new x.BugIndicatingError("start must be before end");
    ...
    class h extends e {
      constructor(s) {
        super(), this.value = s, this._t = new d.PositionOffsetTransformer(this.value)
      }
    ...
    "use strict";
    Object.defineProperty(n, "__esModule", {value: !0}), n.WordCharacterClassifier = void 0, n.getMapForWordSeparators = f;

    class A extends x.CharacterClassifier {
      constructor(c, a) {
        super(0), this._segmenter = null, this._cachedLine = null, this._cachedSegments = [], this.intlSegmenterLocales = a, this.intlSegmenterLocales.length > 0 ? this._segmenter = new Intl.Segmenter(this.intlSegmenterLocales, {granularity: "word"}) : this._segmenter = null;
        for (let m = 0, e = c.length; m < e; m++) this.set(c.charCodeAt(m), 2);
      ...
      findNextIntlWordAtOrAfterOffset(c, a) {
        for (const m of this._getIntlSegmenterWordsOnLine(c)) if (!(m.index < a)) return m;
        return null
      }

      _getIntlSegmenterWordsOnLine(c) {
        return this._segmenter ? this._cachedLine === c ? this._cachedSegments : (this._cachedLine = c, this._cachedSegments = this._filterWordSegments(this._segmenter.segment(c)), this._cachedSegments) : []
      }
    ...
    "use strict";
    Object.defineProperty(n, "__esModule", {value: !0}), n.DEFAULT_WORD_REGEXP = n.USUAL_WORD_SEPARATORS = void 0, n.ensureValidWordDefinition = d, n.getWordAtText = p, n.USUAL_WORD_SEPARATORS = "`~!@#$%^&*()-=+[{]}\\|;:'\",.<>/?";

    function A(a = "") {
      let m = "(-?\\d*\\.\\d\\w*)|([^";
      for (const e of n.USUAL_WORD_SEPARATORS) a.indexOf(e) >= 0 || (m += "\\" + e);
    ...
    function d(a) {
      ...
      if (a && a instanceof RegExp) if (a.global) m = a; else {
        let e = "g";
        a.ignoreCase && (e += "i"), a.multiline && (e += "m"), a.unicode && (e += "u"), m = new RegExp(a.source, e)
      }
    ...
    function p(a, m, e, h, r) {
      if (m = d(m), r || (r = i.Iterable.first(f)), e.length > r.maxLen) {
        let L = a - r.maxLen / 2;
        return L < 0 ? L = 0 : h += L, e = e.substring(L, a + r.maxLen / 2), p(a, m, e, h, r)
      }
      const s = Date.now(), o = a - 1 - h;
      let u = -1, S = null;
      ...
      if (S) {
        const L = {word: S[0], startColumn: h + 1 + S.index, endColumn: h + 1 + S.index + S[0].length};
    ...
    "use strict";
    Object.defineProperty(n, "__esModule", {value: !0}), n.DateTimeout = n.InfiniteTimeout = n.OffsetPair = n.SequenceDiff = n.DiffAlgorithmResult = void 0;

    class d {
      static trivial(e, h) {
        return new d([new f(A.OffsetRange.ofLength(e.length), A.OffsetRange.ofLength(h.length))], !1)
      }

      static trivialTimedOut(e, h) {
        return new d([new f(A.OffsetRange.ofLength(e.length), A.OffsetRange.ofLength(h.length))], !0)
      }
    ...
    class f {
      static invert(e, h) {
        const r = [];
        return (0, i.forEachAdjacent)(e, (s, o) => {
          r.push(f.fromOffsetPairs(s ? s.getEndExclusives() : p.zero, o ? o.getStarts() : new p(h, (s ? s.seq2Range.endExclusive - s.seq1Range.endExclusive : 0) + h)))
        }), r
      }

      static fromOffsetPairs(e, h) {
        return new f(new A.OffsetRange(e.offset1, h.offset1), new A.OffsetRange(e.offset2, h.offset2))
      }

      static assertSorted(e) {
        let h;
        for (const r of e) {
          if (h && !(h.seq1Range.endExclusive <= r.seq1Range.start && h.seq2Range.endExclusive <= r.seq2Range.start)) throw new x.BugIndicatingError("Sequence diffs must be sorted");
          h = r
        }
      }
      ...
      intersect(e) {
        const h = this.seq1Range.intersect(e.seq1Range), r = this.seq2Range.intersect(e.seq2Range);
    ...
    class a {
      constructor(e) {
        if (this.timeout = e, this.startTime = Date.now(), this.valid = !0, e <= 0) throw new x.BugIndicatingError("timeout must be positive")
      }
    ...
    class A {
      compute(a, m, e = x.InfiniteTimeout.instance) {
        if (a.length === 0 || m.length === 0) return x.DiffAlgorithmResult.trivial(a, m);
        const h = a, r = m;

        function s(l, b) {
          for (; l < h.length && b < r.length && h.getElement(l) === r.getElement(b);) l++, b++;
          return l
        }
        ...
        let L = 0;
        e:for (; ;) {
          if (o++, !e.isValid()) return x.DiffAlgorithmResult.trivialTimedOut(h, r);
          const l = -Math.min(o, r.length + o % 2), b = Math.min(o, h.length + o % 2);
          for (L = l; L <= b; L += 2) {
            let g = 0;
            const w = L === b ? -1 : u.get(L + 1), M = L === l ? -1 : u.get(L - 1) + 1;
            g++;
            const y = Math.min(Math.max(w, M), h.length), _ = y - L;
            if (g++, y > h.length || _ > r.length) continue;
            const C = s(y, _);
            u.set(L, C);
            const R = y === w ? S.get(L + 1) : S.get(L - 1);
            if (S.set(L, C !== y ? new d(R, y, _, C - y) : R), u.get(L) === h.length && u.get(L) - L === r.length) break e
          }
        }
        let N = S.get(L);
        const P = [];
        let E = h.length, v = r.length;
        for (; ;) {
          const l = N ? N.x + N.length : 0, b = N ? N.y + N.length : 0;
          if ((l !== E || b !== v) && P.push(new x.SequenceDiff(new i.OffsetRange(l, E), new i.OffsetRange(b, v))), !N) break;
    ...
    "use strict";
    Object.defineProperty(n, "__esModule", {value: !0}), n.optimizeSequenceDiffs = d, n.removeShortMatches = a, n.extendDiffsToEntireWordIfAppropriate = m, n.removeVeryShortMatchingLinesBetweenDiffs = h, n.removeVeryShortMatchingTextBetweenLongDiffs = r;
    ...
    function f(s, o, u) {
      ...
      for (let N = 1; N < u.length; N++) {
        ...
        if (E.seq1Range.isEmpty || E.seq2Range.isEmpty) {
          ...
          let l;
          for (l = 1; l <= v && !(s.getElement(E.seq1Range.start - l) !== s.getElement(E.seq1Range.endExclusive - l) || o.getElement(E.seq2Range.start - l) !== o.getElement(E.seq2Range.endExclusive - l)); l++) ;
          if (l--, l === v) {
            S[S.length - 1] = new A.SequenceDiff(new x.OffsetRange(P.seq1Range.start, E.seq1Range.endExclusive - v), new x.OffsetRange(P.seq2Range.start, E.seq2Range.endExclusive - v));
            continue
          }
          E = E.delta(-l)
        }
      ...
      for (let N = 0; N < S.length - 1; N++) {
        ...
        if (E.seq1Range.isEmpty || E.seq2Range.isEmpty) {
          ...
          let l;
          for (l = 0; l < v && !(!s.isStronglyEqual(E.seq1Range.start + l, E.seq1Range.endExclusive + l) || !o.isStronglyEqual(E.seq2Range.start + l, E.seq2Range.endExclusive + l)); l++) ;
          if (l === v) {
            S[N + 1] = new A.SequenceDiff(new x.OffsetRange(E.seq1Range.start + v, P.seq1Range.endExclusive), new x.OffsetRange(E.seq2Range.start + v, P.seq2Range.endExclusive));
            continue
          }
          l > 0 && (E = E.delta(l))
        }
    ...
    function p(s, o, u) {
      ...
      for (let S = 0; S < u.length; S++) {
        const L = S > 0 ? u[S - 1] : void 0, N = u[S], P = S + 1 < u.length ? u[S + 1] : void 0,
          E = new x.OffsetRange(L ? L.seq1Range.endExclusive + 1 : 0, P ? P.seq1Range.start - 1 : s.length),
          v = new x.OffsetRange(L ? L.seq2Range.endExclusive + 1 : 0, P ? P.seq2Range.start - 1 : o.length);
        N.seq1Range.isEmpty ? u[S] = c(N, s, o, E, v) : N.seq2Range.isEmpty && (u[S] = c(N.swap(), o, s, v, E).swap())
      }
      return u
    }
    ...
    function c(s, o, u, S, L) {
      let P = 1;
      for (; s.seq1Range.start - P >= S.start && s.seq2Range.start - P >= L.start && u.isStronglyEqual(s.seq2Range.start - P, s.seq2Range.endExclusive - P) && P < 100;) P++;
      P--;
      let E = 0;
      for (; s.seq1Range.start + E < S.endExclusive && s.seq2Range.endExclusive + E < L.endExclusive && u.isStronglyEqual(s.seq2Range.start + E, s.seq2Range.endExclusive + E) && E < 100;) E++;
      if (P === 0 && E === 0) return s;
      let v = 0, l = -1;
      for (let b = -P; b <= E; b++) {
        const g = s.seq2Range.start + b, w = s.seq2Range.endExclusive + b, M = s.seq1Range.start + b,
          y = o.getBoundaryScore(M) + u.getBoundaryScore(g) + u.getBoundaryScore(w);
        y > l && (l = y, v = b)
      }
      return s.delta(v)
    }
    ...
    function a(s, o, u) {
      ...
      for (const L of u) {
        ...
        L.seq1Range.start - N.seq1Range.endExclusive <= 2 || L.seq2Range.start - N.seq2Range.endExclusive <= 2 ? S[S.length - 1] = new A.SequenceDiff(N.seq1Range.join(L.seq1Range), N.seq2Range.join(L.seq2Range)) : S.push(L)
      }
      return S
    }

    function m(s, o, u) {
      const S = A.SequenceDiff.invert(u, s.length), L = [];
      let N = new A.OffsetPair(0, 0);

      function P(v, l) {
        if (v.offset1 < N.offset1 || v.offset2 < N.offset2) return;
        const b = s.findWordContaining(v.offset1), g = o.findWordContaining(v.offset2);
        if (!b || !g) return;
        let w = new A.SequenceDiff(b, g);
        const M = w.intersect(l);
        let y = M.seq1Range.length, _ = M.seq2Range.length;
        for (; S.length > 0;) {
          const C = S[0];
          if (!(C.seq1Range.intersects(w.seq1Range) || C.seq2Range.intersects(w.seq2Range))) break;
          const D = s.findWordContaining(C.seq1Range.start), T = o.findWordContaining(C.seq2Range.start),
            O = new A.SequenceDiff(D, T), z = O.intersect(C);
          if (y += z.seq1Range.length, _ += z.seq2Range.length, w = w.join(O), w.seq1Range.endExclusive >= C.seq1Range.endExclusive) S.shift(); else break
        }
        y + _ < (w.seq1Range.length + w.seq2Range.length) * 2 / 3 && L.push(w), N = w.getEndExclusives()
      }

      for (; S.length > 0;) {
        const v = S.shift();
        v.seq1Range.isEmpty || (P(v.getStarts(), v), P(v.getEndExclusives().delta(-1), v))
      }
      return e(u, L)
    }
    ...
    function e(s, o) {
      ...
      for (; s.length > 0 || o.length > 0;) {
        const S = s[0], L = o[0];
        let N;
        S && (!L || S.seq1Range.start < L.seq1Range.start) ? N = s.shift() : N = o.shift(), u.length > 0 && u[u.length - 1].seq1Range.endExclusive >= N.seq1Range.start ? u[u.length - 1] = u[u.length - 1].join(N) : u.push(N)
      }
      return u
    }
    ...
    function h(s, o, u) {
      ...
      do {
        ...
        for (let E = 1; E < S.length; E++) {
          let b = function (w, M) {
            const y = new x.OffsetRange(l.seq1Range.endExclusive, v.seq1Range.start);
            return s.getText(y).replace(/\s/g, "").length <= 4 && (w.seq1Range.length + w.seq2Range.length > 5 || M.seq1Range.length + M.seq2Range.length > 5)
          };
          const v = S[E], l = P[P.length - 1];
          b(l, v) ? (N = !0, P[P.length - 1] = P[P.length - 1].join(v)) : P.push(v)
        }
        S = P
      } while (L++ < 10 && N);
      return S
    ...
    function r(s, o, u) {
      ...
      do {
        ...
        for (let v = 1; v < S.length; v++) {
          let g = function (M, y) {
            const _ = new x.OffsetRange(b.seq1Range.endExclusive, l.seq1Range.start);
            if (s.countLinesIn(_) > 5 || _.length > 500) return !1;
            const R = s.getText(_).trim();
            if (R.length > 20 || R.split(/\r\n|\r|\n/).length > 1) return !1;
            const D = s.countLinesIn(M.seq1Range), T = M.seq1Range.length, O = o.countLinesIn(M.seq2Range),
              z = M.seq2Range.length, j = s.countLinesIn(y.seq1Range), F = y.seq1Range.length,
              q = o.countLinesIn(y.seq2Range), B = y.seq2Range.length, G = 2 * 40 + 50;

            function $(U) {
              return Math.min(U, G)
            }

            return Math.pow(Math.pow($(D * 40 + T), 1.5) + Math.pow($(O * 40 + z), 1.5), 1.5) + Math.pow(Math.pow($(j * 40 + F), 1.5) + Math.pow($(q * 40 + B), 1.5), 1.5) > (G ** 1.5) ** 1.5 * 1.3
          };
          const l = S[v], b = E[E.length - 1];
          g(b, l) ? (N = !0, E[E.length - 1] = E[E.length - 1].join(l)) : E.push(l)
        }
        S = E
      } while (L++ < 10 && N);
      const P = [];
      return (0, i.forEachWithNeighbors)(S, (E, v, l) => {
        let b = v;

        function g(R) {
          return R.length > 0 && R.trim().length <= 3 && v.seq1Range.length + v.seq2Range.length > 100
        }

        const w = s.extendToFullLines(v.seq1Range), M = s.getText(new x.OffsetRange(w.start, v.seq1Range.start));
        g(M) && (b = b.deltaStart(-M.length));
        const y = s.getText(new x.OffsetRange(v.seq1Range.endExclusive, w.endExclusive));
        g(y) && (b = b.deltaEnd(y.length));
        const _ = A.SequenceDiff.fromOffsetPairs(E ? E.getEndExclusives() : A.OffsetPair.zero, l ? l.getStarts() : A.OffsetPair.max),
          C = b.intersect(_);
        P.length > 0 && C.getStarts().equals(P[P.length - 1].getEndExclusives()) ? P[P.length - 1] = P[P.length - 1].join(C) : P.push(C)
      }), P
    }
    ...
    class i {
      ...
      getBoundaryScore(d) {
        const f = d === 0 ? 0 : x(this.lines[d - 1]), p = d === this.lines.length ? 0 : x(this.lines[d]);
        return 1e3 - (f + p)
      }
...
`)
    ...
    function x(A) {
      let d = 0;
      for (; d < A.length && (A.charCodeAt(d) === 32 || A.charCodeAt(d) === 9);) d++;
      return d
    }
  }), X(J[16], Z([0, 1]), function (W, n) {
    "use strict";
    Object.defineProperty(n, "__esModule", {value: !0}), n.LineRangeFragment = n.Array2D = void 0, n.isSpace = x;
    ...
    class A {
      ...
      constructor(f, p, c) {
        this.range = f, this.lines = p, this.source = c, this.histogram = [];
        let a = 0;
        for (let m = f.startLineNumber - 1; m < f.endLineNumberExclusive - 1; m++) {
          const e = p[m];
          for (let r = 0; r < e.length; r++) {
            a++;
            const s = e[r], o = A.getKey(s);
...
`);
      ...
      computeSimilarity(f) {
        ...
        for (let a = 0; a < c; a++) p += Math.abs((this.histogram[a] ?? 0) - (f.histogram[a] ?? 0));
    ...
    class d {
      compute(p, c, a = x.InfiniteTimeout.instance, m) {
        if (p.length === 0 || c.length === 0) return x.DiffAlgorithmResult.trivial(p, c);
        const e = new A.Array2D(p.length, c.length), h = new A.Array2D(p.length, c.length),
          r = new A.Array2D(p.length, c.length);
        for (let P = 0; P < p.length; P++) for (let E = 0; E < c.length; E++) {
          if (!a.isValid()) return x.DiffAlgorithmResult.trivialTimedOut(p, c);
          const v = P === 0 ? 0 : e.get(P - 1, E), l = E === 0 ? 0 : e.get(P, E - 1);
          let b;
          p.getElement(P) === c.getElement(E) ? (P === 0 || E === 0 ? b = 0 : b = e.get(P - 1, E - 1), P > 0 && E > 0 && h.get(P - 1, E - 1) === 3 && (b += r.get(P - 1, E - 1)), b += m ? m(P, E) : 1) : b = -1;
          const g = Math.max(v, l, b);
          if (g === b) {
            const w = P > 0 && E > 0 ? r.get(P - 1, E - 1) : 0;
            r.set(P, E, w + 1), h.set(P, E, 3)
          } else g === v ? (r.set(P, E, 0), h.set(P, E, 1)) : g === l && (r.set(P, E, 0), h.set(P, E, 2));
          e.set(P, E, g)
        }
        const s = [];
        let o = p.length, u = c.length;

        function S(P, E) {
          (P + 1 !== o || E + 1 !== u) && s.push(new x.SequenceDiff(new i.OffsetRange(P + 1, o), new i.OffsetRange(E + 1, u))), o = P, u = E
        }

        let L = p.length - 1, N = c.length - 1;
        for (; L >= 0 && N >= 0;) h.get(L, N) === 3 ? (S(L, N), L--, N--) : h.get(L, N) === 1 ? L-- : N--;
    ...
    "use strict";
    Object.defineProperty(n, "__esModule", {value: !0}), n.LinesSliceCharSequence = void 0;

    class p {
      constructor(r, s, o) {
        this.lines = r, this.range = s, this.considerWhitespaceChanges = o, this.elements = [], this.firstElementOffsetByLineIdx = [], this.lineStartOffsets = [], this.trimmedWsLengthsByLineIdx = [], this.firstElementOffsetByLineIdx.push(0);
        for (let u = this.range.startLineNumber; u <= this.range.endLineNumber; u++) {
          let S = r[u - 1], L = 0;
          u === this.range.startLineNumber && this.range.startColumn > 1 && (L = this.range.startColumn - 1, S = S.substring(L)), this.lineStartOffsets.push(L);
          let N = 0;
          if (!o) {
            const E = S.trimStart();
          ...
          const P = u === this.range.endLineNumber ? Math.min(this.range.endColumn - 1 - L - N, S.length) : S.length;
          for (let E = 0; E < P; E++) this.elements.push(S.charCodeAt(E));
          u < this.range.endLineNumber && (this.elements.push(10), this.firstElementOffsetByLineIdx.push(this.elements.length))
        }
      }
      ...
      getText(r) {
        return this.elements.slice(r.start, r.endExclusive).map(s => String.fromCharCode(s)).join("")
      }
      ...
      getBoundaryScore(r) {
        const s = e(r > 0 ? this.elements[r - 1] : -1), o = e(r < this.elements.length ? this.elements[r] : -1);
        if (s === 7 && o === 8) return 0;
        if (s === 8) return 150;
        let u = 0;
        return s !== o && (u += 10, s === 0 && o === 1 && (u += 1)), u += m(s), u += m(o), u
      }

      translateOffset(r, s = "right") {
        const o = (0, i.findLastIdxMonotonous)(this.firstElementOffsetByLineIdx, S => S <= r),
          u = r - this.firstElementOffsetByLineIdx[o];
        return new A.Position(this.range.startLineNumber + o, 1 + this.lineStartOffsets[o] + u + (u === 0 && s === "left" ? 0 : this.trimmedWsLengthsByLineIdx[o]))
      }

      translateRange(r) {
        const s = this.translateOffset(r.start, "right"), o = this.translateOffset(r.endExclusive, "left");
        return o.isBefore(s) ? d.Range.fromPositions(o, o) : d.Range.fromPositions(s, o)
      }

      findWordContaining(r) {
        if (r < 0 || r >= this.elements.length || !c(this.elements[r])) return;
        let s = r;
      ...
      countLinesIn(r) {
        return this.translateOffset(r.endExclusive).lineNumber - this.translateOffset(r.start).lineNumber
      }
      ...
      extendToFullLines(r) {
        const s = (0, i.findLastMonotonous)(this.firstElementOffsetByLineIdx, u => u <= r.start) ?? 0,
          o = (0, i.findFirstMonotonous)(this.firstElementOffsetByLineIdx, u => r.endExclusive <= u) ?? this.elements.length;
        return new x.OffsetRange(s, o)
      }
    }
    ...
    function c(h) {
      return h >= 97 && h <= 122 || h >= 65 && h <= 90 || h >= 48 && h <= 57
    }
    ...
    function e(h) {
      return h === 10 ? 8 : h === 13 ? 7 : (0, f.isSpace)(h) ? 6 : h >= 97 && h <= 122 ? 0 : h >= 65 && h <= 90 ? 1 : h >= 48 && h <= 57 ? 2 : h === -1 ? 3 : h === 44 || h === 59 ? 5 : 4
    }
  }), X(J[34], Z([0, 1]), function (W, n) {
    "use strict";
    Object.defineProperty(n, "__esModule", {value: !0}), n.MovedText = n.LinesDiff = void 0;
    ...
    "use strict";
    Object.defineProperty(n, "__esModule", {value: !0}), n.RangeMapping = n.DetailedLineRangeMapping = n.LineRangeMapping = void 0;
    ...
    class p {
      static inverse(r, s, o) {
        ...
        let S = 1, L = 1;
        for (const P of r) {
          const E = new p(new x.LineRange(S, P.original.startLineNumber), new x.LineRange(L, P.modified.startLineNumber));
          E.modified.isEmpty || u.push(E), S = P.original.endLineNumberExclusive, L = P.modified.endLineNumberExclusive
        }
      ...
      static clip(r, s, o) {
        const u = [];
        for (const S of r) {
          const L = S.original.intersect(s), N = S.modified.intersect(o);
      ...
      join(r) {
        return new p(this.original.join(r.original), this.modified.join(r.modified))
      }

      toRangeMapping() {
        const r = this.original.toInclusiveRange(), s = this.modified.toInclusiveRange();
        if (r && s) return new e(r, s);
        if (this.original.startLineNumber === 1 || this.modified.startLineNumber === 1) {
          if (!(this.modified.startLineNumber === 1 && this.original.startLineNumber === 1)) throw new i.BugIndicatingError("not a valid diff");
          return new e(new d.Range(this.original.startLineNumber, 1, this.original.endLineNumberExclusive, 1), new d.Range(this.modified.startLineNumber, 1, this.modified.endLineNumberExclusive, 1))
        } else return new e(new d.Range(this.original.startLineNumber - 1, Number.MAX_SAFE_INTEGER, this.original.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), new d.Range(this.modified.startLineNumber - 1, Number.MAX_SAFE_INTEGER, this.modified.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER))
      }

      toRangeMapping2(r, s) {
        if (a(this.original.endLineNumberExclusive, r) && a(this.modified.endLineNumberExclusive, s)) return new e(new d.Range(this.original.startLineNumber, 1, this.original.endLineNumberExclusive, 1), new d.Range(this.modified.startLineNumber, 1, this.modified.endLineNumberExclusive, 1));
        if (!this.original.isEmpty && !this.modified.isEmpty) return new e(d.Range.fromPositions(new A.Position(this.original.startLineNumber, 1), c(new A.Position(this.original.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), r)), d.Range.fromPositions(new A.Position(this.modified.startLineNumber, 1), c(new A.Position(this.modified.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), s)));
    ...
    function c(h, r) {
      ...
      if (h.lineNumber > r.length) return new A.Position(r.length, r[r.length - 1].length + 1);
      const s = r[h.lineNumber - 1];
      return h.column > s.length + 1 ? new A.Position(h.lineNumber, s.length + 1) : h
    }
    ...
    class m extends p {
      static fromRangeMappings(r) {
        const s = x.LineRange.join(r.map(u => x.LineRange.fromRangeInclusive(u.originalRange))),
          o = x.LineRange.join(r.map(u => x.LineRange.fromRangeInclusive(u.modifiedRange)));
        return new m(s, o, r)
      }
      ...
      flip() {
        return new m(this.modified, this.original, this.innerChanges?.map(r => r.flip()))
      }
    ...
    class e {
      static assertSorted(r) {
        for (let s = 1; s < r.length; s++) {
          const o = r[s - 1], u = r[s];
          if (!(o.originalRange.getEndPosition().isBeforeOrEqual(u.originalRange.getStartPosition()) && o.modifiedRange.getEndPosition().isBeforeOrEqual(u.modifiedRange.getStartPosition()))) throw new i.BugIndicatingError("Range mappings must be sorted")
        }
      }
    ...
    n.RangeMapping = e
  }), X(J[55], Z([0, 1, 10, 17, 7, 15, 21, 13, 33, 16, 32, 2]), function (W, n, i, x, A, d, f, p, c, a, m, e) {
    "use strict";
    Object.defineProperty(n, "__esModule", {value: !0}), n.computeMovedLines = h;

    function h(N, P, E, v, l, b) {
      let {moves: g, excludedChanges: w} = s(N, P, E, b);
      if (!b.isValid()) return [];
      const M = N.filter(_ => !w.has(_)), y = o(M, v, l, P, E, b);
      return (0, A.pushMany)(g, y), g = S(g), g = g.filter(_ => {
        const C = _.original.toOffsetRange().slice(P).map(D => D.trim());
        return C.join(`
`).length >= 15 && r(C, D => D.length >= 2) >= 2
    ...
    function s(N, P, E, v) {
      const l = [],
        b = N.filter(M => M.modified.isEmpty && M.original.length >= 3).map(M => new a.LineRangeFragment(M.original, P, M)),
        g = new Set(N.filter(M => M.original.isEmpty && M.modified.length >= 3).map(M => new a.LineRangeFragment(M.modified, E, M))),
        w = new Set;
      for (const M of b) {
        let y = -1, _;
        for (const C of g) {
        ...
        if (y > .9 && _ && (g.delete(_), l.push(new x.LineRangeMapping(M.range, _.range)), w.add(M.source), w.add(_.source)), !v.isValid()) return {
          moves: l,
          excludedChanges: w
        }
      }
    ...
    function o(N, P, E, v, l, b) {
      const g = [], w = new f.SetMap;
      for (const R of N) for (let D = R.original.startLineNumber; D < R.original.endLineNumberExclusive - 2; D++) {
        const T = `${P[D - 1]}:${P[D + 1 - 1]}:${P[D + 2 - 1]}`;
        w.add(T, {range: new p.LineRange(D, D + 3)})
      }
      const M = [];
      N.sort((0, A.compareBy)(R => R.modified.startLineNumber, A.numberComparator));
      for (const R of N) {
        let D = [];
        for (let T = R.modified.startLineNumber; T < R.modified.endLineNumberExclusive - 2; T++) {
          const O = `${E[T - 1]}:${E[T + 1 - 1]}:${E[T + 2 - 1]}`, z = new p.LineRange(T, T + 3), j = [];
          w.forEach(O, ({range: F}) => {
            for (const B of D) if (B.originalLineRange.endLineNumberExclusive + 1 === F.endLineNumberExclusive && B.modifiedLineRange.endLineNumberExclusive + 1 === z.endLineNumberExclusive) {
              B.originalLineRange = new p.LineRange(B.originalLineRange.startLineNumber, F.endLineNumberExclusive), B.modifiedLineRange = new p.LineRange(B.modifiedLineRange.startLineNumber, z.endLineNumberExclusive), j.push(B);
              return
            }
      ...
      M.sort((0, A.reverseOrder)((0, A.compareBy)(R => R.modifiedLineRange.length, A.numberComparator)));
      const y = new p.LineRangeSet, _ = new p.LineRangeSet;
      for (const R of M) {
        const D = R.modifiedLineRange.startLineNumber - R.originalLineRange.startLineNumber,
          T = y.subtractFrom(R.modifiedLineRange), O = _.subtractFrom(R.originalLineRange).getWithDelta(D),
          z = T.getIntersection(O);
        for (const j of z.ranges) {
          if (j.length < 3) continue;
          const F = j, q = j.delta(-D);
          g.push(new x.LineRangeMapping(q, F)), y.addRange(F), _.addRange(q)
        }
      }
      g.sort((0, A.compareBy)(R => R.original.startLineNumber, A.numberComparator));
      const C = new d.MonotonousArray(N);
      for (let R = 0; R < g.length; R++) {
        const D = g[R], T = C.findLastMonotonous($ => $.original.startLineNumber <= D.original.startLineNumber),
          O = (0, d.findLastMonotonous)(N, $ => $.modified.startLineNumber <= D.modified.startLineNumber),
          z = Math.max(D.original.startLineNumber - T.original.startLineNumber, D.modified.startLineNumber - O.modified.startLineNumber),
          j = C.findLastMonotonous($ => $.original.startLineNumber < D.original.endLineNumberExclusive),
          F = (0, d.findLastMonotonous)(N, $ => $.modified.startLineNumber < D.modified.endLineNumberExclusive),
          q = Math.max(j.original.endLineNumberExclusive - D.original.endLineNumberExclusive, F.modified.endLineNumberExclusive - D.modified.endLineNumberExclusive);
        let B;
        for (B = 0; B < z; B++) {
          const $ = D.original.startLineNumber - B - 1, U = D.modified.startLineNumber - B - 1;
          if ($ > v.length || U > l.length || y.contains(U) || _.contains($) || !u(v[$ - 1], l[U - 1], b)) break
        }
        B > 0 && (_.addRange(new p.LineRange(D.original.startLineNumber - B, D.original.startLineNumber)), y.addRange(new p.LineRange(D.modified.startLineNumber - B, D.modified.startLineNumber)));
        let G;
        for (G = 0; G < q; G++) {
          const $ = D.original.endLineNumberExclusive + G, U = D.modified.endLineNumberExclusive + G;
          if ($ > v.length || U > l.length || y.contains(U) || _.contains($) || !u(v[$ - 1], l[U - 1], b)) break
        }
        G > 0 && (_.addRange(new p.LineRange(D.original.endLineNumberExclusive, D.original.endLineNumberExclusive + G)), y.addRange(new p.LineRange(D.modified.endLineNumberExclusive, D.modified.endLineNumberExclusive + G))), (B > 0 || G > 0) && (g[R] = new x.LineRangeMapping(new p.LineRange(D.original.startLineNumber - B, D.original.endLineNumberExclusive + G), new p.LineRange(D.modified.startLineNumber - B, D.modified.endLineNumberExclusive + G)))
      }
      return g
    }
    ...
    function u(N, P, E) {
      ...
      const l = new m.MyersDiffAlgorithm().compute(new c.LinesSliceCharSequence([N], new e.Range(1, 1, 1, N.length), !1), new c.LinesSliceCharSequence([P], new e.Range(1, 1, 1, P.length), !1), E);
      let b = 0;
      const g = i.SequenceDiff.invert(l.diffs, N.length);
      for (const _ of g) _.seq1Range.forEach(C => {
        (0, a.isSpace)(N.charCodeAt(C)) || b++
      });

      function w(_) {
        let C = 0;
        for (let R = 0; R < N.length; R++) (0, a.isSpace)(_.charCodeAt(R)) || C++;
        return C
      }
    ...
    function S(N) {
      ...
      N.sort((0, A.compareBy)(E => E.original.startLineNumber, A.numberComparator));
      const P = [N[0]];
      for (let E = 1; E < N.length; E++) {
        const v = P[P.length - 1], l = N[E], b = l.original.startLineNumber - v.original.endLineNumberExclusive,
          g = l.modified.startLineNumber - v.modified.endLineNumberExclusive;
        if (b >= 0 && g >= 0 && b + g <= 2) {
    ...
    function L(N, P) {
      ...
      return P = P.filter(v => {
        const l = E.findLastMonotonous(w => w.original.startLineNumber < v.original.endLineNumberExclusive) || new x.LineRangeMapping(new p.LineRange(1, 1), new p.LineRange(1, 1)),
          b = (0, d.findLastMonotonous)(N, w => w.modified.startLineNumber < v.modified.endLineNumberExclusive);
        return l !== b
      }), P
    }
  }), X(J[56], Z([0, 1, 7, 12, 13, 5, 2, 10, 54, 32, 55, 52, 53, 33, 34, 17]), function (W, n, i, x, A, d, f, p, c, a, m, e, h, r, s, o) {
    "use strict";
    Object.defineProperty(n, "__esModule", {value: !0}), n.DefaultLinesDiffComputer = void 0, n.lineRangeMappingFromRangeMappings = S, n.getLineRangeMapping = L;

    class u {
      constructor() {
        this.dynamicProgrammingDiffing = new c.DynamicProgrammingDiffing, this.myersDiffingAlgorithm = new a.MyersDiffAlgorithm
      }

      computeDiff(E, v, l) {
        if (E.length <= 1 && (0, i.equals)(E, v, ($, U) => $ === U)) return new s.LinesDiff([], [], !1);
        if (E.length === 1 && E[0].length === 0 || v.length === 1 && v[0].length === 0) return new s.LinesDiff([new o.DetailedLineRangeMapping(new A.LineRange(1, E.length + 1), new A.LineRange(1, v.length + 1), [new o.RangeMapping(new f.Range(1, 1, E.length, E[E.length - 1].length + 1), new f.Range(1, 1, v.length, v[v.length - 1].length + 1))])], [], !1);
        const b = l.maxComputationTimeMs === 0 ? p.InfiniteTimeout.instance : new p.DateTimeout(l.maxComputationTimeMs),
          g = !l.ignoreTrimWhitespace, w = new Map;
        ...
        const y = E.map($ => M($.trim())), _ = v.map($ => M($.trim())), C = new h.LineSequence(y, E),
          R = new h.LineSequence(_, v),
          D = C.length + R.length < 1700 ? this.dynamicProgrammingDiffing.compute(C, R, b, ($, U) => E[$] === v[U] ? v[U].length === 0 ? .1 : 1 + Math.log(1 + v[U].length) : .99) : this.myersDiffingAlgorithm.compute(C, R, b);
        let T = D.diffs, O = D.hitTimeout;
        T = (0, e.optimizeSequenceDiffs)(C, R, T), T = (0, e.removeVeryShortMatchingLinesBetweenDiffs)(C, R, T);
        const z = [], j = $ => {
          if (g) for (let U = 0; U < $; U++) {
            const ee = F + U, re = q + U;
            if (E[ee] !== v[re]) {
              const ue = this.refineDiff(E, v, new p.SequenceDiff(new d.OffsetRange(ee, ee + 1), new d.OffsetRange(re, re + 1)), b, g);
        ...
        let F = 0, q = 0;
        for (const $ of T) {
          (0, x.assertFn)(() => $.seq1Range.start - F === $.seq2Range.start - q);
          const U = $.seq1Range.start - F;
          j(U), F = $.seq1Range.endExclusive, q = $.seq2Range.endExclusive;
        ...
        const B = S(z, E, v);
        let G = [];
        return l.computeMoves && (G = this.computeMoves(B, E, v, y, _, b, g)), (0, x.assertFn)(() => {
          function $(ee, re) {
          ...
          function U(ee, re) {
            return !(ee.startLineNumber < 1 || ee.startLineNumber > re.length + 1 || ee.endLineNumberExclusive < 1 || ee.endLineNumberExclusive > re.length + 1)
          }

          for (const ee of B) {
            if (!ee.innerChanges) return !1;
            for (const re of ee.innerChanges) if (!($(re.modifiedRange.getStartPosition(), v) && $(re.modifiedRange.getEndPosition(), v) && $(re.originalRange.getStartPosition(), E) && $(re.originalRange.getEndPosition(), E))) return !1;
      ...
      computeMoves(E, v, l, b, g, w, M) {
        return (0, m.computeMovedLines)(E, v, l, b, g, w).map(C => {
          const R = this.refineDiff(v, l, new p.SequenceDiff(C.original.toOffsetRange(), C.modified.toOffsetRange()), w, M),
      ...
      refineDiff(E, v, l, b, g) {
        const M = N(l).toRangeMapping2(E, v), y = new r.LinesSliceCharSequence(E, M.originalRange, g),
          _ = new r.LinesSliceCharSequence(v, M.modifiedRange, g),
          C = y.length + _.length < 500 ? this.dynamicProgrammingDiffing.compute(y, _, b) : this.myersDiffingAlgorithm.compute(y, _, b),
          R = !1;
        let D = C.diffs;
        R && p.SequenceDiff.assertSorted(D), D = (0, e.optimizeSequenceDiffs)(y, _, D), R && p.SequenceDiff.assertSorted(D), D = (0, e.extendDiffsToEntireWordIfAppropriate)(y, _, D), R && p.SequenceDiff.assertSorted(D), D = (0, e.removeShortMatches)(y, _, D), R && p.SequenceDiff.assertSorted(D), D = (0, e.removeVeryShortMatchingTextBetweenLongDiffs)(y, _, D), R && p.SequenceDiff.assertSorted(D);
        const T = D.map(O => new o.RangeMapping(y.translateRange(O.seq1Range), _.translateRange(O.seq2Range)));
        return R && o.RangeMapping.assertSorted(T), {mappings: T, hitTimeout: C.hitTimeout}
      }
    }
    ...
    function S(P, E, v, l = !1) {
      const b = [];
      for (const g of (0, i.groupAdjacentBy)(P.map(w => L(w, E, v)), (w, M) => w.original.overlapOrTouch(M.original) || w.modified.overlapOrTouch(M.modified))) {
        const w = g[0], M = g[g.length - 1];
        b.push(new o.DetailedLineRangeMapping(w.original.join(M.original), w.modified.join(M.modified), g.map(y => y.innerChanges[0])))
      }
    ...
    function L(P, E, v) {
      ...
      const g = new A.LineRange(P.originalRange.startLineNumber + l, P.originalRange.endLineNumber + 1 + b),
        w = new A.LineRange(P.modifiedRange.startLineNumber + l, P.modifiedRange.endLineNumber + 1 + b);
      return new o.DetailedLineRangeMapping(g, w, [P])
    }

    function N(P) {
      return new o.LineRangeMapping(new A.LineRange(P.seq1Range.start + 1, P.seq1Range.endExclusive + 1), new A.LineRange(P.seq2Range.start + 1, P.seq2Range.endExclusive + 1))
    }
  }), X(J[57], Z([0, 1, 24, 34, 17, 6, 2, 12, 13]), function (W, n, i, x, A, d, f, p, c) {
    "use strict";
    Object.defineProperty(n, "__esModule", {value: !0}), n.DiffComputer = n.LegacyLinesDiffComputer = void 0;
    const a = 3;
    ...
    class m {
      computeDiff(v, l, b) {
        ...
        for (const _ of w.changes) {
          let C;
          _.originalEndLineNumber === 0 ? C = new c.LineRange(_.originalStartLineNumber + 1, _.originalStartLineNumber + 1) : C = new c.LineRange(_.originalStartLineNumber, _.originalEndLineNumber + 1);
          let R;
          _.modifiedEndLineNumber === 0 ? R = new c.LineRange(_.modifiedStartLineNumber + 1, _.modifiedStartLineNumber + 1) : R = new c.LineRange(_.modifiedStartLineNumber, _.modifiedEndLineNumber + 1);
          let D = new A.DetailedLineRangeMapping(C, R, _.charChanges?.map(T => new A.RangeMapping(new f.Range(T.originalStartLineNumber, T.originalStartColumn, T.originalEndLineNumber, T.originalEndColumn), new f.Range(T.modifiedStartLineNumber, T.modifiedStartColumn, T.modifiedEndLineNumber, T.modifiedEndColumn))));
          y && (y.modified.endLineNumberExclusive === D.modified.startLineNumber || y.original.endLineNumberExclusive === D.original.startLineNumber) && (D = new A.DetailedLineRangeMapping(y.original.join(D.original), y.modified.join(D.modified), y.innerChanges && D.innerChanges ? y.innerChanges.concat(D.innerChanges) : void 0), M.pop()), M.push(D), y = D
        }
        return (0, p.assertFn)(() => (0, p.checkAdjacentItems)(M, (_, C) => C.original.startLineNumber - _.original.endLineNumberExclusive === C.modified.startLineNumber - _.modified.endLineNumberExclusive && _.original.endLineNumberExclusive < C.original.startLineNumber && _.modified.endLineNumberExclusive < C.modified.startLineNumber)), new x.LinesDiff(M, [], w.quitEarly)
      }
    }
    ...
    class h {
      constructor(v) {
        const l = [], b = [];
        for (let g = 0, w = v.length; g < w; g++) l[g] = L(v[g], 1), b[g] = N(v[g], 1);
        this.lines = v, this._startColumns = l, this._endColumns = b
      }

      getElements() {
        const v = [];
        for (let l = 0, b = this.lines.length; l < b; l++) v[l] = this.lines[l].substring(this._startColumns[l] - 1, this._endColumns[l] - 1);
        return v
      }
      ...
      createCharSequence(v, l, b) {
        ...
        let y = 0;
        for (let _ = l; _ <= b; _++) {
          const C = this.lines[_], R = v ? this._startColumns[_] : 1, D = v ? this._endColumns[_] : C.length + 1;
          for (let T = R; T < D; T++) g[y] = C.charCodeAt(T - 1), w[y] = _ + 1, M[y] = T, y++;
          !v && _ < b && (g[y] = 10, w[y] = _ + 1, M[y] = C.length + 1, y++)
        }
        return new r(g, w, M)
      }
    }
    ...
    class r {
      constructor(v, l, b) {
        this._charCodes = v, this._lineNumbers = l, this._columns = b
      }

      toString() {
        return "[" + this._charCodes.map((v, l) => (v === 10 ? "\\n" : String.fromCharCode(v)) + `-(${this._lineNumbers[l]},${this._columns[l]})`).join(", ") + "]"
      }
      ...
      getStartLineNumber(v) {
        return v > 0 && v === this._lineNumbers.length ? this.getEndLineNumber(v - 1) : (this._assertIndex(v, this._lineNumbers), this._lineNumbers[v])
      }

      getEndLineNumber(v) {
        return v === -1 ? this.getStartLineNumber(v + 1) : (this._assertIndex(v, this._lineNumbers), this._charCodes[v] === 10 ? this._lineNumbers[v] + 1 : this._lineNumbers[v])
      }

      getStartColumn(v) {
        return v > 0 && v === this._columns.length ? this.getEndColumn(v - 1) : (this._assertIndex(v, this._columns), this._columns[v])
      }

      getEndColumn(v) {
        return v === -1 ? this.getStartColumn(v + 1) : (this._assertIndex(v, this._columns), this._charCodes[v] === 10 ? 1 : this._columns[v] + 1)
      }
    }

    class s {
      constructor(v, l, b, g, w, M, y, _) {
        this.originalStartLineNumber = v, this.originalStartColumn = l, this.originalEndLineNumber = b, this.originalEndColumn = g, this.modifiedStartLineNumber = w, this.modifiedStartColumn = M, this.modifiedEndLineNumber = y, this.modifiedEndColumn = _
      }

      static createFromDiffChange(v, l, b) {
        const g = l.getStartLineNumber(v.originalStart), w = l.getStartColumn(v.originalStart),
          M = l.getEndLineNumber(v.originalStart + v.originalLength - 1),
          y = l.getEndColumn(v.originalStart + v.originalLength - 1), _ = b.getStartLineNumber(v.modifiedStart),
          C = b.getStartColumn(v.modifiedStart), R = b.getEndLineNumber(v.modifiedStart + v.modifiedLength - 1),
    ...
    function o(E) {
      ...
      for (let b = 1, g = E.length; b < g; b++) {
        const w = E[b], M = w.originalStart - (l.originalStart + l.originalLength),
          y = w.modifiedStart - (l.modifiedStart + l.modifiedLength);
        Math.min(M, y) < a ? (l.originalLength = w.originalStart + w.originalLength - l.originalStart, l.modifiedLength = w.modifiedStart + w.modifiedLength - l.modifiedStart) : (v.push(w), l = w)
      }
      return v
    }
    ...
    class u {
      constructor(v, l, b, g, w) {
        this.originalStartLineNumber = v, this.originalEndLineNumber = l, this.modifiedStartLineNumber = b, this.modifiedEndLineNumber = g, this.charChanges = w
      }

      static createFromDiffResult(v, l, b, g, w, M, y) {
        let _, C, R, D, T;
        if (l.originalLength === 0 ? (_ = b.getStartLineNumber(l.originalStart) - 1, C = 0) : (_ = b.getStartLineNumber(l.originalStart), C = b.getEndLineNumber(l.originalStart + l.originalLength - 1)), l.modifiedLength === 0 ? (R = g.getStartLineNumber(l.modifiedStart) - 1, D = 0) : (R = g.getStartLineNumber(l.modifiedStart), D = g.getEndLineNumber(l.modifiedStart + l.modifiedLength - 1)), M && l.originalLength > 0 && l.originalLength < 20 && l.modifiedLength > 0 && l.modifiedLength < 20 && w()) {
          const O = b.createCharSequence(v, l.originalStart, l.originalStart + l.originalLength - 1),
            z = g.createCharSequence(v, l.modifiedStart, l.modifiedStart + l.modifiedLength - 1);
          if (O.getElements().length > 0 && z.getElements().length > 0) {
            let j = e(O, z, w, !0).changes;
            y && (j = o(j)), T = [];
            for (let F = 0, q = j.length; F < q; F++) T.push(s.createFromDiffChange(j[F], O, z))
          }
        }
    ...
    class S {
      ...
      computeDiff() {
        ...
        const v = e(this.original, this.modified, this.continueLineDiff, this.shouldMakePrettyDiff), l = v.changes,
          b = v.quitEarly;
        if (this.shouldIgnoreTrimWhitespace) {
          const y = [];
          for (let _ = 0, C = l.length; _ < C; _++) y.push(u.createFromDiffResult(this.shouldIgnoreTrimWhitespace, l[_], this.original, this.modified, this.continueCharDiff, this.shouldComputeCharChanges, this.shouldPostProcessCharChanges));
          return {quitEarly: b, changes: y}
        }
        const g = [];
        let w = 0, M = 0;
        for (let y = -1, _ = l.length; y < _; y++) {
          const C = y + 1 < _ ? l[y + 1] : null, R = C ? C.originalStart : this.originalLines.length,
            D = C ? C.modifiedStart : this.modifiedLines.length;
          for (; w < R && M < D;) {
            const T = this.originalLines[w], O = this.modifiedLines[M];
            if (T !== O) {
              {
                let z = L(T, 1), j = L(O, 1);
                for (; z > 1 && j > 1;) {
                  const F = T.charCodeAt(z - 2), q = O.charCodeAt(j - 2);
                  if (F !== q) break;
                  z--, j--
                }
                (z > 1 || j > 1) && this._pushTrimWhitespaceCharChange(g, w + 1, 1, z, M + 1, 1, j)
              }
              {
                let z = N(T, 1), j = N(O, 1);
                const F = T.length + 1, q = O.length + 1;
                for (; z < F && j < q;) {
                  const B = T.charCodeAt(z - 1), G = T.charCodeAt(j - 1);
                  if (B !== G) break;
                  z++, j++
                }
                (z < F || j < q) && this._pushTrimWhitespaceCharChange(g, w + 1, z, F, M + 1, j, q)
              }
            }
            w++, M++
          }
          C && (g.push(u.createFromDiffResult(this.shouldIgnoreTrimWhitespace, C, this.original, this.modified, this.continueCharDiff, this.shouldComputeCharChanges, this.shouldPostProcessCharChanges)), w += C.originalLength, M += C.modifiedLength)
        }
        return {quitEarly: b, changes: g}
      }

      _pushTrimWhitespaceCharChange(v, l, b, g, w, M, y) {
        if (this._mergeTrimWhitespaceCharChange(v, l, b, g, w, M, y)) return;
        let _;
        this.shouldComputeCharChanges && (_ = [new s(l, b, l, g, w, M, w, y)]), v.push(new u(l, l, w, w, _))
      }
    ...
    "use strict";
    Object.defineProperty(n, "__esModule", {value: !0}), n.linesDiffComputers = void 0, n.linesDiffComputers = {
      getLegacy: () => new i.LegacyLinesDiffComputer,
      getDefault: () => new x.DefaultLinesDiffComputer
    }
  }), X(J[59], Z([0, 1, 40]), function (W, n, i) {
    "use strict";
    Object.defineProperty(n, "__esModule", {value: !0}), n.computeDefaultDocumentColors = e;
    ...
    function f(h, r) {
      ...
      if (s) return {range: h, color: A(s.rgba.r, s.rgba.g, s.rgba.b, s.rgba.a)}
    }

    function p(h, r, s) {
      if (!h || r.length !== 1) return;
      const u = r[0].values(), S = x(u);
      return {range: h, color: A(S[0], S[1], S[2], s ? S[3] : 1)}
    }

    function c(h, r, s) {
      if (!h || r.length !== 1) return;
      const u = r[0].values(), S = x(u), L = new i.Color(new i.HSLA(S[0], S[1] / 100, S[2] / 100, s ? S[3] : 1));
    ...
    function m(h) {
      const r = [],
        o = a(h, /\b(rgb|rgba|hsl|hsla)(\([0-9\s,.\%]*\))|(#)([A-Fa-f0-9]{3})\b|(#)([A-Fa-f0-9]{4})\b|(#)([A-Fa-f0-9]{6})\b|(#)([A-Fa-f0-9]{8})\b/gm);
      if (o.length > 0) for (const u of o) {
        const S = u.filter(E => E !== void 0), L = S[1], N = S[2];
        if (!N) continue;
        let P;
        if (L === "rgb") {
          const E = /^\(\s*(25[0-5]|2[0-4][0-9]|1[0-9]{2}|[1-9][0-9]|[0-9])\s*,\s*(25[0-5]|2[0-4][0-9]|1[0-9]{2}|[1-9][0-9]|[0-9])\s*,\s*(25[0-5]|2[0-4][0-9]|1[0-9]{2}|[1-9][0-9]|[0-9])\s*\)$/gm;
          P = p(d(h, u), a(N, E), !1)
        } else if (L === "rgba") {
          const E = /^\(\s*(25[0-5]|2[0-4][0-9]|1[0-9]{2}|[1-9][0-9]|[0-9])\s*,\s*(25[0-5]|2[0-4][0-9]|1[0-9]{2}|[1-9][0-9]|[0-9])\s*,\s*(25[0-5]|2[0-4][0-9]|1[0-9]{2}|[1-9][0-9]|[0-9])\s*,\s*(0[.][0-9]+|[.][0-9]+|[01][.]|[01])\s*\)$/gm;
          P = p(d(h, u), a(N, E), !0)
        } else if (L === "hsl") {
          const E = /^\(\s*(36[0]|3[0-5][0-9]|[12][0-9][0-9]|[1-9]?[0-9])\s*,\s*(100|\d{1,2}[.]\d*|\d{1,2})%\s*,\s*(100|\d{1,2}[.]\d*|\d{1,2})%\s*\)$/gm;
          P = c(d(h, u), a(N, E), !1)
        } else if (L === "hsla") {
          const E = /^\(\s*(36[0]|3[0-5][0-9]|[12][0-9][0-9]|[1-9]?[0-9])\s*,\s*(100|\d{1,2}[.]\d*|\d{1,2})%\s*,\s*(100|\d{1,2}[.]\d*|\d{1,2})%\s*,\s*(0[.][0-9]+|[.][0-9]+|[01][.]|[01])\s*\)$/gm;
          P = c(d(h, u), a(N, E), !0)
    ...
    function e(h) {
      return !h || typeof h.getValue != "function" || typeof h.positionAt != "function" ? [] : m(h)
    }
  }), X(J[60], Z([0, 1, 29]), function (W, n, i) {
    "use strict";
    Object.defineProperty(n, "__esModule", {value: !0}), n.LinkComputer = n.StateMachine = void 0, n.computeLinks = m;
    ...
    function f() {
      return d === null && (d = new A([[1, 104, 2], [1, 72, 2], [1, 102, 6], [1, 70, 6], [2, 116, 3], [2, 84, 3], [3, 116, 4], [3, 84, 4], [4, 112, 5], [4, 80, 5], [5, 115, 9], [5, 83, 9], [5, 58, 10], [6, 105, 7], [6, 73, 7], [7, 108, 8], [7, 76, 8], [8, 101, 9], [8, 69, 9], [9, 58, 10], [10, 47, 11], [11, 47, 12]])), d
    }
    ...
    class a {
      static _createLink(h, r, s, o, u) {
        ...
        if (o > 0) {
          const L = r.charCodeAt(o - 1), N = r.charCodeAt(S);
          (L === 40 && N === 41 || L === 91 && N === 93 || L === 123 && N === 125) && S--
        }
        return {
          range: {startLineNumber: s, startColumn: o + 1, endLineNumber: s, endColumn: S + 2},
      ...
      static computeLinks(h, r = f()) {
        ...
        for (let u = 1, S = h.getLineCount(); u <= S; u++) {
          const L = h.getLineContent(u), N = L.length;
          let P = 0, E = 0, v = 0, l = 1, b = !1, g = !1, w = !1, M = !1;
          for (; P < N;) {
            let y = !1;
            ...
            if (l === 13) {
              ...
              switch (_) {
                ...
                case 34:
                case 96:
                  v === _ ? C = 1 : v === 39 || v === 34 || v === 96 ? C = 0 : C = 1;
                  break;
                case 42:
                  C = v === 42 ? 1 : 0;
                  break;
              ...
              let C;
              _ === 91 ? (g = !0, C = 0) : C = s.get(_), C === 1 ? y = !0 : l = 13
            } else l = r.nextState(l, _), l === 0 && (y = !0);
            y && (l = 1, b = !1, g = !1, M = !1, E = P + 1, v = _), P++
          }
    ...
    function m(e) {
      return !e || typeof e.getLineCount != "function" || typeof e.getLineContent != "function" ? [] : a.computeLinks(e)
    }
    ...
    class i {
      ...
      numberReplace(A, d) {
        ...
        return !isNaN(p) && !isNaN(c) && p === c ? p === 0 && !d ? null : (p = Math.floor(p * f), p += d ? f : -f, String(p / f)) : null
      }
      ...
      valueSetsReplace(A, d, f) {
        let p = null;
        for (let c = 0, a = A.length; p === null && c < a; c++) p = this.valueSetReplace(A[c], d, f);
        return p
      }

      valueSetReplace(A, d, f) {
        let p = A.indexOf(d);
        return p >= 0 ? (p += f ? 1 : -1, p < 0 ? p = A.length - 1 : p %= A.length, A[p]) : null
      }
    }
    ...
    "use strict";
    Object.defineProperty(n, "__esModule", {value: !0}), n.ApplyEditsResult = n.SearchData = n.ValidAnnotatedEditOperation = n.FindMatch = n.TextModelResolvedOptions = n.InjectedTextCursorStops = n.GlyphMarginLane = n.OverviewRulerLane = void 0, n.isITextSnapshot = c, n.shouldSynchronizeModel = h;
    var x;
    (function (r) {
      r[r.Left = 1] = "Left", r[r.Center = 2] = "Center", r[r.Right = 4] = "Right", r[r.Full = 7] = "Full"
    })(x || (n.OverviewRulerLane = x = {}));
    var A;
    (function (r) {
      r[r.Left = 1] = "Left", r[r.Center = 2] = "Center", r[r.Right = 3] = "Right"
    })(A || (n.GlyphMarginLane = A = {}));
    var d;
    (function (r) {
      r[r.Both = 0] = "Both", r[r.Right = 1] = "Right", r[r.Left = 2] = "Left", r[r.None = 3] = "None"
    ...
    class f {
      ...
      constructor(s) {
        this._textModelResolvedOptionsBrand = void 0, this.tabSize = Math.max(1, s.tabSize | 0), s.indentSize === "tabSize" ? (this.indentSize = this.tabSize, this._indentSizeIsTabSize = !0) : (this.indentSize = Math.max(1, s.indentSize | 0), this._indentSizeIsTabSize = !1), this.insertSpaces = !!s.insertSpaces, this.defaultEOL = s.defaultEOL | 0, this.trimAutoWhitespace = !!s.trimAutoWhitespace, this.bracketPairColorizationOptions = s.bracketPairColorizationOptions
      }

      equals(s) {
        return this.tabSize === s.tabSize && this._indentSizeIsTabSize === s._indentSizeIsTabSize && this.indentSize === s.indentSize && this.insertSpaces === s.insertSpaces && this.defaultEOL === s.defaultEOL && this.trimAutoWhitespace === s.trimAutoWhitespace && (0, i.equals)(this.bracketPairColorizationOptions, s.bracketPairColorizationOptions)
      }
      ...
      createChangeEvent(s) {
        return {
          ...
          trimAutoWhitespace: this.trimAutoWhitespace !== s.trimAutoWhitespace
        }
      }
    }
    ...
    class p {
      constructor(s, o) {
        this._findMatchBrand = void 0, this.range = s, this.matches = o
      }
    }
    ...
    class a {
      constructor(s, o, u, S, L, N) {
        this.identifier = s, this.range = o, this.text = u, this.forceMoveMarkers = S, this.isAutoWhitespaceEdit = L, this._isTracked = N
      }
    }
    ...
    class m {
      constructor(s, o, u) {
        this.regex = s, this.wordSeparators = o, this.simpleSearch = u
      }
    }
    ...
    class e {
      constructor(s, o, u) {
        this.reverseEdits = s, this.changes = o, this.trimAutoWhitespaceLineNumbers = u
      }
    }
    ...
    "use strict";
    Object.defineProperty(n, "__esModule", {value: !0}), n.PrefixSumIndexOfResult = n.ConstantTimePrefixSumComputer = n.PrefixSumComputer = void 0;
    ...
    class A {
      ...
      insertValues(c, a) {
        c = (0, x.toUint32)(c);
        const m = this.values, e = this.prefixSum, h = a.length;
        return h === 0 ? !1 : (this.values = new Uint32Array(m.length + h), this.values.set(m.subarray(0, c), 0), this.values.set(m.subarray(c), c + h), this.values.set(a, c), c - 1 < this.prefixSumValidIndex[0] && (this.prefixSumValidIndex[0] = c - 1), this.prefixSum = new Uint32Array(this.values.length), this.prefixSumValidIndex[0] >= 0 && this.prefixSum.set(e.subarray(0, this.prefixSumValidIndex[0] + 1)), !0)
      }

      setValue(c, a) {
        return c = (0, x.toUint32)(c), a = (0, x.toUint32)(a), this.values[c] === a ? !1 : (this.values[c] = a, c - 1 < this.prefixSumValidIndex[0] && (this.prefixSumValidIndex[0] = c - 1), !0)
      }

      removeValues(c, a) {
        c = (0, x.toUint32)(c), a = (0, x.toUint32)(a);
        const m = this.values, e = this.prefixSum;
        if (c >= m.length) return !1;
        const h = m.length - c;
        return a >= h && (a = h), a === 0 ? !1 : (this.values = new Uint32Array(m.length - a), this.values.set(m.subarray(0, c), 0), this.values.set(m.subarray(c + a), c), this.prefixSum = new Uint32Array(this.values.length), c - 1 < this.prefixSumValidIndex[0] && (this.prefixSumValidIndex[0] = c - 1), this.prefixSumValidIndex[0] >= 0 && this.prefixSum.set(e.subarray(0, this.prefixSumValidIndex[0] + 1)), !0)
      }
      ...
      _getPrefixSum(c) {
        ...
        a === 0 && (this.prefixSum[0] = this.values[0], a++), c >= this.values.length && (c = this.values.length - 1);
        for (let m = a; m <= c; m++) this.prefixSum[m] = this.prefixSum[m - 1] + this.values[m];
        return this.prefixSumValidIndex[0] = Math.max(this.prefixSumValidIndex[0], c), this.prefixSum[c]
      }

      getIndexOf(c) {
        c = Math.floor(c), this.getTotalSum();
        let a = 0, m = this.values.length - 1, e = 0, h = 0, r = 0;
        for (; a <= m;) if (e = a + (m - a) / 2 | 0, h = this.prefixSum[e], r = h - this.values[e], c < r) m = e - 1; else if (c >= h) a = e + 1; else break;
        return new f(e, c - r)
      }
    }
    ...
    class d {
      ...
      getIndexOf(c) {
        this._ensureValid();
        const a = this._indexBySum[c], m = a > 0 ? this._prefixSum[a - 1] : 0;
        return new f(a, c - m)
      }
      ...
      insertValues(c, a) {
        this._values = (0, i.arrayInsert)(this._values, c, a), this._invalidate(c)
      }
      ...
      _ensureValid() {
        if (!this._isValid) {
          for (let c = this._validEndIndex + 1, a = this._values.length; c < a; c++) {
            const m = this._values[c], e = c > 0 ? this._prefixSum[c - 1] : 0;
    ...
    class f {
      constructor(c, a) {
        this.index = c, this.remainder = a, this._prefixSumIndexOfResultBrand = void 0, this.index = c, this.remainder = a
      }
    }
    ...
    class d {
      constructor(p, c, a, m) {
        this._uri = p, this._lines = c, this._eol = a, this._versionId = m, this._lineStarts = null, this._cachedTextValue = null
      }
      ...
      onEvents(p) {
        ...
        const c = p.changes;
        for (const a of c) this._acceptDeleteRange(a.range), this._acceptInsertText(new x.Position(a.range.startLineNumber, a.range.startColumn), a.text);
        this._versionId = p.versionId, this._cachedTextValue = null
      }

      _ensureLineStarts() {
        if (!this._lineStarts) {
          const p = this._eol.length, c = this._lines.length, a = new Uint32Array(c);
      ...
      _acceptInsertText(p, c) {
        ...
        if (a.length === 1) {
          this._setLineText(p.lineNumber - 1, this._lines[p.lineNumber - 1].substring(0, p.column - 1) + a[0] + this._lines[p.lineNumber - 1].substring(p.column - 1));
          return
        }
        a[a.length - 1] += this._lines[p.lineNumber - 1].substring(p.column - 1), this._setLineText(p.lineNumber - 1, this._lines[p.lineNumber - 1].substring(0, p.column - 1) + a[0]);
        const m = new Uint32Array(a.length - 1);
        for (let e = 1; e < a.length; e++) this._lines.splice(p.lineNumber + e - 1, 0, a[e]), m[e - 1] = a[e].length + this._eol.length;
    ...
    "use strict";
    Object.defineProperty(n, "__esModule", {value: !0}), n.Searcher = n.TextModelSearch = n.SearchParams = void 0, n.isMultilineRegexSource = a, n.createFindMatch = m, n.isValidMatch = o;
    const p = 999;

    class c {
      constructor(L, N, P, E) {
        this.searchString = L, this.isRegex = N, this.matchCase = P, this.wordSeparators = E
      }

      parseSearchRequest() {
        if (this.searchString === "") return null;
        let L;
        this.isRegex ? L = a(this.searchString) : L = this.searchString.indexOf(`
`) >= 0;
        let N = null;
        try {
        ...
        return P && this.searchString.toLowerCase() !== this.searchString.toUpperCase() && (P = this.matchCase), new f.SearchData(N, this.wordSeparators ? (0, x.getMapForWordSeparators)(this.wordSeparators, []) : null, P ? this.searchString : null)
      }
    }
    ...
    class h {
      static findMatches(L, N, P, E, v) {
        ...
        return l ? l.regex.multiline ? this._doFindMatchesMultiline(L, P, new u(l.wordSeparators, l.regex), E, v) : this._doFindMatchesLineByLine(L, P, l, E, v) : []
      }

      static _getMultilineMatchRange(L, N, P, E, v, l) {
        let b, g = 0;
        E ? (g = E.findLineFeedCountBeforeOffset(v), b = N + v + g) : b = N + v;
        let w;
        if (E) {
          const C = E.findLineFeedCountBeforeOffset(v + l.length) - g;
          w = b + l.length + C
        } else w = b + l.length;
        const M = L.getPositionAt(b), y = L.getPositionAt(w);
        return new d.Range(M.lineNumber, M.column, y.lineNumber, y.column)
      }

      static _doFindMatchesMultiline(L, N, P, E, v) {
        const l = L.getOffsetAt(N.getStartPosition()), b = L.getValueInRange(N, 1), g = L.getEOL() === `\r
` ? new e(b) : null, w = [];
        let M = 0, y;
        for (P.reset(0); y = P.next(b);) if (w[M++] = m(this._getMultilineMatchRange(L, l, b, g, y.index, y[0]), y, E), M >= v) return w;
        return w
      }
      ...
      static _doFindMatchesLineByLine(L, N, P, E, v) {
        ...
        if (N.startLineNumber === N.endLineNumber) {
          const w = L.getLineContent(N.startLineNumber).substring(N.startColumn - 1, N.endColumn - 1);
          return b = this._findMatchesInLine(P, w, N.startLineNumber, N.startColumn - 1, b, l, E, v), l
        }
        const g = L.getLineContent(N.startLineNumber).substring(N.startColumn - 1);
        b = this._findMatchesInLine(P, g, N.startLineNumber, N.startColumn - 1, b, l, E, v);
        for (let w = N.startLineNumber + 1; w < N.endLineNumber && b < v; w++) b = this._findMatchesInLine(P, L.getLineContent(w), w, 0, b, l, E, v);
        if (b < v) {
          const w = L.getLineContent(N.endLineNumber).substring(0, N.endColumn - 1);
      ...
      static _findMatchesInLine(L, N, P, E, v, l, b, g) {
        ...
        if (!b && L.simpleSearch) {
          const _ = L.simpleSearch, C = _.length, R = N.length;
          let D = -C;
          for (; (D = N.indexOf(_, D + C)) !== -1;) if ((!w || o(w, N, R, D, C)) && (l[v++] = new f.FindMatch(new d.Range(P, D + 1 + E, P, D + 1 + C + E), null), v >= g)) return v;
          return v
        }
        const M = new u(L.wordSeparators, L.regex);
        let y;
        M.reset(0);
        do if (y = M.next(N), y && (l[v++] = m(new d.Range(P, y.index + 1 + E, P, y.index + 1 + y[0].length + E), y, b), v >= g)) return v; while (y);
        return v
      }
      ...
      static findNextMatch(L, N, P, E) {
        ...
        return v.regex.multiline ? this._doFindNextMatchMultiline(L, P, l, E) : this._doFindNextMatchLineByLine(L, P, l, E)
      }

      static _doFindNextMatchMultiline(L, N, P, E) {
        const v = new A.Position(N.lineNumber, 1), l = L.getOffsetAt(v), b = L.getLineCount(),
          g = L.getValueInRange(new d.Range(v.lineNumber, v.column, b, L.getLineMaxColumn(b)), 1), w = L.getEOL() === `\r
` ? new e(g) : null;
        P.reset(N.column - 1);
        const M = P.next(g);
        return M ? m(this._getMultilineMatchRange(L, l, g, w, M.index, M[0]), M, E) : N.lineNumber !== 1 || N.column !== 1 ? this._doFindNextMatchMultiline(L, new A.Position(1, 1), P, E) : null
      }

      static _doFindNextMatchLineByLine(L, N, P, E) {
        const v = L.getLineCount(), l = N.lineNumber, b = L.getLineContent(l),
          g = this._findFirstMatchInLine(P, b, l, N.column, E);
        if (g) return g;
        for (let w = 1; w <= v; w++) {
          const M = (l + w - 1) % v, y = L.getLineContent(M + 1), _ = this._findFirstMatchInLine(P, y, M + 1, 1, E);
          if (_) return _
        }
        return null
      }
      ...
      static _findFirstMatchInLine(L, N, P, E, v) {
        L.reset(E - 1);
        const l = L.next(N);
        return l ? m(new d.Range(P, l.index + 1, P, l.index + 1 + l[0].length), l, v) : null
      }
      ...
      static findPreviousMatch(L, N, P, E) {
        ...
        if (!v) return null;
        const l = new u(v.wordSeparators, v.regex);
        return v.regex.multiline ? this._doFindPreviousMatchMultiline(L, P, l, E) : this._doFindPreviousMatchLineByLine(L, P, l, E)
      }

      static _doFindPreviousMatchMultiline(L, N, P, E) {
        const v = this._doFindMatchesMultiline(L, new d.Range(1, 1, N.lineNumber, N.column), P, E, 10 * p);
        if (v.length > 0) return v[v.length - 1];
        const l = L.getLineCount();
        return N.lineNumber !== l || N.column !== L.getLineMaxColumn(l) ? this._doFindPreviousMatchMultiline(L, new A.Position(l, L.getLineMaxColumn(l)), P, E) : null
      }

      static _doFindPreviousMatchLineByLine(L, N, P, E) {
        const v = L.getLineCount(), l = N.lineNumber, b = L.getLineContent(l).substring(0, N.column - 1),
          g = this._findLastMatchInLine(P, b, l, E);
        if (g) return g;
        for (let w = 1; w <= v; w++) {
          const M = (v + l - w - 1) % v, y = L.getLineContent(M + 1), _ = this._findLastMatchInLine(P, y, M + 1, E);
          if (_) return _
        }
        return null
      }
      ...
      static _findLastMatchInLine(L, N, P, E) {
        let v = null, l;
        for (L.reset(0); l = L.next(N);) v = m(new d.Range(P, l.index + 1, P, l.index + 1 + l[0].length), l, E);
        return v
      }
    }
    ...
    class u {
      constructor(L, N) {
        this._wordSeparators = L, this._searchRegex = N, this._prevMatchStartIndex = -1, this._prevMatchLength = 0
      }

      reset(L) {
        this._searchRegex.lastIndex = L, this._prevMatchStartIndex = -1, this._prevMatchLength = 0
      }
      ...
      next(L) {
        ...
        let P;
        do {
          if (this._prevMatchStartIndex + this._prevMatchLength === N || (P = this._searchRegex.exec(L), !P)) return null;
          const E = P.index, v = P[0].length;
          if (E === this._prevMatchStartIndex && v === this._prevMatchLength) {
            if (v === 0) {
              i.getNextCodePoint(L, N, this._searchRegex.lastIndex) > 65535 ? this._searchRegex.lastIndex += 2 : this._searchRegex.lastIndex += 1;
              continue
            }
            return null
          }
          if (this._prevMatchStartIndex = E, this._prevMatchLength = v, !this._wordSeparators || o(this._wordSeparators, L, N, E, v)) return P
        } while (P);
        return null
      }
    }
    ...
    "use strict";
    Object.defineProperty(n, "__esModule", {value: !0}), n.EditorWorkerHost = void 0;
    ...
    "use strict";
    Object.defineProperty(n, "__esModule", {value: !0}), n.findSectionHeaders = A;
    const i = new RegExp("\\bMARK:\\s*(.*)$", "d"), x = /^-+|-+$/g;
    ...
    function d(a, m) {
      const e = [], h = a.getLineCount();
      for (let r = 1; r <= h; r++) {
        const s = a.getLineContent(r), o = s.match(m.foldingRules.markers.start);
        if (o) {
          const u = {startLineNumber: r, startColumn: o[0].length + 1, endLineNumber: r, endColumn: s.length + 1};
          if (u.endColumn > u.startColumn) {
            const S = {range: u, ...c(s.substring(o[0].length)), shouldBeInComments: !1};
    ...
    function p(a, m, e) {
      ...
      const h = i.exec(a);
      if (h) {
        const r = h.indices[1][0] + 1, s = h.indices[1][1] + 1,
          o = {startLineNumber: m, startColumn: r, endLineNumber: m, endColumn: s};
    ...
    "use strict";
    Object.defineProperty(n, "__esModule", {value: !0}), n.UnicodeTextModelHighlighter = void 0;

    class p {
      static computeUnicodeHighlights(h, r, s) {
        const o = s ? s.startLineNumber : 1, u = s ? s.endLineNumber : h.getLineCount(), S = new a(r),
          L = S.getCandidateCodePoints();
        let N;
        L === "allNonBasicAscii" ? N = new RegExp("[^\\t\\n\\r\\x20-\\x7E]", "g") : N = new RegExp(`${c(Array.from(L))}`, "g");
        const P = new x.Searcher(null, N), E = [];
        let v = !1, l, b = 0, g = 0, w = 0;
        e:for (let M = o, y = u; M <= y; M++) {
          const _ = h.getLineContent(M), C = _.length;
          P.reset(0);
          do if (l = P.next(_), l) {
            let R = l.index, D = l.index + l[0].length;
            if (R > 0) {
            ...
            let O = (0, f.getWordAtText)(R + 1, f.DEFAULT_WORD_REGEXP, _, 0);
            O && O.endColumn <= R + 1 && (O = null);
            const z = S.shouldHighlightNonBasicASCII(T, O ? O.word : null);
            if (z !== 0) {
              if (z === 3 ? b++ : z === 2 ? g++ : z === 1 ? w++ : (0, d.assertNever)(z), E.length >= 1e3) {
                v = !0;
                break e
              }
      ...
      static computeUnicodeHighlightReason(h, r) {
        ...
        switch (s.shouldHighlightNonBasicASCII(h, null)) {
          ...
          case 2:
            return {kind: 1};
          case 3: {
            const u = h.codePointAt(0), S = s.ambiguousCharacters.getPrimaryConfusable(u),
              L = A.AmbiguousCharacters.getLocales().filter(N => !A.AmbiguousCharacters.getInstance(new Set([...r.allowedLocales, N])).isAmbiguous(u));
    ...
    class a {
      constructor(h) {
        this.options = h, this.allowedCodePoints = new Set(h.allowedCodePoints), this.ambiguousCharacters = A.AmbiguousCharacters.getInstance(new Set(h.allowedLocales))
      }

      getCandidateCodePoints() {
        if (this.options.nonBasicASCII) return "allNonBasicAscii";
        const h = new Set;
        if (this.options.invisibleCharacters) for (const r of A.InvisibleCharacters.codePoints) m(String.fromCodePoint(r)) || h.add(r);
        if (this.options.ambiguousCharacters) for (const r of this.ambiguousCharacters.getConfusableCodePoints()) h.add(r);
      ...
      shouldHighlightNonBasicASCII(h, r) {
        ...
        if (r) for (const S of r) {
          const L = S.codePointAt(0), N = A.isBasicASCII(S);
          o = o || N, !N && !this.ambiguousCharacters.isAmbiguous(L) && !A.InvisibleCharacters.isInvisibleCharacter(L) && (u = !0)
        }
        return !o && u ? 0 : this.options.invisibleCharacters && !m(h) && A.InvisibleCharacters.isInvisibleCharacter(s) ? 2 : this.options.ambiguousCharacters && this.ambiguousCharacters.isAmbiguous(s) ? 3 : 0
      }
    }
...
` || e === "	"
    ...
    class A {
      constructor() {
        this._tokenizationSupports = new Map, this._factories = new Map, this._onDidChange = new i.Emitter, this.onDidChange = this._onDidChange.event, this._colorMap = null
      }
      ...
      register(p, c) {
        return this._tokenizationSupports.set(p, c), this.handleChange([p]), (0, x.toDisposable)(() => {
      ...
      registerFactory(p, c) {
        ...
        return this._factories.set(p, a), (0, x.toDisposable)(() => {
    ...
    class d extends x.Disposable {
      ...
      constructor(p, c, a) {
        super(), this._registry = p, this._languageId = c, this._factory = a, this._isDisposed = !1, this._resolvePromise = null, this._isResolved = !1
      }
    ...
    "use strict";
    Object.defineProperty(n, "__esModule", {value: !0}), n.getNLSMessages = i, n.getNLSLanguage = x;
    ...
    "use strict";
    Object.defineProperty(n, "__esModule", {value: !0}), n.getNLSMessages = n.getNLSLanguage = void 0, n.localize = f, n.localize2 = c, Object.defineProperty(n, "getNLSLanguage", {
      enumerable: !0,
      get: function () {
    ...
    const A = (0, i.getNLSLanguage)() === "pseudo" || typeof document < "u" && document.location && document.location.hash.indexOf("pseudo=true") >= 0;

    function d(a, m) {
      let e;
      return m.length === 0 ? e = a : e = a.replace(/\{(\d+)\}/g, (h, r) => {
        const s = r[0], o = m[s];
        let u = h;
        return typeof o == "string" ? u = o : (typeof o == "number" || typeof o == "boolean" || o === void 0 || o === null) && (u = String(o)), u
      }), A && (e = "\uFF3B" + e.replace(/[aouei]/g, "$&$&") + "\uFF3D"), e
    }
    ...
    "use strict";
    Object.defineProperty(n, "__esModule", {value: !0}), n.isAndroid = n.isEdge = n.isSafari = n.isFirefox = n.isChrome = n.OS = n.setTimeout0 = n.setTimeout0IsFaster = n.language = n.userAgent = n.isMobile = n.isIOS = n.webWorkerOrigin = n.isWebWorker = n.isWeb = n.isNative = n.isLinux = n.isMacintosh = n.isWindows = n.LANGUAGE_DEFAULT = void 0, n.isLittleEndian = g, n.LANGUAGE_DEFAULT = "en";
    let x = !1, A = !1, d = !1, f = !1, p = !1, c = !1, a = !1, m = !1, e = !1, h = !1, r, s = n.LANGUAGE_DEFAULT,
      o = n.LANGUAGE_DEFAULT, u, S;
    const L = globalThis;
    let N;
    typeof L.vscode < "u" && typeof L.vscode.process < "u" ? N = L.vscode.process : typeof process < "u" && typeof process?.versions?.node == "string" && (N = process);
    const P = typeof N?.versions?.electron == "string", E = P && N?.type === "renderer";
    if (typeof N == "object") {
      x = N.platform === "win32", A = N.platform === "darwin", d = N.platform === "linux", f = d && !!N.env.SNAP && !!N.env.SNAP_REVISION, a = P, e = !!N.env.CI || !!N.env.BUILD_ARTIFACTSTAGINGDIRECTORY, r = n.LANGUAGE_DEFAULT, s = n.LANGUAGE_DEFAULT;
      const w = N.env.VSCODE_NLS_CONFIG;
      if (w) try {
        const M = JSON.parse(w);
        r = M.userLocale, o = M.osLocale, s = M.resolvedLanguage || n.LANGUAGE_DEFAULT, u = M.languagePack?.translationsConfigFile
      } catch {
      }
      p = !0
    } else typeof navigator == "object" && !E ? (S = navigator.userAgent, x = S.indexOf("Windows") >= 0, A = S.indexOf("Macintosh") >= 0, m = (S.indexOf("Macintosh") >= 0 || S.indexOf("iPad") >= 0 || S.indexOf("iPhone") >= 0) && !!navigator.maxTouchPoints && navigator.maxTouchPoints > 0, d = S.indexOf("Linux") >= 0, h = S?.indexOf("Mobi") >= 0, c = !0, s = i.getNLSLanguage() || n.LANGUAGE_DEFAULT, r = navigator.language.toLowerCase(), o = r) : console.error("Unable to resolve platform.");
    let v = 0;
    A ? v = 1 : x ? v = 3 : d && (v = 2), n.isWindows = x, n.isMacintosh = A, n.isLinux = d, n.isNative = p, n.isWeb = c, n.isWebWorker = c && typeof L.importScripts == "function", n.webWorkerOrigin = n.isWebWorker ? L.origin : void 0, n.isIOS = m, n.isMobile = h, n.userAgent = S, n.language = s, n.setTimeout0IsFaster = typeof L.postMessage == "function" && !L.importScripts, n.setTimeout0 = (() => {
      if (n.setTimeout0IsFaster) {
        const w = [];
        L.addEventListener("message", y => {
          if (y.data && y.data.vscodeScheduleAsyncWork) for (let _ = 0, C = w.length; _ < C; _++) {
            const R = w[_];
        ...
        return y => {
          const _ = ++M;
          w.push({id: _, callback: y}), L.postMessage({vscodeScheduleAsyncWork: _}, "*")
        }
      }
    ...
    n.isChrome = !!(n.userAgent && n.userAgent.indexOf("Chrome") >= 0), n.isFirefox = !!(n.userAgent && n.userAgent.indexOf("Firefox") >= 0), n.isSafari = !!(!n.isChrome && n.userAgent && n.userAgent.indexOf("Safari") >= 0), n.isEdge = !!(n.userAgent && n.userAgent.indexOf("Edg/") >= 0), n.isAndroid = !!(n.userAgent && n.userAgent.indexOf("Android") >= 0)
  }), X(J[71], Z([0, 1, 23, 3, 9, 8, 11, 45]), function (W, n, i, x, A, d, f, p) {
    "use strict";
    Object.defineProperty(n, "__esModule", {value: !0}), n.CancelableAsyncIterableObject = n.AsyncIterableObject = n.Promises = n.DeferredPromise = n.GlobalIdleValue = n.AbstractIdleValue = n._runWhenIdle = n.runWhenGlobalIdle = n.RunOnceScheduler = n.IntervalTimer = n.TimeoutTimer = n.ThrottledDelayer = n.Delayer = n.Throttler = void 0, n.isThenable = c, n.createCancelablePromise = a, n.raceCancellation = m, n.timeout = u, n.disposableTimeout = S, n.first = L, n.createCancelableAsyncIterable = y;
    ...
    function a(_) {
      const C = new i.CancellationTokenSource, R = _(C.token), D = new Promise((T, O) => {
        const z = C.token.onCancellationRequested(() => {
          z.dispose(), O(new x.CancellationError)
        });
        Promise.resolve(R).then(j => {
    ...
    class e {
      ...
      queue(C) {
        ...
        return this.activePromise = C(), new Promise((R, D) => {
    ...
    class s {
      constructor(C) {
        this.defaultDelay = C, this.deferred = null, this.completionPromise = null, this.doResolve = null, this.doReject = null, this.task = null
      }

      trigger(C, R = this.defaultDelay) {
        this.task = C, this.cancelTimeout(), this.completionPromise || (this.completionPromise = new Promise((T, O) => {
        ...
        return this.deferred = R === p.MicrotaskDelay ? r(D) : h(R, D), this.completionPromise
      }
      ...
      cancel() {
        this.cancelTimeout(), this.completionPromise && (this.doReject?.(new x.CancellationError), this.completionPromise = null)
      }
    ...
    function u(_, C) {
      return C ? new Promise((R, D) => {
        const T = setTimeout(() => {
          O.dispose(), R()
        }, _), O = C.onCancellationRequested(() => {
    ...
    function L(_, C = D => !!D, R = null) {
      ...
      const T = _.length, O = () => {
        ...
        const z = _[D++];
        return Promise.resolve(z()).then(F => C(F) ? Promise.resolve(F) : O())
      };
      return O()
    }
    ...
    class N {
      constructor(C, R) {
        this._isDisposed = !1, this._token = -1, typeof C == "function" && typeof R == "number" && this.setIfNotSet(C, R)
      }
      ...
      cancelAndSet(C, R) {
        if (this._isDisposed) throw new x.BugIndicatingError("Calling 'cancelAndSet' on a disposed TimeoutTimer");
      ...
      setIfNotSet(C, R) {
        if (this._isDisposed) throw new x.BugIndicatingError("Calling 'setIfNotSet' on a disposed TimeoutTimer");
    ...
    class P {
      ...
      cancelAndSet(C, R, D = globalThis) {
        if (this.isDisposed) throw new x.BugIndicatingError("Calling 'cancelAndSet' on a disposed IntervalTimer");
        this.cancel();
    ...
    class E {
      constructor(C, R) {
        this.timeoutToken = -1, this.runner = C, this.timeout = R, this.timeoutHandler = this.onTimeout.bind(this)
      }
      ...
      schedule(C = this.timeout) {
        this.cancel(), this.timeoutToken = setTimeout(this.timeoutHandler, C)
      }
    ...
    n.RunOnceScheduler = E, function () {
      typeof globalThis.requestIdleCallback != "function" || typeof globalThis.cancelIdleCallback != "function" ? n._runWhenIdle = (_, C) => {
        (0, f.setTimeout0)(() => {
          if (R) return;
          const D = Date.now() + 15;
          C(Object.freeze({
        ...
        const D = _.requestIdleCallback(C, typeof R == "number" ? {timeout: R} : void 0);
        let T = !1;
        return {
          dispose() {
    ...
    class b {
      ...
      complete(C) {
        return new Promise(R => {
          this.completeCallback(C), this.outcome = {outcome: 0, value: C}, R()
        })
      }

      error(C) {
        return new Promise(R => {
          this.errorCallback(C), this.outcome = {outcome: 1, value: C}, R()
        })
      }
    ...
    (function (_) {
      async function C(D) {
        let T;
        const O = await Promise.all(D.map(z => z.then(j => j, j => {
          T || (T = j)
        })));
    ...
    class w {
      ...
      constructor(C, R) {
        this._state = 0, this._results = [], this._error = null, this._onReturn = R, this._onStateChanged = new A.Emitter, queueMicrotask(async () => {
          const D = {emitOne: T => this.emitOne(T), emitMany: T => this.emitMany(T), reject: T => this.reject(T)};
          try {
            await Promise.resolve(C(D)), this.resolve()
          } catch (T) {
            this.reject(T)
          } finally {
            D.emitOne = void 0, D.emitMany = void 0, D.reject = void 0
          }
        })
      }
        ...
        return {
          next: async () => {
            do {
              ...
              if (C < this._results.length) return {done: !1, value: this._results[C++]};
      ...
      emitOne(C) {
        this._state === 0 && (this._results.push(C), this._onStateChanged.fire())
      }

      emitMany(C) {
        this._state === 0 && (this._results = this._results.concat(C), this._onStateChanged.fire())
      }
      ...
      reject(C) {
        this._state === 0 && (this._state = 2, this._error = C, this._onStateChanged.fire())
      }
    }
    ...
    function y(_) {
      const C = new i.CancellationTokenSource, R = _(C.token);
    ...
    if (typeof A < "u" && typeof A.process < "u") {
    ...
    } else typeof process < "u" && typeof process?.versions?.node == "string" ? x = {
      get platform() {
      ...
      get platform() {
        return i.isWindows ? "win32" : i.isMacintosh ? "darwin" : "linux"
      }, get arch() {
      }, get env() {
        return {}
      }, cwd() {
    ...
    "use strict";
    Object.defineProperty(n, "__esModule", {value: !0}), n.sep = n.extname = n.basename = n.dirname = n.relative = n.resolve = n.join = n.normalize = n.posix = n.win32 = void 0;
    const x = 65, A = 97, d = 90, f = 122, p = 46, c = 47, a = 92, m = 58, e = 63;

    class h extends Error {
      constructor(b, g, w) {
        let M;
        typeof g == "string" && g.indexOf("not ") === 0 ? (M = "must not be", g = g.replace(/^not /, "")) : M = "must be";
        const y = b.indexOf(".") !== -1 ? "property" : "argument";
        let _ = `The "${b}" ${y} ${M} of type ${g}`;
        _ += `. Received type ${typeof w}`, super(_), this.code = "ERR_INVALID_ARG_TYPE"
      }
    }
    ...
    function N(l, b, g, w) {
      let M = "", y = 0, _ = -1, C = 0, R = 0;
      for (let D = 0; D <= l.length; ++D) {
        if (D < l.length) R = l.charCodeAt(D); else {
          if (w(R)) break;
          R = c
        }
        if (w(R)) {
          if (!(_ === D - 1 || C === 1)) if (C === 2) {
            if (M.length < 2 || y !== 2 || M.charCodeAt(M.length - 1) !== p || M.charCodeAt(M.length - 2) !== p) {
              if (M.length > 2) {
                const T = M.lastIndexOf(g);
                T === -1 ? (M = "", y = 0) : (M = M.slice(0, T), y = M.length - 1 - M.lastIndexOf(g)), _ = D, C = 0;
                continue
              } else if (M.length !== 0) {
                M = "", y = 0, _ = D, C = 0;
                continue
          ...
          } else M.length > 0 ? M += `${g}${l.slice(_ + 1, D)}` : M = l.slice(_ + 1, D), y = D - _ - 1;
          _ = D, C = 0
        } else R === p && C !== -1 ? ++C : C = -1
      }
      return M
    ...
    function E(l, b) {
      r(b, "pathObject");
      const g = b.dir || b.root, w = b.base || `${b.name || ""}${P(b.ext)}`;
    ...
    n.win32 = {
      resolve(...l) {
        ...
        for (let M = l.length - 1; M >= -1; M--) {
          ...
          } else b.length === 0 ? y = i.cwd() : (y = i.env[`=${b}`] || i.cwd(), (y === void 0 || y.slice(0, 2).toLowerCase() !== b.toLowerCase() && y.charCodeAt(2) === a) && (y = `${b}\\`));
          const _ = y.length;
          let C = 0, R = "", D = !1;
          const T = y.charCodeAt(0);
          if (_ === 1) u(T) && (C = 1, D = !0); else if (u(T)) if (D = !0, u(y.charCodeAt(1))) {
            let O = 2, z = O;
            ...
            if (O < _ && O !== z) {
              ...
              if (O < _ && O !== z) {
                for (z = O; O < _ && !u(y.charCodeAt(O));) O++;
                (O === _ || O !== z) && (R = `\\\\${j}\\${y.slice(z, O)}`, C = O)
              }
            }
          } else C = 1; else L(T) && y.charCodeAt(1) === m && (R = y.slice(0, 2), C = 2, _ > 2 && u(y.charCodeAt(2)) && (D = !0, C = 3));
          if (R.length > 0) if (b.length > 0) {
            if (R.toLowerCase() !== b.toLowerCase()) continue
          } else b = R;
          if (w) {
            if (b.length > 0) break
          } else if (g = `${y.slice(C)}\\${g}`, w = D, D && b.length > 0) break
        }
        return g = N(g, !w, "\\", u), w ? `${b}\\${g}` : `${b}${g}` || "."
      }, normalize(l) {
        s(l, "path");
        const b = l.length;
        if (b === 0) return ".";
        ...
        if (b === 1) return S(y) ? "\\" : l;
        if (u(y)) if (M = !0, u(l.charCodeAt(1))) {
          let C = 2, R = C;
        ...
        } else g = 1; else L(y) && l.charCodeAt(1) === m && (w = l.slice(0, 2), g = 2, b > 2 && u(l.charCodeAt(2)) && (M = !0, g = 3));
        let _ = g < b ? N(l.slice(g), !M, "\\", u) : "";
        return _.length === 0 && !M && (_ = "."), _.length > 0 && u(l.charCodeAt(b - 1)) && (_ += "\\"), w === void 0 ? M ? `\\${_}` : _ : M ? `${w}\\${_}` : `${w}${_}`
      }, isAbsolute(l) {
        s(l, "path");
        const b = l.length;
        if (b === 0) return !1;
        const g = l.charCodeAt(0);
        return u(g) || b > 2 && L(g) && l.charCodeAt(1) === m && u(l.charCodeAt(2))
      }, join(...l) {
        if (l.length === 0) return ".";
        let b, g;
        for (let y = 0; y < l.length; ++y) {
          const _ = l[y];
          s(_, "path"), _.length > 0 && (b === void 0 ? b = g = _ : b += `\\${_}`)
        }
        if (b === void 0) return ".";
        let w = !0, M = 0;
        if (typeof g == "string" && u(g.charCodeAt(0))) {
          ++M;
          const y = g.length;
          y > 1 && u(g.charCodeAt(1)) && (++M, y > 2 && (u(g.charCodeAt(2)) ? ++M : w = !1))
        }
        if (w) {
        ...
        const g = n.win32.resolve(l), w = n.win32.resolve(b);
        if (g === w || (l = g.toLowerCase(), b = w.toLowerCase(), l === b)) return "";
        let M = 0;
        ...
        if (z !== T) {
          ...
          _ > T && (l.charCodeAt(M + z) === a ? O = z : z === 2 && (O = 3)), O === -1 && (O = 0)
        }
        let j = "";
        for (z = M + O + 1; z <= y; ++z) (z === y || l.charCodeAt(z) === a) && (j += j.length === 0 ? ".." : "\\..");
        return C += O, j.length > 0 ? `${j}${w.slice(C, R)}` : (w.charCodeAt(C) === a && ++C, w.slice(C, R))
      }, toNamespacedPath(l) {
        ...
        } else if (L(b.charCodeAt(0)) && b.charCodeAt(1) === m && b.charCodeAt(2) === a) return `\\\\?\\${b}`;
        return l
      }, dirname(l) {
        s(l, "path");
        const b = l.length;
        ...
        } else L(M) && l.charCodeAt(1) === m && (g = b > 2 && u(l.charCodeAt(2)) ? 3 : 2, w = g);
        let y = -1, _ = !0;
        for (let C = b - 1; C >= w; --C) if (u(l.charCodeAt(C))) {
          if (!_) {
            y = C;
            break
          }
        ...
        let g = 0, w = -1, M = !0, y;
        if (l.length >= 2 && L(l.charCodeAt(0)) && l.charCodeAt(1) === m && (g = 2), b !== void 0 && b.length > 0 && b.length <= l.length) {
          if (b === l) return "";
          let _ = b.length - 1, C = -1;
          for (y = l.length - 1; y >= g; --y) {
            ...
            } else C === -1 && (M = !1, C = y + 1), _ >= 0 && (R === b.charCodeAt(_) ? --_ === -1 && (w = y) : (_ = -1, w = C))
          }
          return g === w ? w = C : w === -1 && (w = l.length), l.slice(g, w)
        }
        for (y = l.length - 1; y >= g; --y) if (u(l.charCodeAt(y))) {
          if (!M) {
            g = y + 1;
            break
          }
        ...
        s(l, "path");
        let b = 0, g = -1, w = 0, M = -1, y = !0, _ = 0;
        l.length >= 2 && l.charCodeAt(1) === m && L(l.charCodeAt(0)) && (b = w = 2);
        for (let C = l.length - 1; C >= b; --C) {
          ...
          M === -1 && (y = !1, M = C + 1), R === p ? g === -1 ? g = C : _ !== 1 && (_ = 1) : g !== -1 && (_ = -1)
        }
        return g === -1 || M === -1 || _ === 0 || _ === 1 && g === M - 1 && g === w + 1 ? "" : l.slice(g, M)
      }, format: E.bind(null, "\\"), parse(l) {
        s(l, "path");
        const b = {root: "", dir: "", base: "", ext: "", name: ""};
        if (l.length === 0) return b;
        const g = l.length;
        let w = 0, M = l.charCodeAt(0);
        if (g === 1) return u(M) ? (b.root = b.dir = l, b) : (b.base = b.name = l, b);
        if (u(M)) {
        ...
        let y = -1, _ = w, C = -1, R = !0, D = l.length - 1, T = 0;
        for (; D >= w; --D) {
          ...
          C === -1 && (R = !1, C = D + 1), M === p ? y === -1 ? y = D : T !== 1 && (T = 1) : y !== -1 && (T = -1)
        }
        return C !== -1 && (y === -1 || T === 0 || T === 1 && y === C - 1 && y === _ + 1 ? b.base = b.name = l.slice(_, C) : (b.name = l.slice(_, y), b.base = l.slice(_, C), b.ext = l.slice(y, C))), _ > 0 && _ !== w ? b.dir = l.slice(0, _ - 1) : b.dir = b.root, b
    ...
    n.posix = {
      resolve(...l) {
        ...
        for (let w = l.length - 1; w >= -1 && !g; w--) {
          const M = w >= 0 ? l[w] : v();
          s(M, `paths[${w}]`), M.length !== 0 && (b = `${M}/${b}`, g = M.charCodeAt(0) === c)
        }
        return b = N(b, !g, "/", S), g ? `/${b}` : b.length > 0 ? b : "."
      }, normalize(l) {
        if (s(l, "path"), l.length === 0) return ".";
        const b = l.charCodeAt(0) === c, g = l.charCodeAt(l.length - 1) === c;
        return l = N(l, !b, "/", S), l.length === 0 ? b ? "/" : g ? "./" : "." : (g && (l += "/"), b ? `/${l}` : l)
      }, isAbsolute(l) {
        ...
        for (let g = 0; g < l.length; ++g) {
          const w = l[g];
          s(w, "path"), w.length > 0 && (b === void 0 ? b = w : b += `/${w}`)
        }
        return b === void 0 ? "." : n.posix.normalize(b)
      }, relative(l, b) {
        if (s(l, "from"), s(b, "to"), l === b || (l = n.posix.resolve(l), b = n.posix.resolve(b), l === b)) return "";
        const g = 1, w = l.length, M = w - g, y = 1, _ = b.length - y, C = M < _ ? M : _;
        let R = -1, D = 0;
        for (; D < C; D++) {
        ...
        } else M > C && (l.charCodeAt(g + D) === c ? R = D : D === 0 && (R = 0));
        let T = "";
        for (D = g + R + 1; D <= w; ++D) (D === w || l.charCodeAt(D) === c) && (T += T.length === 0 ? ".." : "/..");
        ...
        let g = -1, w = !0;
        for (let M = l.length - 1; M >= 1; --M) if (l.charCodeAt(M) === c) {
          if (!w) {
            g = M;
            break
          }
        } else w = !1;
        return g === -1 ? b ? "/" : "." : b && g === 1 ? "//" : l.slice(0, g)
      }, basename(l, b) {
        ...
        for (y = l.length - 1; y >= 0; --y) if (l.charCodeAt(y) === c) {
          if (!M) {
            g = y + 1;
            break
          }
        ...
        for (let _ = l.length - 1; _ >= 0; --_) {
          ...
          w === -1 && (M = !1, w = _ + 1), C === p ? b === -1 ? b = _ : y !== 1 && (y = 1) : b !== -1 && (y = -1)
        }
        return b === -1 || w === -1 || y === 0 || y === 1 && b === w - 1 && b === g + 1 ? "" : l.slice(b, w)
      }, format: E.bind(null, "/"), parse(l) {
        s(l, "path");
        const b = {root: "", dir: "", base: "", ext: "", name: ""};
        if (l.length === 0) return b;
        ...
        let w;
        g ? (b.root = "/", w = 1) : w = 0;
        let M = -1, y = 0, _ = -1, C = !0, R = l.length - 1, D = 0;
        for (; R >= w; --R) {
          ...
          _ === -1 && (C = !1, _ = R + 1), T === p ? M === -1 ? M = R : D !== 1 && (D = 1) : M !== -1 && (D = -1)
        }
        if (_ !== -1) {
          const T = y === 0 && g ? 1 : y;
          M === -1 || D === 0 || D === 1 && M === _ - 1 && M === y + 1 ? b.base = b.name = l.slice(T, _) : (b.name = l.slice(T, M), b.base = l.slice(T, _), b.ext = l.slice(M, _))
        }
        return y > 0 ? b.dir = l.slice(0, y - 1) : g && (b.dir = "/"), b
      }, sep: "/", delimiter: ":", win32: null, posix: null
    }, n.posix.win32 = n.win32.win32 = n.win32, n.posix.posix = n.win32.posix = n.posix, n.normalize = o ? n.win32.normalize : n.posix.normalize, n.join = o ? n.win32.join : n.posix.join, n.resolve = o ? n.win32.resolve : n.posix.resolve, n.relative = o ? n.win32.relative : n.posix.relative, n.dirname = o ? n.win32.dirname : n.posix.dirname, n.basename = o ? n.win32.basename : n.posix.basename, n.extname = o ? n.win32.extname : n.posix.extname, n.sep = o ? n.win32.sep : n.posix.sep
  }), X(J[14], Z([0, 1, 37, 11]), function (W, n, i, x) {
    "use strict";
    Object.defineProperty(n, "__esModule", {value: !0}), n.URI = void 0, n.uriToFsPath = N;
    const A = /^\w[\w\d+.-]*$/, d = /^\//, f = /^\/\//;

    function p(b, g) {
      if (!b.scheme && g) throw new Error(`[UriError]: Scheme is missing: {scheme: "", authority: "${b.authority}", path: "${b.path}", query: "${b.query}", fragment: "${b.fragment}"}`);
      if (b.scheme && !A.test(b.scheme)) throw new Error("[UriError]: Scheme contains illegal characters.");
      if (b.path) {
        if (b.authority) {
          if (!d.test(b.path)) throw new Error('[UriError]: If a URI contains an authority component, then the path component must either be empty or begin with a slash ("/") character')
        } else if (f.test(b.path)) throw new Error('[UriError]: If a URI does not contain an authority component, then the path cannot begin with two slash characters ("//")')
      }
    }
    ...
    class r {
      static isUri(g) {
        return g instanceof r ? !0 : g ? typeof g.authority == "string" && typeof g.fragment == "string" && typeof g.path == "string" && typeof g.query == "string" && typeof g.scheme == "string" && typeof g.fsPath == "string" && typeof g.with == "function" && typeof g.toString == "function" : !1
      }

      constructor(g, w, M, y, _, C = !1) {
        typeof g == "object" ? (this.scheme = g.scheme || m, this.authority = g.authority || m, this.path = g.path || m, this.query = g.query || m, this.fragment = g.fragment || m) : (this.scheme = c(g, C), this.authority = w || m, this.path = a(this.scheme, M || m), this.query = y || m, this.fragment = _ || m, p(this, C))
      }
      ...
      with(g) {
        ...
        return w === void 0 ? w = this.scheme : w === null && (w = m), M === void 0 ? M = this.authority : M === null && (M = m), y === void 0 ? y = this.path : y === null && (y = m), _ === void 0 ? _ = this.query : _ === null && (_ = m), C === void 0 ? C = this.fragment : C === null && (C = m), w === this.scheme && M === this.authority && y === this.path && _ === this.query && C === this.fragment ? this : new o(w, M, y, _, C)
      }

      static parse(g, w = !1) {
        const M = h.exec(g);
        return M ? new o(M[2] || m, l(M[4] || m), l(M[5] || m), l(M[7] || m), l(M[9] || m), w) : new o(m, m, m, m, m)
      }

      static file(g) {
        let w = m;
        if (x.isWindows && (g = g.replace(/\\/g, e)), g[0] === e && g[1] === e) {
          const M = g.indexOf(e, 2);
          M === -1 ? (w = g.substring(2), g = e) : (w = g.substring(2, M), g = g.substring(M) || e)
        }
      ...
      static joinPath(g, ...w) {
        if (!g.path) throw new Error("[UriError]: cannot call joinPath on URI without path");
        let M;
        return x.isWindows && g.scheme === "file" ? M = r.file(i.win32.join(N(g, !0), ...w)).path : M = i.posix.join(g.path, ...w), g.with({path: M})
      }
      ...
      static revive(g) {
        if (g) {
          ...
          {
            const w = new o(g);
            return w._formatted = g.external ?? null, w._fsPath = g._sep === s ? g.fsPath ?? null : null, w
          }
        } else return g
      }
    }
    ...
    class o extends r {
      ...
      toString(g = !1) {
        return g ? P(this, !0) : (this._formatted || (this._formatted = P(this, !1)), this._formatted)
      }

      toJSON() {
        const g = {$mid: 1};
        return this._fsPath && (g.fsPath = this._fsPath, g._sep = s), this._formatted && (g.external = this._formatted), this.path && (g.path = this.path), this.scheme && (g.scheme = this.scheme), this.authority && (g.authority = this.authority), this.query && (g.query = this.query), this.fragment && (g.fragment = this.fragment), g
      }
    }
    ...
    function S(b, g, w) {
      ...
      for (let _ = 0; _ < b.length; _++) {
        ...
        if (C >= 97 && C <= 122 || C >= 65 && C <= 90 || C >= 48 && C <= 57 || C === 45 || C === 46 || C === 95 || C === 126 || g && C === 47 || w && C === 91 || w && C === 93 || w && C === 58) y !== -1 && (M += encodeURIComponent(b.substring(y, _)), y = -1), M !== void 0 && (M += b.charAt(_)); else {
          M === void 0 && (M = b.substr(0, _));
          const R = u[C];
          R !== void 0 ? (y !== -1 && (M += encodeURIComponent(b.substring(y, _)), y = -1), M += R) : y === -1 && (y = _)
        }
      }
      return y !== -1 && (M += encodeURIComponent(b.substring(y))), M !== void 0 ? M : b
    }
    ...
    function L(b) {
      ...
      for (let w = 0; w < b.length; w++) {
        ...
        M === 35 || M === 63 ? (g === void 0 && (g = b.substr(0, w)), g += u[M]) : g !== void 0 && (g += b[w])
      }
      return g !== void 0 ? g : b
    }
    ...
    function N(b, g) {
      let w;
      return b.authority && b.path.length > 1 && b.scheme === "file" ? w = `//${b.authority}${b.path}` : b.path.charCodeAt(0) === 47 && (b.path.charCodeAt(1) >= 65 && b.path.charCodeAt(1) <= 90 || b.path.charCodeAt(1) >= 97 && b.path.charCodeAt(1) <= 122) && b.path.charCodeAt(2) === 58 ? g ? w = b.path.substr(1) : w = b.path[1].toLowerCase() + b.path.substr(2) : w = b.path, x.isWindows && (w = w.replace(/\//g, "\\")), w
    }

    function P(b, g) {
      const w = g ? L : S;
      let M = "", {scheme: y, authority: _, path: C, query: R, fragment: D} = b;
      if (y && (M += y, M += ":"), (_ || y === "file") && (M += e, M += e), _) {
        let T = _.indexOf("@");
        if (T !== -1) {
          const O = _.substr(0, T);
          _ = _.substr(T + 1), T = O.lastIndexOf(":"), T === -1 ? M += w(O, !1, !1) : (M += w(O.substr(0, T), !1, !1), M += ":", M += w(O.substr(T + 1), !1, !0)), M += "@"
        }
        _ = _.toLowerCase(), T = _.lastIndexOf(":"), T === -1 ? M += w(_, !1, !0) : (M += w(_.substr(0, T), !1, !0), M += _.substr(T))
      }
      if (C) {
        if (C.length >= 3 && C.charCodeAt(0) === 47 && C.charCodeAt(2) === 58) {
      ...
      return R && (M += "?", M += w(R, !1, !1)), D && (M += "#", M += g ? D : S(D, !1, !1)), M
    }
    ...
    "use strict";
    Object.defineProperty(n, "__esModule", {value: !0}), n.COI = n.FileAccess = n.VSCODE_AUTHORITY = n.RemoteAuthorities = n.connectionTokenQueryName = n.Schemas = void 0, n.matchesScheme = c, n.matchesSomeScheme = a;
    var p;
    (function (r) {
    ...
    function c(r, s) {
      return d.URI.isUri(r) ? (0, A.equalsIgnoreCase)(r.scheme, s) : (0, A.startsWithIgnoreCase)(r, s + ":")
    }
    ...
    class m {
      ...
      rewrite(s) {
        ...
        const S = this._ports[o], L = this._connectionTokens[o];
        let N = `path=${encodeURIComponent(s.path)}`;
        return typeof L == "string" && (N += `&${n.connectionTokenQueryName}=${encodeURIComponent(L)}`), d.URI.from({
          scheme: x.isWeb ? this._preferredWebSchema : p.vscodeRemoteResource,
          authority: `${u}:${S}`,
    ...
    class e {
      ...
      uriToBrowserUri(s) {
        return s.scheme === p.vscodeRemote ? n.RemoteAuthorities.rewrite(s) : s.scheme === p.file && (x.isNative || x.webWorkerOrigin === `${p.vscodeFileResource}://${e.FALLBACK_AUTHORITY}`) ? s.with({
      ...
      toUri(s, o) {
        ...
        if (globalThis._VSCODE_FILE_ROOT) {
          ...
          if (/^\w[\w\d+.-]*:\/\//.test(u)) return d.URI.joinPath(d.URI.parse(u, !0), s);
          const S = f.join(u, s);
          return d.URI.file(S)
        }
    ...
    var h;
    (function (r) {
      const s = new Map([["1", {"Cross-Origin-Opener-Policy": "same-origin"}], ["2", {"Cross-Origin-Embedder-Policy": "require-corp"}], ["3", {
      ...
      function u(L) {
        let N;
        typeof L == "string" ? N = new URL(L).searchParams : L instanceof URL ? N = L.searchParams : d.URI.isUri(L) && (N = new URL(L.toString(!0)).searchParams);
        const P = N?.get(o);
        if (P) return s.get(P)
      }
    ...
    "use strict";
    Object.defineProperty(n, "__esModule", {value: !0}), n.SimpleWorkerServer = n.SimpleWorkerClient = void 0, n.logOnceWebWorkerWarning = h, n.create = l;
    const c = !1, a = "default", m = "$initialize";
    let e = !1;

    function h(b) {
      f.isWeb && (e || (e = !0, console.warn("Could not create web worker(s). Falling back to loading web worker code in main thread, which might cause UI freezes. Please see https://github.com/microsoft/monaco-editor#faq")), console.warn(b.message))
    }

    class r {
      constructor(g, w, M, y, _) {
        this.vsWorker = g, this.req = w, this.channel = M, this.method = y, this.args = _, this.type = 0
      }
    }

    class s {
      constructor(g, w, M, y) {
        this.vsWorker = g, this.seq = w, this.res = M, this.err = y, this.type = 1
      }
    }

    class o {
      constructor(g, w, M, y, _) {
        this.vsWorker = g, this.req = w, this.channel = M, this.eventName = y, this.arg = _, this.type = 2
      }
    }

    class u {
      constructor(g, w, M) {
        this.vsWorker = g, this.req = w, this.event = M, this.type = 3
      }
    }
    ...
    class L {
      ...
      sendMessage(g, w, M) {
        ...
        return new Promise((_, C) => {
          this._pendingReplies[y] = {resolve: _, reject: C}, this._send(new r(this._workerId, y, g, w, M))
        })
      }
      ...
      listen(g, w, M) {
        ...
        const _ = new x.Emitter({
          onWillAddFirstListener: () => {
            y = String(++this._lastSentReq), this._pendingEmitters.set(y, _), this._send(new o(this._workerId, y, g, w, M))
          }, onDidRemoveLastListener: () => {
            this._pendingEmitters.delete(y), this._send(new S(this._workerId, y)), y = null
          }
        });
        return _.event
      }
      ...
      createProxyToRemoteChannel(g, w) {
        const M = {get: (y, _) => (typeof _ == "string" && !y[_] && (E(_) ? y[_] = C => this.listen(g, _, C) : P(_) ? y[_] = this.listen(g, _, void 0) : _.charCodeAt(0) === 36 && (y[_] = async (...C) => (await w?.(), this.sendMessage(g, _, C)))), y[_])};
      ...
      _handleReplyMessage(g) {
        ...
        if (delete this._pendingReplies[g.seq], g.err) {
          let M = g.err;
          g.err.$isError && (M = new Error, M.name = g.err.name, M.message = g.err.message, M.stack = g.err.stack), w.reject(M);
          return
        }
        w.resolve(g.res)
      }
      ...
      _handleRequestMessage(g) {
        const w = g.req;
        this._handler.handleMessage(g.channel, g.method, g.args).then(y => {
          this._send(new s(this._workerId, w, y, void 0))
        }, y => {
          y.detail instanceof Error && (y.detail = (0, i.transformErrorForSerialization)(y.detail)), this._send(new s(this._workerId, w, void 0, (0, i.transformErrorForSerialization)(y)))
        })
      }

      _handleSubscribeEventMessage(g) {
        const w = g.req, M = this._handler.handleEvent(g.channel, g.eventName, g.arg)(y => {
      ...
      _send(g) {
        const w = [];
        if (g.type === 0) for (let M = 0; M < g.args.length; M++) g.args[M] instanceof ArrayBuffer && w.push(g.args[M]); else g.type === 1 && g.res instanceof ArrayBuffer && w.push(g.res);
    ...
    class N extends A.Disposable {
      constructor(g, w) {
        super(), this._localChannels = new Map, this._worker = this._register(g.create({
        ...
        typeof y < "u" && typeof y.getConfig == "function" ? M = y.getConfig() : typeof globalThis.requirejs < "u" && (M = globalThis.requirejs.s.contexts._.config), this._onModuleLoaded = this._protocol.sendMessage(a, m, [this._worker.getId(), JSON.parse(JSON.stringify(M)), w.amdModuleId]), this.proxy = this._protocol.createProxyToRemoteChannel(a, async () => {
      ...
      _handleMessage(g, w, M) {
        ...
        if (!y) return Promise.reject(new Error(`Missing channel ${g} on main thread`));
        if (typeof y[w] != "function") return Promise.reject(new Error(`Missing method ${w} on main thread channel ${g}`));
        try {
      ...
      _handleEvent(g, w, M) {
        ...
        if (E(w)) {
          ...
          if (typeof _ != "function") throw new Error(`Missing dynamic event ${w} on main thread channel ${g}.`);
          return _
        }
        if (P(w)) {
          const _ = y[w];
          if (typeof _ != "function") throw new Error(`Missing event ${w} on main thread channel ${g}.`);
          return _
        }
    ...
    function P(b) {
      return b[0] === "o" && b[1] === "n" && p.isUpperAsciiLetter(b.charCodeAt(2))
    }
    ...
    class v {
      constructor(g, w) {
        this._localChannels = new Map, this._remoteChannels = new Map, this._requestHandlerFactory = w, this._requestHandler = null, this._protocol = new L({
          sendMessage: (M, y) => {
            g(M, y)
          },
      ...
      _handleMessage(g, w, M) {
        ...
        if (!y) return Promise.reject(new Error(`Missing channel ${g} on worker thread`));
        if (typeof y[w] != "function") return Promise.reject(new Error(`Missing method ${w} on worker thread channel ${g}`));
        try {
          return Promise.resolve(y[w].apply(y, M))
        } catch (_) {
          return Promise.reject(_)
      ...
      _handleEvent(g, w, M) {
        ...
        if (E(w)) {
          const _ = y[w].call(y, M);
          if (typeof _ != "function") throw new Error(`Missing dynamic event ${w} on request handler.`);
          return _
        }
        if (P(w)) {
          const _ = y[w];
          if (typeof _ != "function") throw new Error(`Missing event ${w} on request handler.`);
          return _
        }
        throw new Error(`Malformed event name ${w}`)
      }
      ...
      async initialize(g, w, M) {
        ...
        if (w && (typeof w.baseUrl < "u" && delete w.baseUrl, typeof w.paths < "u" && typeof w.paths.vs < "u" && delete w.paths.vs, typeof w.trustedTypesPolicy < "u" && delete w.trustedTypesPolicy, w.catchError = !0, globalThis.require.config(w)), c) {
          const y = d.FileAccess.asBrowserUri(`${M}.js`).toString(!0);
          return new Promise((_, C) => {
            W([`${y}`], _, C)
          }).then(_ => {
            if (this._requestHandler = _.create(this), !this._requestHandler) throw new Error("No RequestHandler!")
          })
        }
        return new Promise((y, _) => {
          (globalThis.require || W)([M], R => {
    ...
    class c {
      constructor(_, C) {
        this.tokens = _, this.endState = C, this._tokenizationResultBrand = void 0
      }
    }
    ...
    class a {
      constructor(_, C) {
        this.tokens = _, this.endState = C, this._encodedTokenizationResultBrand = void 0
      }
    }
    ...
    var h;
    (function (y) {
      y[y.Automatic = 0] = "Automatic", y[y.Explicit = 1] = "Explicit"
    })(h || (n.InlineCompletionTriggerKind = h = {}));

    class r {
      constructor(_, C, R, D) {
        this.range = _, this.text = C, this.completionKind = R, this.isSnippetText = D
      }

      equals(_) {
        return A.Range.lift(this.range).equalsRange(_.range) && this.text === _.text && this.completionKind === _.completionKind && this.isSnippetText === _.isSnippetText
      }
    }
    ...
    var s;
    (function (y) {
      y[y.Automatic = 0] = "Automatic", y[y.PasteAs = 1] = "PasteAs"
    })(s || (n.DocumentPasteTriggerKind = s = {}));
    var o;
    (function (y) {
      y[y.Invoke = 1] = "Invoke", y[y.TriggerCharacter = 2] = "TriggerCharacter", y[y.ContentChange = 3] = "ContentChange"
    })(o || (n.SignatureHelpTriggerKind = o = {}));
    var u;
    (function (y) {
      y[y.Text = 0] = "Text", y[y.Read = 1] = "Read", y[y.Write = 2] = "Write"
    })(u || (n.DocumentHighlightKind = u = {}));

    function S(y) {
      return y && x.URI.isUri(y.uri) && A.Range.isIRange(y.range) && (A.Range.isIRange(y.originSelectionRange) || A.Range.isIRange(y.targetSelectionRange))
    }
    ...
    (function (y) {
      const _ = new Map;
      _.set(0, i.Codicon.symbolFile), _.set(1, i.Codicon.symbolModule), _.set(2, i.Codicon.symbolNamespace), _.set(3, i.Codicon.symbolPackage), _.set(4, i.Codicon.symbolClass), _.set(5, i.Codicon.symbolMethod), _.set(6, i.Codicon.symbolProperty), _.set(7, i.Codicon.symbolField), _.set(8, i.Codicon.symbolConstructor), _.set(9, i.Codicon.symbolEnum), _.set(10, i.Codicon.symbolInterface), _.set(11, i.Codicon.symbolFunction), _.set(12, i.Codicon.symbolVariable), _.set(13, i.Codicon.symbolConstant), _.set(14, i.Codicon.symbolString), _.set(15, i.Codicon.symbolNumber), _.set(16, i.Codicon.symbolBoolean), _.set(17, i.Codicon.symbolArray), _.set(18, i.Codicon.symbolObject), _.set(19, i.Codicon.symbolKey), _.set(20, i.Codicon.symbolNull), _.set(21, i.Codicon.symbolEnumMember), _.set(22, i.Codicon.symbolStruct), _.set(23, i.Codicon.symbolEvent), _.set(24, i.Codicon.symbolOperator), _.set(25, i.Codicon.symbolTypeParameter);

      function C(R) {
        let D = _.get(R);
        return D || (console.info("No codicon found for SymbolKind " + R), D = i.Codicon.symbolProperty), D
      }
    ...
    (function (y) {
      function _(C) {
        return !C || typeof C != "object" ? !1 : typeof C.id == "string" && typeof C.title == "string"
      }
    ...
    class w {
      ...
      dispose() {
        this._tokenizationSupport && this._tokenizationSupport.then(_ => {
          _ && _.dispose()
        })
      }
    ...
    n.LazyTokenizationSupport = w, n.TokenizationRegistry = new d.TokenizationRegistry, n.TreeSitterTokenizationRegistry = new d.TokenizationRegistry;
    var M;
    (function (y) {
      y[y.Invoke = 0] = "Invoke", y[y.Automatic = 1] = "Automatic"
    })(M || (n.InlineEditTriggerKind = M = {}))
  }), X(J[74], Z([0, 1, 23, 9, 42, 14, 4, 2, 48, 73, 69]), function (W, n, i, x, A, d, f, p, c, a, m) {
    "use strict";
    Object.defineProperty(n, "__esModule", {value: !0}), n.KeyMod = void 0, n.createMonacoBaseAPI = h;
  ...
  }), X(J[75], Z([0, 1, 71, 8, 14, 4, 2, 31, 64]), function (W, n, i, x, A, d, f, p, c) {
    "use strict";
    Object.defineProperty(n, "__esModule", {value: !0}), n.MirrorModel = n.WorkerTextModelSyncServer = n.WorkerTextModelSyncClient = n.STOP_SYNC_MODEL_DELTA_TIME_MS = void 0, n.STOP_SYNC_MODEL_DELTA_TIME_MS = 60 * 1e3;

    class a extends x.Disposable {
      constructor(r, s, o = !1) {
        if (super(), this._syncedModels = Object.create(null), this._syncedModelsLastUsedTime = Object.create(null), this._proxy = r, this._modelService = s, !o) {
          const u = new i.IntervalTimer;
          u.cancelAndSet(() => this._checkStopModelSync(), Math.round(n.STOP_SYNC_MODEL_DELTA_TIME_MS / 2)), this._register(u)
        }
      }

      dispose() {
        for (const r in this._syncedModels) (0, x.dispose)(this._syncedModels[r]);
      ...
      ensureSyncedResources(r, s = !1) {
        for (const o of r) {
          const u = o.toString();
          this._syncedModels[u] || this._beginModelSync(o, s), this._syncedModels[u] && (this._syncedModelsLastUsedTime[u] = new Date().getTime())
        }
      }

      _checkStopModelSync() {
        const r = new Date().getTime(), s = [];
        for (const o in this._syncedModelsLastUsedTime) r - this._syncedModelsLastUsedTime[o] > n.STOP_SYNC_MODEL_DELTA_TIME_MS && s.push(o);
      ...
      _beginModelSync(r, s) {
        ...
        S.add(o.onDidChangeContent(L => {
          this._proxy.$acceptModelChanged(u.toString(), L)
        })), S.add(o.onWillDispose(() => {
          this._stopModelSync(u)
        })), S.add((0, x.toDisposable)(() => {
      ...
      _stopModelSync(r) {
        ...
        delete this._syncedModels[r], delete this._syncedModelsLastUsedTime[r], (0, x.dispose)(s)
      }
    }
    ...
    class m {
      ...
      getModels() {
        const r = [];
        return Object.keys(this._models).forEach(s => r.push(this._models[s])), r
      }

      $acceptNewModel(r) {
        this._models[r.url] = new e(A.URI.parse(r.url), r.lines, r.EOL, r.versionId)
      }
    ...
    class e extends c.MirrorTextModel {
      ...
      findMatches(r) {
        ...
        for (let o = 0; o < this._lines.length; o++) {
          const u = this._lines[o], S = this.offsetAt(new d.Position(o + 1, 1)), L = u.matchAll(r);
          for (const N of L) (N.index || N.index === 0) && (N.index = N.index + S), s.push(N)
        }
        return s
      }
      ...
      getWordAtPosition(r, s) {
        const o = (0, p.getWordAtText)(r.column, (0, p.ensureValidWordDefinition)(s), this._lines[r.lineNumber - 1], 0);
        return o ? new f.Range(r.lineNumber, o.startColumn, r.lineNumber, o.endColumn) : null
      }

      words(r) {
        const s = this._lines, o = this._wordenize.bind(this);
        let u = 0, S = "", L = 0, N = [];
        return {
          * [Symbol.iterator]() {
            for (; ;) if (L < N.length) {
              ...
              L += 1, yield P
            } else if (u < s.length) S = s[u], N = o(S, r), L = 0, u += 1; else break
          }
        }
      }

      getLineWords(r, s) {
        const o = this._lines[r - 1], u = this._wordenize(o, s), S = [];
        for (const L of u) S.push({word: o.substring(L.start, L.end), startColumn: L.start + 1, endColumn: L.end + 1});
        return S
      }
      ...
      _wordenize(r, s) {
        const o = [];
        let u;
        for (s.lastIndex = 0; (u = s.exec(r)) && u[0].length !== 0;) o.push({
          start: u.index,
      ...
      getValueInRange(r) {
        if (r = this._validateRange(r), r.startLineNumber === r.endLineNumber) return this._lines[r.startLineNumber - 1].substring(r.startColumn - 1, r.endColumn - 1);
        const s = this._eol, o = r.startLineNumber - 1, u = r.endLineNumber - 1, S = [];
        S.push(this._lines[o].substring(r.startColumn - 1));
        for (let L = o + 1; L < u; L++) S.push(this._lines[L]);
        return S.push(this._lines[u].substring(0, r.endColumn - 1)), S.join(s)
      }

      offsetAt(r) {
        return r = this._validatePosition(r), this._ensureLineStarts(), this._lineStarts.getPrefixSum(r.lineNumber - 2) + (r.column - 1)
      }

      positionAt(r) {
        r = Math.floor(r), r = Math.max(0, r), this._ensureLineStarts();
        const s = this._lineStarts.getIndexOf(r), o = this._lines[s.index].length;
        return {lineNumber: 1 + s.index, column: 1 + Math.min(s.remainder, o)}
      }

      _validateRange(r) {
        const s = this._validatePosition({lineNumber: r.startLineNumber, column: r.startColumn}),
          o = this._validatePosition({lineNumber: r.endLineNumber, column: r.endColumn});
        return s.lineNumber !== r.startLineNumber || s.column !== r.startColumn || o.lineNumber !== r.endLineNumber || o.column !== r.endColumn ? {
      ...
      _validatePosition(r) {
        ...
        let {lineNumber: s, column: o} = r, u = !1;
        if (s < 1) s = 1, o = 1, u = !0; else if (s > this._lines.length) s = this._lines.length, o = this._lines[s - 1].length + 1, u = !0; else {
    ...
    n.MirrorModel = e
  }), X(J[77], Z([0, 1, 24, 2, 60, 61, 74, 66, 22, 68, 58, 27, 38, 59, 67, 75]), function (W, n, i, x, A, d, f, p, c, a, m, e, h, r, s, o) {
    "use strict";
    Object.defineProperty(n, "__esModule", {value: !0}), n.EditorSimpleWorker = n.BaseEditorSimpleWorker = void 0, n.create = N;
    const u = !1;
    ...
    class S {
      ...
      async $computeUnicodeHighlights(E, v, l) {
        ...
        return b ? a.UnicodeTextModelHighlighter.computeUnicodeHighlights(b, v, l) : {
          ranges: [],
          hasMore: !1,
      ...
      async $computeDiff(E, v, l, b) {
        const g = this._getModel(E), w = this._getModel(v);
        return !g || !w ? null : L.computeDiff(g, w, l, b)
      }

      static computeDiff(E, v, l, b) {
        const g = b === "advanced" ? m.linesDiffComputers.getDefault() : m.linesDiffComputers.getLegacy(),
          w = E.getLinesContent(), M = v.getLinesContent(), y = g.computeDiff(w, M, l),
          _ = y.changes.length > 0 ? !1 : this._modelsAreIdentical(E, v);

        function C(R) {
          return R.map(D => [D.original.startLineNumber, D.original.endLineNumberExclusive, D.modified.startLineNumber, D.modified.endLineNumberExclusive, D.innerChanges?.map(T => [T.originalRange.startLineNumber, T.originalRange.startColumn, T.originalRange.endLineNumber, T.originalRange.endColumn, T.modifiedRange.startLineNumber, T.modifiedRange.startColumn, T.modifiedRange.endLineNumber, T.modifiedRange.endColumn])])
        }
        ...
        return {
          ...
          changes: C(y.changes),
          moves: y.moves.map(R => [R.lineRangeMapping.original.startLineNumber, R.lineRangeMapping.original.endLineNumberExclusive, R.lineRangeMapping.modified.startLineNumber, R.lineRangeMapping.modified.endLineNumberExclusive, C(R.changes)])
        }
      }

      static _modelsAreIdentical(E, v) {
        const l = E.getLineCount(), b = v.getLineCount();
        if (l !== b) return !1;
        for (let g = 1; g <= l; g++) {
          const w = E.getLineContent(g), M = v.getLineContent(g);
          if (w !== M) return !1
        }
        return !0
      }
      ...
      async $computeMoreMinimalEdits(E, v, l) {
        ...
        v = v.slice(0).sort((y, _) => {
          if (y.range && _.range) return x.Range.compareRangesUsingStarts(y.range, _.range);
          const C = y.range ? 0 : 1, R = _.range ? 0 : 1;
          return C - R
        });
        let M = 0;
        for (let y = 1; y < v.length; y++) x.Range.getEndPosition(v[M].range).equals(x.Range.getStartPosition(v[y].range)) ? (v[M].range = x.Range.fromPositions(x.Range.getStartPosition(v[M].range), x.Range.getEndPosition(v[y].range)), v[M].text += v[y].text) : (M++, v[M] = v[y]);
        v.length = M + 1;
        for (let {range: y, text: _, eol: C} of v) {
          if (typeof C == "number" && (w = C), x.Range.isEmpty(y) && !_) continue;
          ...
          const D = (0, i.stringDiff)(R, _, l), T = b.offsetAt(x.Range.lift(y).getStartPosition());
          for (const O of D) {
            const z = b.positionAt(T + O.originalStart), j = b.positionAt(T + O.originalStart + O.originalLength), F = {
      ...
      async $textualSuggest(E, v, l, b) {
        const g = new c.StopWatch, w = new RegExp(l, b), M = new Set;
        e:for (const y of E) {
          const _ = this._getModel(y);
          if (_) {
            for (const C of _.words(w)) if (!(C === v || !isNaN(Number(C))) && (M.add(C), M.size > L._suggestionsLimit)) break e
          }
        }
      ...
      async $navigateValueSet(E, v, l, b, g) {
        ...
        const y = w.getValueInRange(v),
          _ = w.getWordAtPosition({lineNumber: v.startLineNumber, column: v.startColumn}, M);
        if (!_) return null;
        const C = w.getValueInRange(_);
        return d.BasicInplaceReplace.INSTANCE.navigateValueSet(v, y, _, C, l)
      }
    }
    ...
    class L extends S {
      constructor(E, v) {
        super(), this._host = E, this._foreignModuleFactory = v, this._foreignModule = null
      }
      ...
      $loadForeignModule(E, v, l) {
        const b = (M, y) => this._host.$fhr(M, y),
          w = {host: (0, e.createProxyObject)(l, b), getMirrorModels: () => this._getModels()};
        return this._foreignModuleFactory ? (this._foreignModule = this._foreignModuleFactory(w, v), Promise.resolve((0, e.getAllMethodNames)(this._foreignModule))) : new Promise((M, y) => {
          const _ = C => {
            this._foreignModule = C.create(w, v), M((0, e.getAllMethodNames)(this._foreignModule))
          };
          if (!u) W([`${E}`], _, y); else {
      ...
      $fmr(E, v) {
        ...
        try {
          return Promise.resolve(this._foreignModule[E].apply(this._foreignModule, v))
        } catch (l) {
    ...
    typeof importScripts == "function" && (globalThis.monaco = (0, f.createMonacoBaseAPI)())
  })
}).call(this);
